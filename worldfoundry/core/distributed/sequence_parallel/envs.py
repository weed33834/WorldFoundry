...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "TRAINER_USE_PRECOMPILED": lambda: (
        bool(os.environ.get("TRAINER_USE_PRECOMPILED")) or bool(os.environ.get("TRAINER_PRECOMPILED_WHEEL_LOCATION"))
    ),
    # CMake build type
    ...
    "TRAINER_RINGBUFFER_WARNING_INTERVAL": lambda: int(os.environ.get("TRAINER_RINGBUFFER_WARNING_INTERVAL", "60")),
    ...
    "TRAINER_ENGINE_ITERATION_TIMEOUT_S": lambda: int(os.environ.get("TRAINER_ENGINE_ITERATION_TIMEOUT_S", "60")),
