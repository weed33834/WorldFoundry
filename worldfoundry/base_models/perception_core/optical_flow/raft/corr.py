"""Module for base_models -> perception_core -> optical_flow -> raft -> corr.py functionality."""

import torch
import torch.nn.functional as F
from worldfoundry.base_models.perception_core.optical_flow.raft.utils.utils import bilinear_sampler, coords_grid
...
class AlternateCorrBlock:
    """Alternate corr block implementation."""
    def __init__(self, fmap1, fmap2, num_levels=4, radius=4):
        """Init.
