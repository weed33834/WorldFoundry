"""Module for base_models -> perception_core -> general_perception -> open_clip -> pretrained.py functionality."""
...
def download_pretrained(
    ...
    Args:
        cfg: The cfg.
        prefer_hf_hub: The prefer hf hub.
        cache_dir: The cache dir.
    """
    target = ''
    if not cfg:
