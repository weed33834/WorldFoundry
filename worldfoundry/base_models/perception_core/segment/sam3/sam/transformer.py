...
"""Module for base_models -> perception_core -> segment -> sam3 -> sam -> transformer.py functionality."""
...
class TwoWayTransformer(nn.Module):
    """Two way transformer implementation."""
    def __init__(
        self,
        depth: int,
        embedding_dim: int,
...
class TwoWayAttentionBlock(nn.Module):
    """Two way attention block implementation."""
    def __init__(
        self,
        embedding_dim: int,
        num_heads: int,
        ...
        self.mlp = SamMLPBlock(embedding_dim, mlp_dim, activation)
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            downsample_rate: The downsample rate.
            dropout: The dropout.
            kv_in_dim: The kv in dim.
            use_fa3: The use fa3.
    ...
    def _separate_heads(self, x: Tensor, num_heads: int) -> Tensor:
        """Helper function to separate heads.
    ...
    def _recombine_heads(self, x: Tensor) -> Tensor:
        """Helper function to recombine heads.
    ...
    def forward(self, q: Tensor, k: Tensor, v: Tensor) -> Tensor:
        ...
        if self.use_fa3:
            ...
            out = _worldfoundry_scaled_dot_product_attention(q, k, v, dropout_p=dropout_p)
