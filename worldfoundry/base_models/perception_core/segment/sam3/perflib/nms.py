...
"""Module for base_models -> perception_core -> segment -> sam3 -> perflib -> nms.py functionality."""
...
try:
    ...
    logging.debug(
        "Falling back to triton or CPU mask NMS implementation. Install a compatible prebuilt "
...
def generic_nms(
    ...
    if ious.is_cuda:
        if GENERIC_NMS_AVAILABLE:
            ...
            from worldfoundry.base_models.perception_core.segment.sam3.perflib.triton.nms import nms_triton
