...
def _checkpoint_root():
    explicit = os.environ.get("WORLDFOUNDRY_DOVER_CHECKPOINT_DIR")
    if explicit:
        return Path(explicit).expanduser()
    evalcrafter_root = os.environ.get("WORLDFOUNDRY_EVALCRAFTER_CHECKPOINTS_DIR")
    if evalcrafter_root:
        return Path(evalcrafter_root).expanduser() / "DOVER"
    ckpt_root = os.environ.get("WORLDFOUNDRY_CKPT_DIR")
    if ckpt_root:
        return Path(ckpt_root).expanduser() / "DOVER"
    return Path("checkpoints") / "DOVER"


def _checkpoint(name):
    return str(_checkpoint_root() / name)


model_urls = {
    "convnext_tiny_1k": _checkpoint("convnext_tiny_1k_224_ema.pth"),
    "convnext_small_1k": _checkpoint("convnext_small_1k_224_ema.pth"),
    "convnext_base_1k": _checkpoint("convnext_base_1k_224_ema.pth"),
    "convnext_large_1k": _checkpoint("convnext_large_1k_224_ema.pth"),
    "convnext_tiny_22k": _checkpoint("convnext_tiny_22k_224.pth"),
    "convnext_small_22k": _checkpoint("convnext_small_22k_224.pth"),
    "convnext_base_22k": _checkpoint("convnext_base_22k_224.pth"),
    "convnext_large_22k": _checkpoint("convnext_large_22k_224.pth"),
    "convnext_xlarge_22k": _checkpoint("convnext_xlarge_22k_224.pth"),
}
