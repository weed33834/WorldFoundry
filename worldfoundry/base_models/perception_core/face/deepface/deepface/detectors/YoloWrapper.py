from worldfoundry.base_models.perception_core.face.deepface.deepface.detectors import FaceDetector
...
def build_model():
    ...
    from worldfoundry.base_models.perception_core.face.deepface.deepface.commons.functions import get_deepface_home
