...
"""Module for base_models -> perception_core -> tracking -> track_anything -> aot -> utils -> image.py functionality."""
...
def _save_mask(mask, path, squeeze_idx=None):
    """Helper function to save mask.

    Args:
        mask: The mask.
        path: The path.
        squeeze_idx: The squeeze idx.
    """
