...
"""Module for base_models -> perception_core -> tracking -> track_anything -> aot -> networks -> models -> aot.py functionality."""
...
class AOT(nn.Module):
    ...
    def decode_id_logits(self, lstt_emb, shortcuts):
        ...
        Args:
            lstt_emb: The lstt emb.
            shortcuts: The shortcuts.
        """
