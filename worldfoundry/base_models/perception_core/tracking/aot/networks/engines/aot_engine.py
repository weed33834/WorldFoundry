...
from worldfoundry.base_models.perception_core.tracking.aot.utils.math import generate_permute_matrix
from worldfoundry.base_models.perception_core.tracking.aot.utils.image import one_hot_mask

from worldfoundry.base_models.perception_core.tracking.aot.networks.layers.basic import seq_to_2d
...
class AOTEngine(nn.Module):
    ...
    def _init_losses(self):
        ...
        from worldfoundry.base_models.perception_core.tracking.aot.networks.layers.loss import CrossEntropyLoss, SoftJaccordLoss
