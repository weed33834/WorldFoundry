...
from worldfoundry.base_models.llm_mllm_core.mllm.perceptionlm.apps.plm.generate import (
...
class PerceptionLMModel:
    ...
    def load_model(self):
        ...
        self.model, self.tokenizer, self.config = load_consolidated_model_and_tokenizer(
            model_path,
