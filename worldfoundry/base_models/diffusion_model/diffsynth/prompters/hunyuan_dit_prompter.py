"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> hunyuan_dit_prompter.py functionality."""
...
class HunyuanDiTPrompter(BasePrompter):
    """Hunyuan di t prompter implementation."""
    def __init__(
        self,
        tokenizer_path=None,
        ...
        Args:
            ...
            tokenizer_t5_path: The tokenizer t5 path.
        """
    ...
    def fetch_models(self, text_encoder: HunyuanDiTCLIPTextEncoder = None, text_encoder_t5: HunyuanDiTT5TextEncoder = None):
        ...
        Args:
            ...
            text_encoder_t5: The text encoder t5.
        """
    ...
    def encode_prompt_using_signle_model(self, prompt, text_encoder, tokenizer, max_length, clip_skip, device):
        """Encode prompt using signle model.
