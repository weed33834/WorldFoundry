"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> kolors_prompter.py functionality."""
...
class SPTokenizer:
    ...
    def tokenize(self, s: str, encode_special_tokens=False):
        ...
        Args:
            s: The s.
            encode_special_tokens: The encode special tokens.
        """
...
class ChatGLMTokenizer(PreTrainedTokenizer):
    """Chat glm tokenizer implementation."""
    ...
    def __init__(self, vocab_file, padding_side="left", clean_up_tokenization_spaces=False, encode_special_tokens=False,
        ...
        Args:
            ...
            clean_up_tokenization_spaces: The clean up tokenization spaces.
            encode_special_tokens: The encode special tokens.
        """
...
class KolorsPrompter(BasePrompter):
    """Kolors prompter implementation."""
    def __init__(
        self,
        tokenizer_path=None
    ):
