"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> omnigen_prompter.py functionality."""
...
def crop_arr(pil_image, max_image_size):
    ...
    Args:
        ...
        max_image_size: The max image size.
    """
...
class OmniGenPrompter:
    """Omni gen prompter implementation."""
    def __init__(self, 
                text_tokenizer, 
    ...
    def __call__(self, 
        ...
        Args:
            ...
            separate_cfg_input: The separate cfg input.
            use_input_image_size_as_output: The use input image size as output.
...
class OmniGenCollator:
    """Omni gen collator implementation."""
    ...
    def create_position(self, attention_mask, num_tokens_for_output_images):
        ...
        Args:
            ...
            num_tokens_for_output_images: The num tokens for output images.
        """
        position_ids = []
    ...
    def adjust_attention_for_input_images(self, attention_mask, image_sizes):
        """Adjust attention for input images.
    ...
    def process_mllm_input(self, mllm_inputs, target_img_size):
        ...
        Args:
            mllm_inputs: The mllm inputs.
            target_img_size: The target img size.
        """
...
class OmniGenSeparateCollator(OmniGenCollator):
    """Omni gen separate collator implementation."""
    def __call__(self, features):
        """Call.
