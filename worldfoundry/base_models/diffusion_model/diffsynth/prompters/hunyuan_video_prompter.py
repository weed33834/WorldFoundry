"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> hunyuan_video_prompter.py functionality."""
...
class HunyuanVideoPrompter(BasePrompter):
    """Hunyuan video prompter implementation."""
    ...
    def encode_prompt_using_llm(self,
        ...
        """Encode prompt using llm.

        Args:
            prompt: The prompt.
            max_length: The max length.
            device: The device.
            crop_start: The crop start.
    ...
    def encode_prompt_using_mllm(self,
        ...
        Args:
            ...
            hidden_state_skip_layer: The hidden state skip layer.
            use_attention_mask: The use attention mask.
            image_embed_interleave: The image embed interleave.
        """
