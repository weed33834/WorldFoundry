"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> base_prompter.py functionality."""
...
class BasePrompter:
    ...
    def load_prompt_refiners(self, model_manager: ModelManager, refiner_classes=[]):
        """Load prompt refiners.

        Args:
            model_manager: The model manager.
            refiner_classes: The refiner classes.
        """
    ...
    def load_prompt_extenders(self,model_manager:ModelManager,extender_classes=[]):
        """Load prompt extenders.

        Args:
            model_manager: The model manager.
            extender_classes: The extender classes.
        """
