"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> prompt_refiners.py functionality."""
...
class BeautifulPrompt(torch.nn.Module):
    """Beautiful prompt implementation."""
...
class QwenPrompt(torch.nn.Module):
    ...
    def from_model_manager(model_nameger: ModelManager):
        ...
        Args:
            model_nameger: The model nameger.
        """
