"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> sd3_prompter.py functionality."""
...
class SD3Prompter(BasePrompter):
    ...
    def __init__(
        ...
        Args:
            ...
            tokenizer_3_path: The tokenizer 3 path.
        """
    ...
    def fetch_models(self, text_encoder_1: SD3TextEncoder1 = None, text_encoder_2: SD3TextEncoder2 = None, text_encoder_3: SD3TextEncoder3 = None):
        ...
        Args:
            ...
            text_encoder_3: The text encoder 3.
        """
