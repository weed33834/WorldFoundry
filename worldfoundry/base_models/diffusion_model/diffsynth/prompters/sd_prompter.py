"""Module for base_models -> diffusion_model -> diffsynth -> prompters -> sd_prompter.py functionality."""

from .base_prompter import BasePrompter, tokenize_long_prompt
from worldfoundry.core.model_loading import load_state_dict, search_for_embeddings
...
class SDPrompter(BasePrompter):
    ...
    def add_textual_inversions_to_model(self, textual_inversion_dict, text_encoder):
        """Add textual inversions to model.

        Args:
            textual_inversion_dict: The textual inversion dict.
            text_encoder: The text encoder.
        """
    ...
    def add_textual_inversions_to_tokenizer(self, textual_inversion_dict, tokenizer):
        """Add textual inversions to tokenizer.
