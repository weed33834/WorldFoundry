"""Module for base_models -> diffusion_model -> diffsynth -> diffusion -> base_pipeline.py functionality."""
...
from ..models.scope_model_loader import ModelPool
from ..utils.controlnet import ControlNetInput


class PipelineUnit:
    """Pipeline unit implementation."""
    def __init__(
        self,
...
class BasePipeline(torch.nn.Module):
    ...
    def generate_noise(self, shape, seed=None, rand_device=None, rand_torch_dtype=torch.float32, device=None, torch_dtype=None, dtype=None):
        """Generate noise.
...
class PipelineUnitGraph:
    """Pipeline unit graph implementation."""
    def __init__(self):
        """Init."""
        pass
...
class PipelineUnitRunner:
    """Pipeline unit runner implementation."""
    def __init__(self):
        """Init."""
        pass
