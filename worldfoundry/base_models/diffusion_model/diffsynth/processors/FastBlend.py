"""Module for base_models -> diffusion_model -> diffsynth -> processors -> FastBlend.py functionality."""
...
class FastBlendSmoother(VideoProcessor):
    """Fast blend smoother implementation."""
    def __init__(
        self,
        ...
        Args:
            inference_mode: The inference mode.
    ...
    def __call__(self, rendered_frames, original_frames=None, **kwargs):
        ...
        Args:
            ...
            original_frames: The original frames.
        """
