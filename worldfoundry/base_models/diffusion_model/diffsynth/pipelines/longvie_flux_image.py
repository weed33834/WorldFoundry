"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> longvie_flux_image.py functionality."""

from ..models import SD3TextEncoder1, FluxTextEncoder2, FluxVAEDecoder, FluxVAEEncoder, FluxIpAdapter
from ..models.longvie_flux_dit import FluxDiT
from ..models.longvie_model_manager import ModelManager
...
class FluxImagePipeline(BasePipeline):
    ...
    def fetch_models(self, model_manager: ModelManager, controlnet_config_units: List[ControlNetConfigUnit]=[], prompt_refiner_classes=[], prompt_extender_classes=[]):
        ...
        Args:
            ...
            controlnet_config_units: The controlnet config units.
            prompt_refiner_classes: The prompt refiner classes.
            prompt_extender_classes: The prompt extender classes.
        """
    ...
    def prepare_controlnet_input(self, controlnet_image, controlnet_inpaint_mask, tiler_kwargs):
        ...
        Args:
            controlnet_image: The controlnet image.
            controlnet_inpaint_mask: The controlnet inpaint mask.
            tiler_kwargs: The tiler kwargs.
        """
    ...
    def inpaint_fusion(self, latents, inpaint_latents, pred_noise, fg_mask, bg_mask, progress_id, background_weight=0.):
        ...
        Args:
            latents: The latents.
            inpaint_latents: The inpaint latents.
            pred_noise: The pred noise.
            fg_mask: The fg mask.
            bg_mask: The bg mask.
            progress_id: The progress id.
            background_weight: The background weight.
        """
        # inpaint noise
    ...
    def prepare_entity_inputs(self, entity_prompts, entity_masks, width, height, t5_sequence_length=512, enable_eligen_inpaint=False):
        ...
        Args:
            ...
            height: The height.
            t5_sequence_length: The t5 sequence length.
            enable_eligen_inpaint: The enable eligen inpaint.
        """
    ...
    def prepare_controlnet(self, controlnet_image, masks, controlnet_inpaint_mask, tiler_kwargs, enable_controlnet_on_negative):
        ...
        Args:
            ...
            controlnet_inpaint_mask: The controlnet inpaint mask.
            tiler_kwargs: The tiler kwargs.
            enable_controlnet_on_negative: The enable controlnet on negative.
        """
...
def lets_dance_flux(
    ...
    **kwargs
    ...
    Args:
        ...
        controlnet_frames: The controlnet frames.
        tiled: The tiled.
        tile_size: The tile size.
        tile_stride: The tile stride.
