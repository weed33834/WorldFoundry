"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> wan22_video_pusa.py functionality."""
    ...
    **kwargs,
    ...
    if dit.has_image_input:
        if y is None or clip_feature is None:
            raise ValueError("Wan Pusa image-conditioned DiT requires both y and clip_feature.")
