"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> hunyuan_image.py functionality."""
...
class ImageSizeManager:
    """Image size manager implementation."""
    def __init__(self):
        """Init."""
        pass
    ...
    def get_2d_rotary_pos_embed_from_grid(self, embed_dim, grid, use_real=False):
        """Get 2d rotary pos embed from grid.
...
class HunyuanDiTImagePipeline(BasePipeline):
    """Hunyuan di t image pipeline implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            reference_strengths: The reference strengths.
