"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> sdxl_video.py functionality."""
...
class SDXLVideoPipeline(SDXLImagePipeline):
    """Sdxl video pipeline implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            ipadapter_use_instant_style: The ipadapter use instant style.
