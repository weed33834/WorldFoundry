"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> wan22_video_pusa_multi_frames.py functionality."""
...
class Wan22VideoPusaMultiFramesPipeline(BasePipeline):
    """Wan video pusa multi frames pipeline implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            end_image: The end image.
            multi_frame_images: The multi frame images.
            input_video: The input video.
            control_video: The control video.
            vace_video: The vace video.
