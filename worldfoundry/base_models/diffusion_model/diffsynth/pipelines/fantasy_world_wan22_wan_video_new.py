"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> fantasy_world_wan22_wan_video_new.py functionality."""
...
from ..diffusion.base_pipeline import BasePipeline, PipelineUnit, PipelineUnitRunner
from ..models import load_state_dict
from ..models.fantasy_world_wan22_model_manager import ModelManager
from ..models.fantasy_world_wan22_wan_video_dit import WanModel, RMSNorm, sinusoidal_embedding_1d
from ..models.wan_video_text_encoder import WanTextEncoder, T5RelativeEmbedding, T5LayerNorm
from ..models.fantasy_world_wan22_wan_video_vae import WanVideoVAE, RMS_norm, CausalConv3d, Upsample
...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        Args:
            ...
            cameras_interp: The cameras interp.
            ...
            return_condition: The return condition.
        """
        # Scheduler
...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    Args:
        ...
        longcat_latents: The longcat latents.
        sliding_window_size: The sliding window size.
        sliding_window_stride: The sliding window stride.
        cfg_merge: The cfg merge.
