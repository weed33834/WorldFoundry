"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> hunyuan_video.py functionality."""
...
class HunyuanVideoPipeline(BasePipeline):
    ...
    def prepare_vae_images_inputs(self, semantic_images, i2v_resolution="720p"):
        """Prepare vae images inputs.

        Args:
            semantic_images: The semantic images.
            i2v_resolution: The i2v resolution.
        """
    ...
    def encode_prompt(self, prompt, positive=True, clip_sequence_length=77, llm_sequence_length=256, input_images=None):
        ...
        Args:
            ...
            clip_sequence_length: The clip sequence length.
            llm_sequence_length: The llm sequence length.
    ...
    def __call__(
        ...
        Args:
            ...
            input_images: The input images.
            i2v_resolution: The i2v resolution.
            i2v_stability: The i2v stability.
            ...
            tile_size: The tile size.
            tile_stride: The tile stride.
            step_processor: The step processor.
