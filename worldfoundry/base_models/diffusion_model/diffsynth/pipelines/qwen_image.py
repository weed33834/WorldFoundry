"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> qwen_image.py functionality."""
...
from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_controlnet import (
    QwenImageBlockWiseControlNet,
)
from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_dit import QwenImageDiT
from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_text_encoder import (
    QwenImageTextEncoder,
)
from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_vae import QwenImageVAE
...
class QwenImageBlockwiseMultiControlNet(torch.nn.Module):
    """Qwen image blockwise multi control net implementation."""
...
class QwenImagePipeline(BasePipeline):
    ...
    def _enable_fp8_lora_training(self, dtype):
        """Helper function to enable fp8 lora training.
        ...
        from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_dit import RMSNorm
        from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_vae import QwenImageRMS_norm
        module_map = {
        ...
        if self.text_encoder is not None:
            enable_vram_management(self.text_encoder, module_map=module_map, vram_config=model_config)
        if self.dit is not None:
            enable_vram_management(self.dit, module_map=module_map, vram_config=model_config)
        if self.vae is not None:
            enable_vram_management(self.vae, module_map=module_map, vram_config=model_config)
    ...
    def enable_vram_management(self, num_persistent_param_in_dit=None, vram_limit=None, vram_buffer=0.5, auto_offload=True, enable_dit_fp8_computation=False):
        ...
        Args:
            ...
            auto_offload: The auto offload.
            enable_dit_fp8_computation: The enable dit fp8 computation.
        """
    ...
    def from_pretrained(
        ...
        Args:
            ...
            processor_config: The processor config.
        """
    ...
    def __call__(
        ...
        Args:
            ...
            inpaint_blur_size: The inpaint blur size.
            inpaint_blur_sigma: The inpaint blur sigma.
            height: The height.
            width: The width.
            seed: The seed.
            ...
            blockwise_controlnet_inputs: The blockwise controlnet inputs.
            ...
            edit_image: The edit image.
            edit_image_auto_resize: The edit image auto resize.
            edit_rope_interpolation: The edit rope interpolation.
...
class QwenImageUnit_ShapeChecker(PipelineUnit):
    """Qwen image unit shape checker implementation."""
    def __init__(self):
        """Init."""
...
class QwenImageUnit_NoiseInitializer(PipelineUnit):
    """Qwen image unit noise initializer implementation."""
    def __init__(self):
        """Init."""
...
class QwenImageUnit_InputImageEmbedder(PipelineUnit):
    """Qwen image unit input image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class QwenImageUnit_Inpaint(PipelineUnit):
    """Qwen image unit inpaint implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class QwenImageUnit_PromptEmbedder(PipelineUnit):
    """Qwen image unit prompt embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            seperate_cfg=True,
...
class QwenImageUnit_EntityControl(PipelineUnit):
    """Qwen image unit entity control implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            take_over=True,
...
class QwenImageUnit_BlockwiseControlNet(PipelineUnit):
    """Qwen image unit blockwise control net implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class QwenImageUnit_EditImageEmbedder(PipelineUnit):
    """Qwen image unit edit image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class QwenImageUnit_ContextImageEmbedder(PipelineUnit):
    """Qwen image unit context image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
def model_fn_qwen_image(
    ...
    **kwargs
    ...
    Args:
        dit: The dit.
        blockwise_controlnet: The blockwise controlnet.
        latents: The latents.
        ...
        height: The height.
        width: The width.
        blockwise_controlnet_conditioning: The blockwise controlnet conditioning.
        blockwise_controlnet_inputs: The blockwise controlnet inputs.
        progress_id: The progress id.
        num_inference_steps: The num inference steps.
        ...
        entity_masks: The entity masks.
        edit_latents: The edit latents.
        context_latents: The context latents.
        enable_fp8_attention: The enable fp8 attention.
