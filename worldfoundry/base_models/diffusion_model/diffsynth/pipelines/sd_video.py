"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> sd_video.py functionality."""
...
def lets_dance_with_long_video(
    ...
    """Lets dance with long video.

    Args:
        unet: The unet.
        motion_modules: The motion modules.
        ...
        unet_batch_size: The unet batch size.
        controlnet_batch_size: The controlnet batch size.
        cross_frame_attention: The cross frame attention.
        tiled: The tiled.
        tile_size: The tile size.
        tile_stride: The tile stride.
        device: The device.
        animatediff_batch_size: The animatediff batch size.
        animatediff_stride: The animatediff stride.
    """
...
class SDVideoPipeline(SDImagePipeline):
    """Sd video pipeline implementation."""
    ...
    def __init__(self, device="cuda", torch_dtype=torch.float16, use_original_animatediff=True):
        ...
        Args:
            ...
            use_original_animatediff: The use original animatediff.
        """
    ...
    def __call__(
        ...
        Args:
            ...
            clip_skip: The clip skip.
            num_frames: The num frames.
            input_frames: The input frames.
            ...
            smoother_progress_ids: The smoother progress ids.
            tiled: The tiled.
            tile_size: The tile size.
            tile_stride: The tile stride.
            seed: The seed.
