"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> wan_video_new_longvie_temporal.py functionality."""
...
class WanVideoUnit_InputImageEmbedder(PipelineUnit):
    """Wan video unit input image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class WanVideoUnit_HistoryImageEmbedder(PipelineUnit):
    """Wan video unit history image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
