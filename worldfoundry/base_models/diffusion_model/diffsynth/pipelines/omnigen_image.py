"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> omnigen_image.py functionality."""
...
class OmniGenCache(DynamicCache):
    """Omni gen cache implementation."""
    def __init__(self, 
                    num_tokens_for_img: int, offload_kv_cache: bool=False) -> None:
        """Init.

        Args:
            num_tokens_for_img: The num tokens for img.
...
class OmnigenImagePipeline(BasePipeline):
    """Omnigen image pipeline implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            image_cfg_scale: The image cfg scale.
