"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> longvie_flux_image_new.py functionality."""
...
from ..models import SD3TextEncoder1, FluxTextEncoder2, FluxVAEEncoder, FluxVAEDecoder
from ..models.longvie_flux_dit import FluxDiT
...
from ..models.longvie_flux_dit import RMSNorm
from worldfoundry.core.gradient import gradient_checkpoint_forward
from worldfoundry.core.vram import AutoWrappedLinear, AutoWrappedModule, enable_vram_management
...
class MultiControlNet(torch.nn.Module):
    """Multi control net implementation."""
    ...
    def process_single_controlnet(self, controlnet_input: ControlNetInput, conditioning: torch.Tensor, **kwargs):
        """Process single controlnet.

        Args:
            controlnet_input: The controlnet input.
    ...
    def forward(self, conditionings: list[torch.Tensor], controlnet_inputs: list[ControlNetInput], progress_id, num_inference_steps, **kwargs):
        ...
        Args:
            ...
            controlnet_inputs: The controlnet inputs.
...
class FluxImagePipeline(BasePipeline):
    """Flux image pipeline implementation."""
    ...
    def load_loras(
        ...
        Args:
            module: The module.
            lora_configs: The lora configs.
            alpha: The alpha.
            hotload: The hotload.
            extra_fused_lora: The extra fused lora.
        """
    ...
    def _enable_vram_management_with_default_config(self, model, vram_limit):
        """Helper function to enable vram management with default config.
    ...
    def from_pretrained(
        ...
        Args:
            ...
            nexus_gen_processor_config: The nexus gen processor config.
        """
    ...
    def __call__(
        ...
        Args:
            ...
            embedded_guidance: The embedded guidance.
            ...
            num_inference_steps: The num inference steps.
            multidiffusion_prompts: The multidiffusion prompts.
            multidiffusion_masks: The multidiffusion masks.
            multidiffusion_scales: The multidiffusion scales.
            kontext_images: The kontext images.
            controlnet_inputs: The controlnet inputs.
            ipadapter_images: The ipadapter images.
            ipadapter_scale: The ipadapter scale.
            eligen_entity_prompts: The eligen entity prompts.
            eligen_entity_masks: The eligen entity masks.
            eligen_enable_on_negative: The eligen enable on negative.
            eligen_enable_inpaint: The eligen enable inpaint.
            infinityou_id_image: The infinityou id image.
            infinityou_guidance: The infinityou guidance.
            flex_inpaint_image: The flex inpaint image.
            flex_inpaint_mask: The flex inpaint mask.
            flex_control_image: The flex control image.
            flex_control_strength: The flex control strength.
            flex_control_stop: The flex control stop.
            value_controller_inputs: The value controller inputs.
            step1x_reference_image: The step1x reference image.
            nexus_gen_reference_image: The nexus gen reference image.
            lora_encoder_inputs: The lora encoder inputs.
            lora_encoder_scale: The lora encoder scale.
...
class FluxImageUnit_ShapeChecker(PipelineUnit):
    """Flux image unit shape checker implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_NoiseInitializer(PipelineUnit):
    """Flux image unit noise initializer implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_InputImageEmbedder(PipelineUnit):
    """Flux image unit input image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class FluxImageUnit_PromptEmbedder(PipelineUnit):
    """Flux image unit prompt embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            seperate_cfg=True,
...
class FluxImageUnit_ImageIDs(PipelineUnit):
    """Flux image unit image i ds implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_EmbeddedGuidanceEmbedder(PipelineUnit):
    """Flux image unit embedded guidance embedder implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_Kontext(PipelineUnit):
    """Flux image unit kontext implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_ControlNet(PipelineUnit):
    """Flux image unit control net implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
    ...
    def apply_controlnet_mask_on_latents(self, pipe, latents, mask):
        """Apply controlnet mask on latents.
    ...
    def apply_controlnet_mask_on_image(self, pipe, image, mask):
        """Apply controlnet mask on image.
...
class FluxImageUnit_IPAdapter(PipelineUnit):
    """Flux image unit ip adapter implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            take_over=True,
...
class FluxImageUnit_EntityControl(PipelineUnit):
    """Flux image unit entity control implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            take_over=True,
    ...
    def prepare_entity_inputs(self, pipe, entity_prompts, entity_masks, width, height, t5_sequence_length=512):
        ...
        Args:
            pipe: The pipe.
            entity_prompts: The entity prompts.
    ...
    def prepare_eligen(self, pipe, prompt_emb_nega, eligen_entity_prompts, eligen_entity_masks, width, height, t5_sequence_length, enable_eligen_on_negative, cfg_scale):
        ...
        Args:
            pipe: The pipe.
            prompt_emb_nega: The prompt emb nega.
            eligen_entity_prompts: The eligen entity prompts.
            eligen_entity_masks: The eligen entity masks.
            width: The width.
            height: The height.
            t5_sequence_length: The t5 sequence length.
            enable_eligen_on_negative: The enable eligen on negative.
            cfg_scale: The cfg scale.
        """
...
class FluxImageUnit_NexusGen(PipelineUnit):
    """Flux image unit nexus gen implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            take_over=True,
    ...
    def get_editing_text_ids(self, latents, target_embed_height, target_embed_width, ref_embed_height, ref_embed_width):
        """Get editing text ids.

        Args:
            latents: The latents.
            target_embed_height: The target embed height.
            target_embed_width: The target embed width.
            ref_embed_height: The ref embed height.
            ref_embed_width: The ref embed width.
        """
...
class FluxImageUnit_Step1x(PipelineUnit):
    """Flux image unit step x implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_TeaCache(PipelineUnit):
    """Flux image unit tea cache implementation."""
    def __init__(self):
        """Init."""
...
class FluxImageUnit_Flex(PipelineUnit):
    """Flux image unit flex implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class FluxImageUnit_InfiniteYou(PipelineUnit):
    """Flux image unit infinite you implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
...
class FluxImageUnit_ValueControl(PipelineUnit):
    """Flux image unit value control implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            seperate_cfg=True,
    ...
    def add_to_text_embedding(self, prompt_emb, text_ids, value_emb):
        """Add to text embedding.

        Args:
            prompt_emb: The prompt emb.
            text_ids: The text ids.
            value_emb: The value emb.
        """
...
class InfinitYou(torch.nn.Module):
    ...
    def extract_arcface_bgr_embedding(self, in_image, landmark, device):
        """Extract arcface bgr embedding.

        Args:
            in_image: The in image.
    ...
    def prepare_infinite_you(self, model, id_image, infinityou_guidance, device):
        """Prepare infinite you.

        Args:
            model: The model.
            id_image: The id image.
            infinityou_guidance: The infinityou guidance.
            device: The device.
        """
        import cv2
...
class FluxImageUnit_LoRAEncode(PipelineUnit):
    """Flux image unit lo ra encode implementation."""
    def __init__(self):
        """Init."""
        super().__init__(
            take_over=True,
...
def model_fn_flux_image(
    ...
    **kwargs
    ...
    Args:
        ...
        step1x_connector: The step1x connector.
        latents: The latents.
        ...
        kontext_latents: The kontext latents.
        kontext_image_ids: The kontext image ids.
        controlnet_inputs: The controlnet inputs.
        controlnet_conditionings: The controlnet conditionings.
        tiled: The tiled.
        tile_size: The tile size.
        tile_stride: The tile stride.
        entity_prompt_emb: The entity prompt emb.
        entity_masks: The entity masks.
        ipadapter_kwargs_list: The ipadapter kwargs list.
        id_emb: The id emb.
        infinityou_guidance: The infinityou guidance.
        flex_condition: The flex condition.
        flex_uncondition: The flex uncondition.
        flex_control_stop_timestep: The flex control stop timestep.
        step1x_llm_embedding: The step1x llm embedding.
        step1x_mask: The step1x mask.
        step1x_reference_latents: The step1x reference latents.
