"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> dancer.py functionality."""
...
def lets_dance(
    ...
    Args:
        ...
        device: The device.
        vram_limit_level: The vram limit level.
    """
...
def lets_dance_xl(
    ...
    Args:
        ...
        add_text_embeds: The add text embeds.
        timestep: The timestep.
        encoder_hidden_states: The encoder hidden states.
        ipadapter_kwargs_list: The ipadapter kwargs list.
        controlnet_frames: The controlnet frames.
