"""Module for base_models -> diffusion_model -> diffsynth -> pipelines -> wan22_video_pusa_v2v.py functionality."""
...
class Wan22VideoPusaV2VPipeline(BasePipeline):
    """Wan video pusa v pipeline implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            conditioning_video: The conditioning video.
            conditioning_indices: The conditioning indices.
            conditioning_noise_multipliers: The conditioning noise multipliers.
            input_video: The input video.
            control_video: The control video.
            vace_video: The vace video.
