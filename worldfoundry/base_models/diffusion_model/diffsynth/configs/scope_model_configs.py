"""Module for base_models -> diffusion_model -> diffsynth -> configs -> scope_model_configs.py functionality."""
...
qwen_image_series = [
    {
        ...
        "model_class": "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_dit.QwenImageDiT",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_text_encoder.QwenImageTextEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.qwen_image_text_encoder.QwenImageTextEncoderStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_vae.QwenImageVAE",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_controlnet.QwenImageBlockWiseControlNet",
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.siglip2_image_encoder.Siglip2ImageEncoder",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.dinov3_image_encoder.DINOv3ImageEncoder",
    },
    {
        # Example: 
        "model_hash": "a166c33455cdbd89c0888a3645ca5c0f",
        "model_name": "qwen_image_image2lora_coarse",
        "model_class": "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_image.qwen_image_image2lora.QwenImageImage2LoRAModel",
    },
    {
        # Example: 
...
lingbot_series = [
    {
        "model_hash": "9352cfe51607c8e57165b5e033c492e2",
        "model_name": "lingbot_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.lingbot_dit.WanModel",
        "extra_kwargs": {'patch_size': [1, 2, 2], 'in_dim': 36, 'dim': 5120, 'ffn_dim': 13824, 'freq_dim': 256, 'text_dim': 4096, 'out_dim': 16, 'num_heads': 40, 'num_layers': 40, 'eps': 1e-06}
    }
]
...
wan_series = [
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_dit.WanModel",
        ...
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_dit.WanVideoDiTStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Wan-AI/Wan2.1-T2V-14B", origin_file_pattern="models_t5_umt5-xxl-enc-bf16.pth")
        "model_hash": "9c8818c2cbea55eca56c7b447df170da",
        "model_name": "wan_video_text_encoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_text_encoder.WanTextEncoder",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_vae.WanVideoVAE",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_vae.WanVideoVAEStateDictConverter",
    },
    {
        ...
        "model_name": "wan_video_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.longcat_video_dit.LongCatVideoTransformer3DModel",
    },
    {
        ...
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_dit.WanVideoDiTFromDiffusers"
    },
    {
        # Example: ModelConfig(model_id="ByteDance/Video-As-Prompt-Wan2.1-14B", origin_file_pattern="transformer/diffusion_pytorch_model*.safetensors")
        "model_hash": "5f90e66a0672219f12d9a626c8c21f61",
        "model_name": "wan_video_vap",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.wan_video_mot.MotWanModel",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_mot.WanVideoMotStateDictConverter"
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_image_encoder.WanImageEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_image_encoder.WanImageEncoderStateDictConverter"
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_motion_controller.WanMotionControllerModel",
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_vace.VaceWanModel",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_vace.VaceWanModelDictConverter"
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_animate_adapter.WanAnimateAdapter",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_animate_adapter.WanAnimateAdapterStateDictConverter"
    },
    {
    ...
    },
    {
        ...
        "model_name": "wan_video_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_dit_s2v.WanS2VModel",
    ...
    },
    {
        ...
        "model_name": "wan_video_vae",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wan_video_vae.WanVideoVAE38",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wan_video_vae.WanVideoVAEStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.scope_wav2vec.WanS2VAudioEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.wans2v_audio_encoder.WanS2VAudioEncoderStateDictConverter",
    },
]
...
flux_series = [
    {
        ...
        "model_name": "flux_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_dit.FluxDiT",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_dit.FluxDiTStateDictConverter",
    },
    {
        ...
        "model_name": "flux_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_dit.FluxDiT",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_dit.FluxDiTStateDictConverterFromDiffusers",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_text_encoder_clip.FluxTextEncoderClip",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_text_encoder_clip.FluxTextEncoderClipStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_text_encoder_t5.FluxTextEncoderT5",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_text_encoder_t5.FluxTextEncoderT5StateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_vae.FluxVAEEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_vae.FluxVAEEncoderStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="black-forest-labs/FLUX.1-dev", origin_file_pattern="ae.safetensors")
        "model_hash": "21ea55f476dfc4fd135587abb59dfe5d",
        "model_name": "flux_vae_decoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_vae.FluxVAEDecoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_vae.FluxVAEDecoderStateDictConverter",
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_value_control.SingleValueEncoder",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_controlnet.FluxControlNet",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_controlnet.FluxControlNetStateDictConverter",
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_infiniteyou.InfiniteYouImageProjector",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_infiniteyou.FluxInfiniteYouImageProjectorStateDictConverter",
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_lora_encoder.FluxLoRAEncoder",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_lora_patcher.FluxLoraPatcher",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.nexus_gen.NexusGenAutoregressiveModel",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.nexus_gen.NexusGenAutoregressiveModelStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.nexus_gen_projector.NexusGenImageEmbeddingMerger",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.nexus_gen_projector.NexusGenMergerStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="DiffSynth-Studio/Nexus-GenV2", origin_file_pattern="edit_decoder.bin")
        "model_hash": "63c969fd37cce769a90aa781fbff5f81",
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.nexus_gen_projector.NexusGenAdapter",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.nexus_gen_projector.NexusGenAdapterStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="DiffSynth-Studio/Nexus-GenV2", origin_file_pattern="generation_decoder.bin")
        "model_hash": "3e6c61b0f9471135fc9c6d6a98e98b6d",
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_ipadapter.FluxIpAdapter",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_ipadapter.FluxIpAdapterStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_ipadapter.SiglipVisionModelSO400M",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_ipadapter.SiglipStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.step1x_connector.Qwen2Connector",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.step1x_connector.Qwen2ConnectorStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="stepfun-ai/Step1X-Edit", origin_file_pattern="step1x-edit-i1258.safetensors"),
        "model_hash": "d30fb9e02b1dbf4e509142f05cf7dd50",
...
flux2_series = [
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux2_text_encoder.Flux2TextEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux2_text_encoder.Flux2TextEncoderStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux2_dit.Flux2DiT",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux2_vae.Flux2VAE",
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.z_image_text_encoder.ZImageTextEncoder",
        "extra_kwargs": {"model_size": "8B"},
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.z_image_text_encoder.ZImageTextEncoderStateDictConverter",
    },
    {
...
z_image_series = [
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.z_image_dit.ZImageDiT",
    },
    {
    ...
    },
    {
        ...
        "model_name": "flux_vae_encoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_vae.FluxVAEEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_vae.FluxVAEEncoderStateDictConverterDiffusers",
    ...
    },
    {
        ...
        "model_name": "flux_vae_decoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_vae.FluxVAEDecoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.flux_vae.FluxVAEDecoderStateDictConverterDiffusers",
        "extra_kwargs": {"use_conv_attention": False},
    },
    {
    ...
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.siglip2_image_encoder.Siglip2ImageEncoder428M",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.z_image_controlnet.ZImageControlNet",
    },
    {
        # Example: ???
        "model_hash": "9510cb8cd1dd34ee0e4f111c24905510",
        "model_name": "z_image_image2lora_style",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.z_image_image2lora.ZImageImage2LoRAModel",
...
ltx2_series = [
    {
        ...
        "model_name": "ltx2_dit",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_dit.LTXModel",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_dit.LTXModelStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "aca7b0bbf8415e9c98360750268915fc",
        "model_name": "ltx2_video_vae_encoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_video_vae.LTX2VideoEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_video_vae.LTX2VideoEncoderStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "aca7b0bbf8415e9c98360750268915fc",
        "model_name": "ltx2_video_vae_decoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_video_vae.LTX2VideoDecoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_video_vae.LTX2VideoDecoderStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "aca7b0bbf8415e9c98360750268915fc",
        "model_name": "ltx2_audio_vae_decoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_audio_vae.LTX2AudioDecoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_audio_vae.LTX2AudioDecoderStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "aca7b0bbf8415e9c98360750268915fc",
        "model_name": "ltx2_audio_vocoder",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_audio_vae.LTX2Vocoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_audio_vae.LTX2VocoderStateDictConverter",
    },
    # { # not used currently
    #     # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
    #     "model_hash": "aca7b0bbf8415e9c98360750268915fc",
    #     "model_name": "ltx2_audio_vae_encoder",
    #     "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_audio_vae.LTX2AudioEncoder",
    #     "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_audio_vae.LTX2AudioEncoderStateDictConverter",
    # },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "aca7b0bbf8415e9c98360750268915fc",
        "model_name": "ltx2_text_encoder_post_modules",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_text_encoder.LTX2TextEncoderPostModules",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_text_encoder.LTX2TextEncoderPostModulesStateDictConverter",
    },
    {
        ...
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_text_encoder.LTX2TextEncoder",
        "state_dict_converter": "worldfoundry.base_models.diffusion_model.diffsynth.utils.state_dict_converters.ltx2_text_encoder.LTX2TextEncoderStateDictConverter",
    },
    {
        # Example: ModelConfig(model_id="Lightricks/LTX-2", origin_file_pattern="ltx-2-19b-dev.safetensors")
        "model_hash": "c79c458c6e99e0e14d47e676761732d2",
        "model_name": "ltx2_latent_upsampler",
        "model_class": "worldfoundry.base_models.diffusion_model.diffsynth.models.ltx2_upsampler.LTX2LatentUpsampler",
    },
]
MODEL_CONFIGS = qwen_image_series + lingbot_series + wan_series + flux_series + flux2_series + z_image_series + ltx2_series
