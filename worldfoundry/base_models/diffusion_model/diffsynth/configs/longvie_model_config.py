"""Module for base_models -> diffusion_model -> diffsynth -> configs -> longvie_model_config.py functionality."""
...
from ..models.longvie_sd3_dit import SD3DiT
...
from ..models.longvie_svd_unet import SVDUNet
...
from worldfoundry.base_models.diffusion_model.diffsynth.extensions.ESRGAN import RRDBNet
from worldfoundry.base_models.diffusion_model.diffsynth.extensions.RIFE import IFNet
...
from ..models.longvie_wan_video_dit import WanModel
from ..models.wan_video_dit_s2v import WanS2VModel
from ..models.wan_video_text_encoder import WanTextEncoder
from ..models.wan_video_image_encoder import WanImageEncoder
from ..models.longvie_wan_video_vae import WanVideoVAE, WanVideoVAE38
...
huggingface_model_loader_configs = [
    ...
    ("ChatGLMModel", "worldfoundry.base_models.diffusion_model.diffsynth.models.kolors_text_encoder", "kolors_text_encoder", None),
    ("MarianMTModel", "transformers.models.marian.modeling_marian", "translator", None),
    ("BloomForCausalLM", "transformers.models.bloom.modeling_bloom", "beautiful_prompt", None),
    ("Qwen2ForCausalLM", "transformers.models.qwen2.modeling_qwen2", "qwen_prompt", None),
    # ("LlamaForCausalLM", "transformers.models.llama.modeling_llama", "omost_prompt", None),
    ("T5EncoderModel", "worldfoundry.base_models.diffusion_model.diffsynth.models.flux_text_encoder", "flux_text_encoder_2", "FluxTextEncoder2"),
    ("CogVideoXTransformer3DModel", "worldfoundry.base_models.diffusion_model.diffsynth.models.cog_dit", "cog_dit", "CogDiT"),
    ("SiglipModel", "transformers.models.siglip.modeling_siglip", "siglip_vision_model", "SiglipVisionModel"),
    ("LlamaForCausalLM", "worldfoundry.base_models.diffusion_model.diffsynth.models.hunyuan_video_text_encoder", "hunyuan_video_text_encoder_2", "HunyuanVideoLLMEncoder"),
    ("LlavaForConditionalGeneration", "worldfoundry.base_models.diffusion_model.diffsynth.models.hunyuan_video_text_encoder", "hunyuan_video_text_encoder_2", "HunyuanVideoMLLMEncoder"),
    ("Step1Model", "worldfoundry.base_models.diffusion_model.diffsynth.models.stepvideo_text_encoder", "stepvideo_text_encoder_2", "STEP1TextEncoder"),
    ("Qwen2_5_VLForConditionalGeneration", "worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen25_vl_prompt_embedder", "qwenvl", "Qwen25VL_7b_Embedder"),
]
