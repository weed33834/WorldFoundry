"""Module for base_models -> diffusion_model -> diffsynth -> utils -> state_dict_converters -> flux_ipadapter.py functionality."""

def FluxIpAdapterStateDictConverter(state_dict):
    """Fluxipadapterstatedictconverter.
