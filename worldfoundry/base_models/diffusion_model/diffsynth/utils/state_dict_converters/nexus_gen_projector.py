"""Module for base_models -> diffusion_model -> diffsynth -> utils -> state_dict_converters -> nexus_gen_projector.py functionality."""

def NexusGenMergerStateDictConverter(state_dict):
    """Nexusgenmergerstatedictconverter.
...
def NexusGenAdapterStateDictConverter(state_dict):
    """Nexusgenadapterstatedictconverter.
