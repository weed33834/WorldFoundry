"""Module for base_models -> diffusion_model -> diffsynth -> utils -> state_dict_converters -> flux_vae.py functionality."""

def FluxVAEEncoderStateDictConverter(state_dict):
    """Fluxvaeencoderstatedictconverter.
...
def FluxVAEDecoderStateDictConverter(state_dict):
    """Fluxvaedecoderstatedictconverter.
...
def FluxVAEEncoderStateDictConverterDiffusers(state_dict):
    """Fluxvaeencoderstatedictconverterdiffusers.
...
def FluxVAEDecoderStateDictConverterDiffusers(state_dict):
        """Fluxvaedecoderstatedictconverterdiffusers.
