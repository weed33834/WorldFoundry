"""Module for base_models -> diffusion_model -> diffsynth -> extensions -> FastBlend -> api.py functionality."""
...
def check_input_for_blending(video_guide, video_guide_folder, video_style, video_style_folder):
    """Check input for blending.

    Args:
        video_guide: The video guide.
        video_guide_folder: The video guide folder.
        video_style: The video style.
        video_style_folder: The video style folder.
    """
...
class KeyFrameMatcher:
    """Key frame matcher implementation."""
    def __init__(self):
        """Init."""
        pass
    ...
    def match_using_filename(self, file_names_a, file_names_b):
        ...
        Args:
            file_names_a: The file names a.
            file_names_b: The file names b.
        """
...
def detect_frames(frames_path, keyframes_path):
    ...
    Args:
        ...
        keyframes_path: The keyframes path.
    """
