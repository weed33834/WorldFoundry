"""Module for base_models -> diffusion_model -> diffsynth -> extensions -> FastBlend -> runners -> interpolation.py functionality."""
...
class InterpolationModeRunner:
    """Interpolation mode runner implementation."""
    def __init__(self):
        """Init."""
        pass
...
class InterpolationModeSingleFrameRunner:
    """Interpolation mode single frame runner implementation."""
    def __init__(self):
        """Init."""
        pass
