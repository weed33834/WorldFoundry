"""Module for base_models -> diffusion_model -> diffsynth -> extensions -> FastBlend -> runners -> fast.py functionality."""
...
class TableManager:
    ...
    def build_remapping_table(self, frames_guide, frames_style, patch_match_engine, batch_size, desc=""):
        ...
        Args:
            ...
            patch_match_engine: The patch match engine.
    ...
    def remapping_table_to_blending_table(self, table):
        """Remapping table to blending table.
    ...
    def tree_query(self, leftbound, rightbound):
        ...
        Args:
            leftbound: The leftbound.
            rightbound: The rightbound.
        """
        node_list = []
    ...
    def process_window_sum(self, frames_guide, blending_table, patch_match_engine, window_size, batch_size, desc=""):
        ...
        Args:
            frames_guide: The frames guide.
            blending_table: The blending table.
            patch_match_engine: The patch match engine.
...
class FastModeRunner:
    """Fast mode runner implementation."""
    def __init__(self):
        """Init."""
        pass
