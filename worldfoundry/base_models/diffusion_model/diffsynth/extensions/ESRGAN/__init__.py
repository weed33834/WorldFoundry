"""Module for base_models -> diffusion_model -> diffsynth -> extensions -> ESRGAN -> __init__.py functionality."""
...
class ResidualDenseBlock(torch.nn.Module):
    """Residual dense block implementation."""

    def __init__(self, num_feat=64, num_grow_ch=32):
        """Init.

        Args:
            num_feat: The num feat.
            num_grow_ch: The num grow ch.
        """
...
class RRDBNetStateDictConverter:
    """Rrdb net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
