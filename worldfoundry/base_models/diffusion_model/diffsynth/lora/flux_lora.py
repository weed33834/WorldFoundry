"""Module for base_models -> diffusion_model -> diffsynth -> lora -> flux_lora.py functionality."""
...
class FluxLoRALoader(GeneralLoRALoader):
    """Flux lo ra loader implementation."""
...
class LoraMerger(torch.nn.Module):
    ...
    def forward(self, base_output, lora_outputs):
        ...
        Args:
            base_output: The base output.
            lora_outputs: The lora outputs.
        """
...
class FluxLoraPatcher(torch.nn.Module):
    """Flux lora patcher implementation."""
...
class FluxLoraPatcherStateDictConverter:
    """Flux lora patcher state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class FluxLoRAFuser:
    """Flux lo ra fuser implementation."""
    ...
    def LoRA_State_Dicts_Decomposition(self, lora_state_dicts=[], q=4):
        """Lora state dicts decomposition.

        Args:
            lora_state_dicts: The lora state dicts.
            q: The q.
        """
