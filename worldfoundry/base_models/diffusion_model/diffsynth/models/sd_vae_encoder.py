"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_vae_encoder.py functionality."""
...
class SDVAEEncoderStateDictConverter:
    """Sdvae encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
