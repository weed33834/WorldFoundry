"""Module for base_models -> diffusion_model -> diffsynth -> models -> sdxl_controlnet.py functionality."""
...
class SDXLControlNetUnion(torch.nn.Module):
    """Sdxl control net union implementation."""
    def __init__(self, global_pool=False):
        """Init.

        Args:
            global_pool: The global pool.
        """
        super().__init__()
...
class SDXLControlNetUnionStateDictConverter:
    """Sdxl control net union state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
