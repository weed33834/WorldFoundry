"""Module for base_models -> diffusion_model -> diffsynth -> models -> nexus_gen_projector.py functionality."""
...
def apply_multimodal_rotary_pos_emb(q, k, cos, sin, mrope_section, unsqueeze_dim=1):
    """Apply multimodal rotary pos emb.
    ...
    Args:
        ...
        cos: The cos.
        sin: The sin.
        mrope_section: The mrope section.
        unsqueeze_dim: The unsqueeze dim.
    """
...
class Qwen2_5_VLAttention(nn.Module):
    """Qwen vl attention implementation."""
...
class NexusGenImageEmbeddingMerger(nn.Module):
    """Nexus gen image embedding merger implementation."""
    ...
    def forward(self, embeds, embeds_grid, ref_embeds=None, ref_embeds_grid=None):
        ...
        Args:
            embeds: The embeds.
            embeds_grid: The embeds grid.
            ref_embeds: The ref embeds.
            ref_embeds_grid: The ref embeds grid.
        """
...
class NexusGenMergerStateDictConverter:
    """Nexus gen merger state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class NexusGenAdapterStateDictConverter:
    """Nexus gen adapter state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
