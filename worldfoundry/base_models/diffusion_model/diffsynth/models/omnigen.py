...
"""Module for base_models -> diffusion_model -> diffsynth -> models -> omnigen.py functionality."""
...
class OmniGenOriginalModel(nn.Module):
    ...
    def __init__(
        ...
        Args:
            transformer_config: The transformer config.
            patch_size: The patch size.
    ...
    def patch_multiple_resolutions(self, latents, padding_latent=None, is_input_images:bool=False):
        """Patch multiple resolutions.

        Args:
            latents: The latents.
            padding_latent: The padding latent.
            is_input_images: The is input images.
        """
    ...
    def forward_with_cfg(self, x, timestep, input_ids, input_img_latents, input_image_sizes, attention_mask, position_ids, cfg_scale, use_img_cfg, img_cfg_scale, past_key_values, use_kv_cache, offload_model):      
        ...
        Args:
            ...
            input_ids: The input ids.
            input_img_latents: The input img latents.
            input_image_sizes: The input image sizes.
            attention_mask: The attention mask.
            position_ids: The position ids.
            cfg_scale: The cfg scale.
            use_img_cfg: The use img cfg.
            img_cfg_scale: The img cfg scale.
            past_key_values: The past key values.
            use_kv_cache: The use kv cache.
            offload_model: The offload model.
        """
...
class OmniGenTransformer(OmniGenOriginalModel):
    """Omni gen transformer implementation."""
    def __init__(self):
        """Init."""
        config = {
...
class OmniGenTransformerStateDictConverter:
    """Omni gen transformer state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
