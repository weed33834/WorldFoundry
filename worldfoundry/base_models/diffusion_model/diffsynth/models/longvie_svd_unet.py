"""Module for base_models -> diffusion_model -> diffsynth -> models -> longvie_svd_unet.py functionality."""
...
class TemporalResnetBlock(torch.nn.Module):
    """Temporal resnet block implementation."""
    ...
    def forward(self, hidden_states, time_emb, text_emb, res_stack, **kwargs):
        ...
        Args:
            ...
            time_emb: The time emb.
            text_emb: The text emb.
            res_stack: The res stack.
        """
...
class TemporalTimesteps(torch.nn.Module):
    """Temporal timesteps implementation."""
    def __init__(self, num_channels: int, flip_sin_to_cos: bool, downscale_freq_shift: float, computation_device = None, scale=1, align_dtype_to_timestep=False):
        ...
        Args:
            ...
            scale: The scale.
            align_dtype_to_timestep: The align dtype to timestep.
        """
        super().__init__()
...
class TrainableTemporalTimesteps(torch.nn.Module):
    """Trainable temporal timesteps implementation."""
...
class PositionalID(torch.nn.Module):
    """Positional id implementation."""
    def __init__(self, max_id=25, repeat_length=20):
        """Init.

        Args:
            max_id: The max id.
            repeat_length: The repeat length.
        """
        super().__init__()
        self.max_id = max_id
    ...
    def forward(self, num_frames, pivot_frame_id=0):
        ...
        Args:
            num_frames: The num frames.
            pivot_frame_id: The pivot frame id.
        """
...
class TemporalAttentionBlock(torch.nn.Module):
    """Temporal attention block implementation."""
    ...
    def __init__(self, num_attention_heads, attention_head_dim, in_channels, cross_attention_dim=None, add_positional_conv=None):
        ...
        Args:
            ...
            add_positional_conv: The add positional conv.
        """
        super().__init__()
...
class SVDUNet(torch.nn.Module):
    ...
    def tiled_forward(
        ...
        Args:
            ...
            batch_height: The batch height.
            batch_width: The batch width.
            stride_time: The stride time.
            stride_height: The stride height.
            stride_width: The stride width.
...
class SVDUNetStateDictConverter:
    """Svdu net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
