"""Module for base_models -> diffusion_model -> diffsynth -> models -> hunyuan_dit.py functionality."""
...
class HunyuanDiTRotaryEmbedding(torch.nn.Module):
    """Hunyuan di t rotary embedding implementation."""

    def __init__(self, q_norm_shape=88, k_norm_shape=88, rotary_emb_on_k=True):
        """Init.

        Args:
            q_norm_shape: The q norm shape.
            k_norm_shape: The k norm shape.
            rotary_emb_on_k: The rotary emb on k.
        """
        super().__init__()
    ...
    def forward(self, q, k, v, freqs_cis_img, to_cache=False):
        ...
        Args:
            ...
            k: The k.
            v: The v.
            freqs_cis_img: The freqs cis img.
            to_cache: The to cache.
        """
        # norm
        q = self.q_norm(q)
        k = self.k_norm(k)
...
class HunyuanDiTFinalLayer(torch.nn.Module):
    """Hunyuan di t final layer implementation."""
    ...
    def forward(self, hidden_states, condition_emb):
        ...
        Args:
            ...
            condition_emb: The condition emb.
        """
...
class HunyuanDiTBlock(torch.nn.Module):
    """Hunyuan di t block implementation."""
    ...
    def __init__(
        ...
        Args:
            ...
            skip_connection: The skip connection.
        """
        super().__init__()
...
class TimestepEmbedder(torch.nn.Module):
    """Timestep embedder implementation."""
...
class HunyuanDiT(torch.nn.Module):
    ...
    def __init__(self, num_layers_down=21, num_layers_up=19, in_channels=4, out_channels=8, hidden_dim=1408, text_dim=1024, t5_dim=2048, text_length=77, t5_length=256):
        ...
        Args:
            num_layers_down: The num layers down.
            num_layers_up: The num layers up.
    ...
    def prepare_text_emb(self, text_emb, text_emb_t5, text_emb_mask, text_emb_mask_t5):
        ...
        Args:
            text_emb: The text emb.
            text_emb_t5: The text emb t5.
            text_emb_mask: The text emb mask.
            text_emb_mask_t5: The text emb mask t5.
        """
...
class HunyuanDiTStateDictConverter():
    """Hunyuan di t state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
