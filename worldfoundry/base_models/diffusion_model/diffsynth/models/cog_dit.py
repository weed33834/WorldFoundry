"""Module for base_models -> diffusion_model -> diffsynth -> models -> cog_dit.py functionality."""

import torch
from einops import rearrange, repeat
from .sd3_dit import TimestepEmbeddings
from .attention import Attention
from worldfoundry.core.model_loading import load_state_dict_from_folder
...
class CogAdaLayerNorm(torch.nn.Module):
    """Cog ada layer norm implementation."""
    def __init__(self, dim, dim_cond, single=False):
        """Init.

        Args:
            dim: The dim.
            dim_cond: The dim cond.
            single: The single.
        """
        super().__init__()
        self.single = single
...
class CogDiTBlock(torch.nn.Module):
    ...
    def process_qkv(self, q, k, v, image_rotary_emb, text_seq_length):
        ...
        Args:
            ...
            text_seq_length: The text seq length.
        """
        q = self.norm_q(q)
        k = self.norm_k(k)
...
class CogDiT(torch.nn.Module):
    ...
    def get_resize_crop_region_for_grid(self, src, tgt_width, tgt_height):
        """Get resize crop region for grid.

        Args:
            src: The src.
            tgt_width: The tgt width.
            tgt_height: The tgt height.
        """
        tw = tgt_width
        th = tgt_height
        h, w = src
    ...
    def get_3d_rotary_pos_embed(
        ...
        """Get 3d rotary pos embed.

        Args:
            embed_dim: The embed dim.
            crops_coords: The crops coords.
            grid_size: The grid size.
            temporal_size: The temporal size.
            theta: The theta.
            use_real: The use real.
        """
...
class CogDiTStateDictConverter:
    """Cog di t state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
