"""Module for base_models -> diffusion_model -> diffsynth -> models -> nexus_gen.py functionality."""
...
class NexusGenAutoregressiveModel(torch.nn.Module):
    ...
    def bound_image(self, image, max_pixels=262640):
        ...
        Args:
            ...
            max_pixels: The max pixels.
        """
        from worldfoundry.base_models.llm_mllm_core.mllm.qwen.qwen_vl_utils import smart_resize
...
class NexusGenAutoregressiveModelStateDictConverter:
    """Nexus gen autoregressive model state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
