"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_unet.py functionality."""
...
class DownSampler(torch.nn.Module):
    ...
    def __init__(self, channels, padding=1, extra_padding=False):
        ...
        Args:
            ...
            padding: The padding.
            extra_padding: The extra padding.
        """
        super().__init__()
...
class AttentionBlock(torch.nn.Module):
    ...
    def __init__(self, num_attention_heads, attention_head_dim, in_channels, num_layers=1, cross_attention_dim=None, norm_num_groups=32, eps=1e-5, need_proj_out=True):
        ...
        Args:
            ...
            eps: The eps.
            need_proj_out: The need proj out.
        """
        super().__init__()
...
class SDUNetStateDictConverter:
    """Sdu net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
