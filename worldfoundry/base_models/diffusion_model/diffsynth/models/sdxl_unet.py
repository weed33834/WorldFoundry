"""Module for base_models -> diffusion_model -> diffsynth -> models -> sdxl_unet.py functionality."""
...
class SDXLUNet(torch.nn.Module):
    """Sdxlu net implementation."""
    def __init__(self, is_kolors=False):
        """Init.

        Args:
            is_kolors: The is kolors.
        """
        super().__init__()
...
class SDXLUNetStateDictConverter:
    """Sdxlu net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
