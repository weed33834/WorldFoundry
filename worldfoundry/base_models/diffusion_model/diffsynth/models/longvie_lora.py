"""Module for base_models -> diffusion_model -> diffsynth -> models -> longvie_lora.py functionality."""
...
class SDLoRAFromCivitai(LoRAFromCivitai):
    """Sd lo ra from civitai implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class SDXLLoRAFromCivitai(LoRAFromCivitai):
    """Sdxl lo ra from civitai implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class FluxLoRAFromCivitai(LoRAFromCivitai):
    """Flux lo ra from civitai implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class GeneralLoRAFromPeft:
    """General lo ra from peft implementation."""
    def __init__(self):
        """Init."""
...
class HunyuanVideoLoRAFromCivitai(LoRAFromCivitai):
    """Hunyuan video lo ra from civitai implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class FluxLoRAConverter:
    """Flux lo ra converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class WanLoRAConverter:
    """Wan lo ra converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class QwenImageLoRAConverter:
    """Qwen image lo ra converter implementation."""
    def __init__(self):
        """Init."""
        pass
