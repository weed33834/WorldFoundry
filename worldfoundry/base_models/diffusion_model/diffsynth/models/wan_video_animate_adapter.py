"""Module for base_models -> diffusion_model -> diffsynth -> models -> wan_video_animate_adapter.py functionality."""
...
class FaceAdapter(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            num_adapter_layers: The num adapter layers.
            dtype: The dtype.
            device: The device.
        """
    ...
    def forward(
        ...
        Args:
            x: The x.
            motion_embed: The motion embed.
            idx: The idx.
            freqs_cis_q: The freqs cis q.
            freqs_cis_k: The freqs cis k.
...
class FaceBlock(nn.Module):
    ...
    def forward(
        ...
        Args:
            x: The x.
            motion_vec: The motion vec.
            motion_mask: The motion mask.
            use_context_parallel: The use context parallel.
        ...
        # Compute attention.
        attn = _worldfoundry_scaled_dot_product_attention(q, k, v)
...
class FusedLeakyReLU(nn.Module):
	"""Fused leaky re lu implementation."""
...
class ScaledLeakyReLU(nn.Module):
	"""Scaled leaky re lu implementation."""
...
class WanAnimateAdapter(torch.nn.Module):
    """Wan animate adapter implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class WanAnimateAdapterStateDictConverter:
    """Wan animate adapter state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
