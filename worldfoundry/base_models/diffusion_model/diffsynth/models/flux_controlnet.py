"""Module for base_models -> diffusion_model -> diffsynth -> models -> flux_controlnet.py functionality."""
...
class FluxControlNet(torch.nn.Module):
    """Flux control net implementation."""
    def __init__(self, disable_guidance_embedder=False, num_joint_blocks=5, num_single_blocks=10, num_mode=0, mode_dict={}, additional_input_dim=0):
        ...
        Args:
            ...
            num_joint_blocks: The num joint blocks.
            num_single_blocks: The num single blocks.
            num_mode: The num mode.
            mode_dict: The mode dict.
            additional_input_dim: The additional input dim.
        """
        super().__init__()
    ...
    def align_res_stack_to_original_blocks(self, res_stack, num_blocks, hidden_states):
        """Align res stack to original blocks.
...
class FluxControlNetStateDictConverter:
    """Flux control net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
