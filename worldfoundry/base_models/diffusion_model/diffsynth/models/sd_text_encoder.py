"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_text_encoder.py functionality."""
...
class CLIPEncoderLayer(torch.nn.Module):
    """Clip encoder layer implementation."""
    def __init__(self, embed_dim, intermediate_size, num_heads=12, head_dim=64, use_quick_gelu=True):
        ...
        Args:
            ...
            use_quick_gelu: The use quick gelu.
        """
        super().__init__()
...
class SDTextEncoder(torch.nn.Module):
    """Sd text encoder implementation."""
...
class SDTextEncoderStateDictConverter:
    """Sd text encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
