"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_controlnet.py functionality."""
...
class ControlNetConditioningLayer(torch.nn.Module):
    """Control net conditioning layer implementation."""
...
class SDControlNetStateDictConverter:
    """Sd control net state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
