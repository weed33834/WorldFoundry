"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_motion.py functionality."""
...
class SDMotionModel(torch.nn.Module):
    """Sd motion model implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class SDMotionModelStateDictConverter:
    """Sd motion model state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
