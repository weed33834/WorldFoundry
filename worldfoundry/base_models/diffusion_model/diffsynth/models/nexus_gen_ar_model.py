"""Module for base_models -> diffusion_model -> diffsynth -> models -> nexus_gen_ar_model.py functionality."""
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def prepare_prefilled_image_embeds(self, cur_image_tokens, num_img_tokens, is_sampling_img, **model_kwargs):
        """Prepare prefilled image embeds.

        Args:
            cur_image_tokens: The cur image tokens.
            num_img_tokens: The num img tokens.
            is_sampling_img: The is sampling img.
        """
    ...
    def _validate_model_kwargs(self, model_kwargs: Dict[str, Any]):
        """Helper function to validate model kwargs.
    ...
    def prepare_image_position_ids(self, input_ids, generation_image_grid_thw, is_sampling_img, **model_kwargs):
        ...
        Args:
            ...
            generation_image_grid_thw: The generation image grid thw.
            is_sampling_img: The is sampling img.
        """
...
class Qwen2_5_VLVideosProcessorKwargs(VideosKwargs, total=False):
    """Qwen vl videos processor kwargs implementation."""
    fps: Union[List[float], float]


class Qwen2_5_VLProcessorKwargs(ProcessingKwargs, total=False):
    """Qwen vl processor kwargs implementation."""
