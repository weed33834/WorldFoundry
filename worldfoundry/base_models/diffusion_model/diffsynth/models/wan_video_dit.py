"""Module for base_models -> diffusion_model -> diffsynth -> models -> wan_video_dit.py functionality."""
...
class WanModelStateDictConverter:
    ...
    def from_civitai(self, state_dict):
        ...
        Args:
            state_dict: The state dict.
        """
        raw_keys_hash = hash_state_dict_keys(state_dict)
        state_dict = {
            name: param
            for name, param in state_dict.items()
            if not name.startswith("vace") and not (name.startswith("control") and not name.startswith("control_adapter"))
        }
        keys_hash = raw_keys_hash if raw_keys_hash in {
            "ac6a5aa74f4a0aab6f64eb9a72f19901",
            "b61c605c2adbd23124d152ed28e049ae",
        } else hash_state_dict_keys(state_dict)
        if keys_hash == "9269f8db9040a9d860eaca435be61814":
            config = {
        ...
        elif keys_hash == "aafcfd9672c3a2456dc46e1cb6e52c70":
            config = {
                "has_image_input": False,
                "patch_size": [1, 2, 2],
                "in_dim": 16,
        ...
        elif keys_hash == "6bfcfb3b342cb286ce886889d519a77e":
            config = {
        ...
        elif keys_hash == "6d6ccde6845b95ad9114ab993d917893":
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
                "in_dim": 36,
        ...
        elif keys_hash == "349723183fc063b2bfc10bb2835cf677":
            # 1.3B PAI control
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
        ...
        elif keys_hash == "efa44cddf936c70abd0ea28b6cbe946c":
            # 14B PAI control
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
        ...
        elif keys_hash == "3ef3b1f8e1dab83d5b71fd7b617f859f":
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
                "in_dim": 36,
        ...
        elif keys_hash == "70ddad9d3a133785da5ea371aae09504":
        ...
        elif keys_hash == "26bde73488a92e64cc20b0a7485b9e5b":
        ...
        elif keys_hash == "ac6a5aa74f4a0aab6f64eb9a72f19901":
        ...
        elif keys_hash == "b61c605c2adbd23124d152ed28e049ae":
