"""Module for base_models -> diffusion_model -> diffsynth -> models -> longcat_video_dit.py functionality."""
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            enable_flashattn3: The enable flashattn3.
            enable_flashattn2: The enable flashattn2.
            enable_xformers: The enable xformers.
            enable_bsa: The enable bsa.
            bsa_params: The bsa params.
            cp_split_hw: The cp split hw.
    ...
    def _process_attn(self, q, k, v, shape):
        """Helper function to process attn.
...
class MultiHeadCrossAttention(nn.Module):
    ...
    def _process_cross_attn(self, x, cond, kv_seqlen):
        """Helper function to process cross attn.

        Args:
            x: The x.
            cond: The cond.
            kv_seqlen: The kv seqlen.
        """
        B, N, C = x.shape
...
class FinalLayer_FP32(nn.Module):
    ...
    def __init__(self, hidden_size, num_patch, out_channels, adaln_tembed_dim):
        ...
        Args:
            ...
            num_patch: The num patch.
            out_channels: The out channels.
            adaln_tembed_dim: The adaln tembed dim.
        """
        super().__init__()
...
class FeedForwardSwiGLU(nn.Module):
    """Feed forward swi glu implementation."""
    def __init__(
        self,
        dim: int,
        hidden_dim: int,
        ...
        Args:
            ...
            ffn_dim_multiplier: The ffn dim multiplier.
        """
        super().__init__()
...
class LongCatSingleStreamBlock(nn.Module):
    """Long cat single stream block implementation."""
    def __init__(
        self,
        hidden_size: int,
        num_heads: int,
...
class LongCatVideoTransformer3DModel(torch.nn.Module):
    """Long cat video transformer d model implementation."""
    def __init__(
        self,
        in_channels: int = 16,
        out_channels: int = 16,
        ...
        Args:
            ...
            bsa_params: The bsa params.
            cp_split_hw: The cp split hw.
            text_tokens_zero_pad: The text tokens zero pad.
    ...
    def enable_loras(self, lora_key_list=[]):
        ...
        Args:
            lora_key_list: The lora key list.
        """
    ...
    def _create_multi_lora_forward(self, module, loras):
        """Helper function to create multi lora forward.
    ...
    def forward(
        ...
        Args:
            ...
            num_cond_latents: The num cond latents.
            return_kv: The return kv.
            kv_cache_dict: The kv cache dict.
            skip_crs_attn: The skip crs attn.
            offload_kv_cache: The offload kv cache.
...
class LongCatVideoTransformer3DModelDictConverter:
    """Long cat video transformer d model dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
