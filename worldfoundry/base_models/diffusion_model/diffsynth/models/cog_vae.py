"""Module for base_models -> diffusion_model -> diffsynth -> models -> cog_vae.py functionality."""
...
class Downsample3D(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            stride: The stride.
            padding: The padding.
            compress_time: The compress time.
        """
        super().__init__()
...
class CogVideoXSpatialNorm3D(torch.nn.Module):
    """Cog video x spatial norm d implementation."""
...
class Resnet3DBlock(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, spatial_norm_dim, groups, eps=1e-6, use_conv_shortcut=False):
        ...
        Args:
            ...
            groups: The groups.
            eps: The eps.
            use_conv_shortcut: The use conv shortcut.
        """
        super().__init__()
...
class CogVAEDecoder(torch.nn.Module):
    """Cog vae decoder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class CogVAEEncoder(torch.nn.Module):
    """Cog vae encoder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
        self.scaling_factor = 0.7
...
class CogVAEEncoderStateDictConverter:
    """Cog vae encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class CogVAEDecoderStateDictConverter:
    """Cog vae decoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
