"""Module for base_models -> diffusion_model -> diffsynth -> models -> scope_model_loader.py functionality."""

from worldfoundry.core.model_loading import hash_model_file, load_model
from worldfoundry.core.vram import AutoWrappedModule
from ..configs.scope_model_configs import MODEL_CONFIGS
from ..configs.scope_vram_management_module_maps import VRAM_MANAGEMENT_MODULE_MAPS
...
class ModelPool:
    ...
    def need_to_enable_vram_management(self, vram_config):
        """Need to enable vram management.

        Args:
            vram_config: The vram config.
        """
    ...
    def auto_load_model(self, path, vram_config=None, vram_limit=None, clear_parameters=False, state_dict=None):
        ...
        Args:
            ...
            vram_config: The vram config.
            vram_limit: The vram limit.
            clear_parameters: The clear parameters.
            state_dict: The state dict.
        """
