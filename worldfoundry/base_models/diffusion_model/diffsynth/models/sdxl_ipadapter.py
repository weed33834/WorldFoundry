"""Module for base_models -> diffusion_model -> diffsynth -> models -> sdxl_ipadapter.py functionality."""
...
class IpAdapterXLCLIPImageEmbedder(SVDImageEncoder):
    """Ip adapter xlclip image embedder implementation."""
    def __init__(self):
        """Init."""
...
class IpAdapterImageProjModel(torch.nn.Module):
    """Ip adapter image proj model implementation."""
...
class SDXLIpAdapter(torch.nn.Module):
    """Sdxl ip adapter implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class SDXLIpAdapterStateDictConverter:
    """Sdxl ip adapter state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
