"""Module for base_models -> diffusion_model -> diffsynth -> models -> hunyuan_dit_text_encoder.py functionality."""
...
class HunyuanDiTCLIPTextEncoder(BertModel):
    """Hunyuan di tclip text encoder implementation."""
    def __init__(self):
        """Init."""
        config = BertConfig(
            _name_or_path = "",
...
class HunyuanDiTT5TextEncoder(T5EncoderModel):
    """Hunyuan di text encoder implementation."""
    def __init__(self):
        """Init."""
        config = T5Config(
...
class HunyuanDiTCLIPTextEncoderStateDictConverter():
    """Hunyuan di tclip text encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class HunyuanDiTT5TextEncoderStateDictConverter():
    """Hunyuan di text encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
