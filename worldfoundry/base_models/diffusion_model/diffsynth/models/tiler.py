"""Module for base_models -> diffusion_model -> diffsynth -> models -> tiler.py functionality."""
...
class TileWorker:
    ...
    def tile(self, model_input, tile_size, tile_stride, tile_device, tile_dtype):
        ...
        Args:
            ...
            tile_device: The tile device.
            tile_dtype: The tile dtype.
        """
    ...
    def tiled_inference(self, forward_fn, model_input, tile_batch_size, inference_device, inference_dtype, tile_device, tile_dtype):
        ...
        Args:
            forward_fn: The forward fn.
            model_input: The model input.
            tile_batch_size: The tile batch size.
            inference_device: The inference device.
            inference_dtype: The inference dtype.
            tile_device: The tile device.
            tile_dtype: The tile dtype.
        """
...
class FastTileWorker:
    """Fast tile worker implementation."""
    def __init__(self):
        """Init."""
        pass
