"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_ipadapter.py functionality."""
...
class IpAdapterCLIPImageEmbedder(SVDImageEncoder):
    """Ip adapter clip image embedder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class SDIpAdapterStateDictConverter(SDXLIpAdapterStateDictConverter):
    """Sd ip adapter state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
