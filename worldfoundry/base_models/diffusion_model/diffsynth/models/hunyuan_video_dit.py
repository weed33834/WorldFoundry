"""Module for base_models -> diffusion_model -> diffsynth -> models -> hunyuan_video_dit.py functionality."""
...
class IndividualTokenRefinerBlock(torch.nn.Module):
    ...
    def forward(self, x, c, attn_mask=None):
        ...
        attn = _worldfoundry_scaled_dot_product_attention(q, k, v, attn_mask=attn_mask)
...
def modulate(x, shift=None, scale=None, tr_shift=None, tr_scale=None, tr_token=None):
    ...
    Args:
        ...
        shift: The shift.
        scale: The scale.
        tr_shift: The tr shift.
        tr_scale: The tr scale.
...
class HunyuanVideoDiT(torch.nn.Module):
    ...
    def enable_block_wise_offload(self, warm_device="cuda", cold_device="cpu"):
        """Enable block wise offload.

        Args:
            warm_device: The warm device.
            cold_device: The cold device.
        """
    ...
    def load_models_to_device(self, loadmodel_names=[], device="cpu"):
        ...
        Args:
            loadmodel_names: The loadmodel names.
            device: The device.
        """
