"""Module for base_models -> diffusion_model -> diffsynth -> models -> wan_video_mot.py functionality."""
...
class MotSelfAttention(SelfAttention):
    """Mot self attention implementation."""
    ...
    def forward(self, x, freqs, is_before_attn=False):
        ...
        Args:
            x: The x.
            freqs: The freqs.
            is_before_attn: The is before attn.
        """
        if is_before_attn:
...
class MotWanAttentionBlock(DiTBlock):
    """Mot wan attention block implementation."""
    ...
    def forward(self, wan_block, x, context, t_mod, freqs, x_mot, context_mot, t_mod_mot, freqs_mot):
        ...
        Args:
            wan_block: The wan block.
            x: The x.
            context: The context.
            t_mod: The t mod.
            freqs: The freqs.
            x_mot: The x mot.
            context_mot: The context mot.
            t_mod_mot: The t mod mot.
            freqs_mot: The freqs mot.
        """
