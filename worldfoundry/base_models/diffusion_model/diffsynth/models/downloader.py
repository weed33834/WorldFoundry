"""Module for base_models -> diffusion_model -> diffsynth -> models -> downloader.py functionality."""
...
def download_from_modelscope(model_id, origin_file_path, local_dir):
    ...
    Args:
        ...
        origin_file_path: The origin file path.
        local_dir: The local dir.
    """
    try:
        from modelscope import snapshot_download
    except ModuleNotFoundError as exc:
        raise ModuleNotFoundError(
            "LongVie local inference does not require modelscope, but ModelScope downloads do. "
            "Install modelscope or use a local checkpoint path."
        ) from exc
...
def download_from_huggingface(model_id, origin_file_path, local_dir):
    ...
    try:
        ...
        raise ModuleNotFoundError(
            "LongVie local inference does not require huggingface_hub, but Hugging Face downloads do. "
            "Install huggingface_hub or use a local checkpoint path."
        ) from exc
