"""Module for base_models -> diffusion_model -> diffsynth -> models -> svd_vae_encoder.py functionality."""

from .sd_vae_encoder import SDVAEEncoderStateDictConverter, SDVAEEncoder


class SVDVAEEncoder(SDVAEEncoder):
    """Svdvae encoder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class SVDVAEEncoderStateDictConverter(SDVAEEncoderStateDictConverter):
    """Svdvae encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
