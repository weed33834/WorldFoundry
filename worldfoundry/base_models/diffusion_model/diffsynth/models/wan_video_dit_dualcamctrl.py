"""DualCamCtrl-specific Wan DiT/control-net definitions.

This module preserves the official DualCamCtrl inference-time model behavior
without changing the canonical Wan DiT used by other WorldFoundry runtimes.
"""
