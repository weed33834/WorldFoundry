"""Module for base_models -> diffusion_model -> diffsynth -> models -> sd_vae_decoder.py functionality."""
...
class SDVAEDecoderStateDictConverter:
    """Sdvae decoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
