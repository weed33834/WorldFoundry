"""Module for base_models -> diffusion_model -> diffsynth -> models -> flux_vae.py functionality."""
...
class FluxVAEEncoder(SD3VAEEncoder):
    """Flux vae encoder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
...
class FluxVAEDecoder(SD3VAEDecoder):
    """Flux vae decoder implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
        self.scaling_factor = 0.3611
...
class FluxVAEEncoderStateDictConverter(SDVAEEncoderStateDictConverter):
    """Flux vae encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
...
class FluxVAEDecoderStateDictConverter(SDVAEDecoderStateDictConverter):
    """Flux vae decoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
