"""Module for base_models -> diffusion_model -> diffsynth -> auxiliary_models -> worldmirror -> utils -> inference_utils.py functionality."""
...
def extract_load_and_preprocess_images(image_folder_or_video_path, fps=1, target_size=518, mode="crop"):
    """Extract load and preprocess images.

    Args:
        image_folder_or_video_path: The image folder or video path.
        fps: The fps.
