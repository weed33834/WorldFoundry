"""Module for base_models -> diffusion_model -> diffsynth -> auxiliary_models -> worldmirror -> models -> models -> worldmirror.py functionality."""
...
class WorldMirror(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(self,
        ...
        Args:
            ...
            enable_dynamic_gs_attr: The enable dynamic gs attr.
            life_span_gamma: The life span gamma.
            dynamic_threshold: The dynamic threshold.
            enable_global_motion_tracking: The enable global motion tracking.
    ...
    def transform_camera_vector(self, camera_params, h, w):
        """Transform camera vector.

        Args:
            camera_params: The camera params.
            h: The h.
            w: The w.
        """
    ...
    def prepare_contexts(self, views, cond_flags, is_inference, use_motion):
        ...
        Args:
            views: The views.
            cond_flags: The cond flags.
            is_inference: The is inference.
            use_motion: The use motion.
        """
