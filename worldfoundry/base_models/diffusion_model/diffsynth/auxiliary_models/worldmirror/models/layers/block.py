...
"""Module for base_models -> diffusion_model -> diffsynth -> auxiliary_models -> worldmirror -> models -> layers -> block.py functionality."""
...
class CrossBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            norm_layer: The norm layer.
            attn_class: The attn class.
            cross_attn_class: The cross attn class.
            ffn_layer: The ffn layer.
            qk_norm: The qk norm.
            fused_attn: The fused attn.
            rope: The rope.
    ...
    def forward(self, x: Tensor, y: Tensor, xpos=None, ypos=None) -> Tensor:
        ...
        Returns:
            The return value.
        """
        def cross_attn_residual_func(x: Tensor, y: Tensor, xpos=None, ypos=None) -> Tensor:
            """Cross attn residual func.
            ...
            """
            y_ = self.norm_y(y)
            return self.ls1(self.cross_attn(self.norm1(x), y_, y_, xpos, ypos))
        ...
        if self.training and self.sample_drop_ratio > 0.0:
            x = x + self.drop_path1(cross_attn_residual_func(x, y, xpos=xpos, ypos=ypos))
            x = x + self.drop_path2(ffn_residual_func(x))
        else:
            x = x + cross_attn_residual_func(x, y, xpos=xpos, ypos=ypos)
            x = x + ffn_residual_func(x)
        return x
