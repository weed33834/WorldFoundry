...
"""Module for base_models -> diffusion_model -> diffsynth -> auxiliary_models -> worldmirror -> models -> layers -> attention.py functionality."""
...
class CrossAttention(nn.Module):
    ...
    def forward(self, query, key, value, qpos, kpos) -> Tensor:
        """Forward.
        ...
        q = self.projq(query).reshape(B, N, self.num_heads, self.head_dim).permute(0, 2, 1, 3)
