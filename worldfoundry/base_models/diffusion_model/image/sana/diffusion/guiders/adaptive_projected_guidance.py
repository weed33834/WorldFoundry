...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> guiders -> adaptive_projected_guidance.py functionality."""
...
class AdaptiveProjectedGuidance:
    ...
    def __init__(
        ...
        Args:
            ...
            adaptive_projected_guidance_momentum: The adaptive projected guidance momentum.
            adaptive_projected_guidance_rescale: The adaptive projected guidance rescale.
            eta: The eta.
            guidance_rescale: The guidance rescale.
            use_original_formulation: The use original formulation.
            start: The start.
            stop: The stop.
            mode: The mode.
        """
...
class MomentumBuffer:
    """Momentum buffer implementation."""
...
def normalized_guidance(
    ...
    Args:
        pred_cond: The pred cond.
        pred_uncond: The pred uncond.
        guidance_scale: The guidance scale.
        momentum_buffer: The momentum buffer.
        eta: The eta.
        norm_threshold: The norm threshold.
        mode: The mode.
    """
