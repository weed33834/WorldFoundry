...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> data -> wids -> wids_tar.py functionality."""
...
class TarFileReader:
    """Tar file reader implementation."""
    ...
    def _create_tar_index(self):
        """Helper function to create tar index."""
