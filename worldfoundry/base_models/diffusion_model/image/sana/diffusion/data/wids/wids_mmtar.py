...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> data -> wids -> wids_mmtar.py functionality."""
...
class MMIndexedTar:
    ...
    def __init__(self, fname, index_file=None, verbose=True, cleanup_callback=None):
        ...
        Args:
            ...
            verbose: The verbose.
            cleanup_callback: The cleanup callback.
        """
