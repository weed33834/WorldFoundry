...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> data -> datasets -> sana_data.py functionality."""
...
class SanaImgDataset(Dataset):
    """Sana img dataset implementation."""
    def __init__(
        self,
        data_dir="",
        transform=None,
        ...
        **kwargs,
        ...
        Args:
            ...
            img_extension: The img extension.
        """
...
class SanaWebDataset(Dataset):
    """Sana web dataset implementation."""
    def __init__(
        self,
        data_dir="",
        meta_path=None,
    ...
    def _initialize_dataset(self, num_replicas, sort_dataset):
        """Helper function to initialize dataset.
