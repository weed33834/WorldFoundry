...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> data -> datasets -> sana_data_multi_scale.py functionality."""
...
class SanaWebDatasetMS(SanaWebDataset):
    """Sana web dataset ms implementation."""
    def __init__(
        self,
        data_dir="",
        meta_path=None,
        cache_dir=os.environ.get("WORLDFOUNDRY_SANA_WEBDS_META_CACHE", "cache/worldfoundry/sana-webds-meta"),
        ...
        **kwargs,
        ...
        Args:
            ...
            meta_path: The meta path.
            cache_dir: The cache dir.
            max_shards_to_load: The max shards to load.
            transform: The transform.
            resolution: The resolution.
            aspect_ratio_type: The aspect ratio type.
            sample_subset: The sample subset.
            ...
            num_replicas: The num replicas.
            caption_selection_type: The caption selection type.
            external_caption_suffixes: The external caption suffixes.
            external_clipscore_suffixes: The external clipscore suffixes.
            clip_thr: The clip thr.
            clip_thr_temperature: The clip thr temperature.
            vae_downsample_rate: The vae downsample rate.
        """
        super().__init__(
            data_dir=data_dir,
            meta_path=meta_path,
...
class DummyDatasetMS(SanaWebDatasetMS):
    """Dummy dataset ms implementation."""
