...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> gaussian_diffusion.py functionality."""
...
def _warmup_beta(beta_start, beta_end, num_diffusion_timesteps, warmup_frac):
    """Helper function to warmup beta.

    Args:
        beta_start: The beta start.
        beta_end: The beta end.
        num_diffusion_timesteps: The num diffusion timesteps.
        warmup_frac: The warmup frac.
    """
...
class GaussianDiffusion:
    ...
    def _predict_xstart_from_eps(self, x_t, t, eps):
        """Helper function to predict xstart from eps.
    ...
    def _predict_eps_from_xstart(self, x_t, t, pred_xstart):
        """Helper function to predict eps from xstart.

        Args:
            x_t: The x t.
            t: The t.
            pred_xstart: The pred xstart.
        """
        return (
