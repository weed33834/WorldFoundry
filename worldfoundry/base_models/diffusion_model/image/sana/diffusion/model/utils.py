...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> utils.py functionality."""
...
def get_weight_dtype(mixed_precision):
    ...
    Args:
        mixed_precision: The mixed precision.
    """
...
def create_block_mask_cached(score_mod, B, H, M, N, device="cuda", _compile=False):
    """Create block mask cached.

    Args:
        score_mod: The score mod.
        B: The b.
        H: The h.
        M: The m.
        N: The n.
        device: The device.
        _compile: The compile.
    """
