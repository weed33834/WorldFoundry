"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> apps -> setup.py functionality."""
...
def init_model(
    ...
    Args:
        network: The network.
        init_from: The init from.
        backbone_init_from: The backbone init from.
        rand_init: The rand init.
        last_gamma: The last gamma.
