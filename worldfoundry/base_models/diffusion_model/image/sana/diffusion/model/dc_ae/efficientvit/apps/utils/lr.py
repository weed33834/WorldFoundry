...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> apps -> utils -> lr.py functionality."""
...
class CosineLRwithWarmup(torch.optim.lr_scheduler._LRScheduler):
    """Cosine l rwith warmup implementation."""
    def __init__(
        self,
        ...
        Args:
            ...
            warmup_lr: The warmup lr.
            decay_steps: The decay steps.
...
class ConstantLRwithWarmup(torch.optim.lr_scheduler._LRScheduler):
    """Constant l rwith warmup implementation."""
    def __init__(
        self,
        optimizer: torch.optim.Optimizer,
        warmup_steps: int,
