...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> apps -> utils -> metric.py functionality."""
...
class AverageMeter:
    ...
    def __init__(self, is_distributed=True):
        ...
        Args:
            is_distributed: The is distributed.
        """
