...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> apps -> utils -> opt.py functionality."""
...
def build_optimizer(
    ...
    Args:
        net_params: The net params.
        optimizer_name: The optimizer name.
        optimizer_params: The optimizer params.
        init_lr: The init lr.
