...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> models -> utils -> random.py functionality."""
...
def torch_random_choices(
    ...
    """Torch random choices.

    Args:
        src_list: The src list.
        generator: The generator.
        k: The k.
        weight_list: The weight list.
