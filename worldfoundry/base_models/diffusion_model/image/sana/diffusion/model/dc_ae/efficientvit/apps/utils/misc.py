...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> apps -> utils -> misc.py functionality."""
...
def partial_update_config(config: dict, partial_config: dict) -> dict:
    ...
    Args:
        config: The config.
        partial_config: The partial config.
