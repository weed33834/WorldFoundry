...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dc_ae -> efficientvit -> models -> utils -> network.py functionality."""
...
def load_state_dict_from_file(file: str, only_state_dict=True) -> dict[str, torch.Tensor]:
    ...
    Args:
        file: The file.
        only_state_dict: The only state dict.
