...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> nets -> sana_ladd.py functionality."""
...
class DiscHeadModel:
    """Disc head model implementation."""
