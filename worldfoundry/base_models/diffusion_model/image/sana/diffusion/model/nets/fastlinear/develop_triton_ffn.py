...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> nets -> fastlinear -> develop_triton_ffn.py functionality."""
...
class DevelopTritonFFNConfig:
    """Develop triton ffn config implementation."""
    batch_size: int = 16
