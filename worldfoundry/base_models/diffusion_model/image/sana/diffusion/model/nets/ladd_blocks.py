...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> nets -> ladd_blocks.py functionality."""
...
class SpectralConv1d(nn.Conv1d):
    """Spectral conv d implementation."""
...
class BatchNormLocal(nn.Module):
    """Batch norm local implementation."""
