...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> timestep_sampler.py functionality."""
...
class UniformSampler(ScheduleSampler):
    """Uniform sampler implementation."""
...
class LossAwareSampler(ScheduleSampler):
    """Loss aware sampler implementation."""
...
class LossSecondMomentResampler(LossAwareSampler):
    """Loss second moment resampler implementation."""
    def __init__(self, diffusion, history_per_term=10, uniform_prob=0.001):
        """Init.

        Args:
            diffusion: The diffusion.
            history_per_term: The history per term.
            uniform_prob: The uniform prob.
        """
        self.diffusion = diffusion
