...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> model -> dpm_solver.py functionality."""
...
class NoiseScheduleVP:
    """Noise schedule vp implementation."""
    def __init__(
        self,
        schedule="discrete",
        betas=None,
...
class NoiseScheduleFlow:
    """Noise schedule flow implementation."""
    def __init__(
        self,
...
class ForwardWithSTG:
    """Forward with stg implementation."""
...
class DPM_Solver:
    ...
    def __init__(
        ...
        def _expand_time(x, t):
            """Helper function to expand time.
