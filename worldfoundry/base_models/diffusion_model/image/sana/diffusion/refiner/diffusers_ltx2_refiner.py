...
class DiffusersLTX2Refiner(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            refiner_root: The refiner root.
            gemma_root: The gemma root.
    ...
    def _predict_current_x0(
        ...
        *,
        ...
        """Helper function to predict current x0.
    ...
    def _forward_video_only(
        ...
        *,
        ...
        """Helper function to forward video only.
...
def _forward_video_block(
    *,
    ...
    """Helper function to forward video block.
...
def _pack_text_embeds(
    ...
    """Helper function to pack text embeds.

    Args:
        text_hidden_states: The text hidden states.
