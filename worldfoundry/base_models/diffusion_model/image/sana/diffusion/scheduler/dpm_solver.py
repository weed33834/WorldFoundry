...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> scheduler -> dpm_solver.py functionality."""
...
def DPMS(
    ...
    **kwargs,
    ...
    Args:
        ...
        uncondition: The uncondition.
        cfg_scale: The cfg scale.
        pag_scale: The pag scale.
        pag_applied_layers: The pag applied layers.
        model_type: The model type.
        noise_schedule: The noise schedule.
        guidance_type: The guidance type.
        model_kwargs: The model kwargs.
        diffusion_steps: The diffusion steps.
        schedule: The schedule.
        interval_guidance: The interval guidance.
        condition_as_list: The condition as list.
        apg: The apg.
    """
