...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> scheduler -> lcm_scheduler.py functionality."""
...
class LCMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            clip_sample: The clip sample.
            set_alpha_to_one: The set alpha to one.
            ...
            clip_sample_range: The clip sample range.
    ...
    def _get_variance(self, timestep, prev_timestep):
        ...
        Args:
            ...
            prev_timestep: The prev timestep.
        """
    ...
    def get_scalings_for_boundary_condition_discrete(self, t):
        """Get scalings for boundary condition discrete.
