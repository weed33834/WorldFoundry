...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> scheduler -> sa_solver_diffusers.py functionality."""
...
class SASolverScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            beta_start: The beta start.
            beta_end: The beta end.
            beta_schedule: The beta schedule.
            trained_betas: The trained betas.
            predictor_order: The predictor order.
            corrector_order: The corrector order.
            predictor_corrector_mode: The predictor corrector mode.
            prediction_type: The prediction type.
            tau_func: The tau func.
    ...
    def get_coefficients_fn(self, order, interval_start, interval_end, lambda_list, tau):
        ...
        Args:
            order: The order.
            interval_start: The interval start.
            interval_end: The interval end.
            lambda_list: The lambda list.
            tau: The tau.
        """
