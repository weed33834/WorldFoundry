...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> utils -> logger.py functionality."""
...
class TimezoneFormatter(logging.Formatter):
    """Timezone formatter implementation."""
...
def rename_file_with_creation_time(file_path):
    """Rename file with creation time.
