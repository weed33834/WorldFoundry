...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> utils -> camctrl_config.py functionality."""
...
class VideoDataCamCtrlConfig(VideoDataConfig):
    """Video data cam ctrl config implementation."""
...
class ModelVideoCamCtrlConfig(ModelVideoConfig):
    """Model video cam ctrl config implementation."""
...
class TrainVideoCamCtrlConfig(TrainVideoConfig):
    """Train video cam ctrl config implementation."""
...
class SanaVideoCamCtrlConfig(SanaVideoConfig):
    """Sana video cam ctrl config implementation."""
...
def model_video_camctrl_init_config(config: SanaVideoCamCtrlConfig, latent_size: int = 32):
    """Model video camctrl init config.
