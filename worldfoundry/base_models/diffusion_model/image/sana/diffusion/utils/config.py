...
"""Module for base_models -> diffusion_model -> image -> sana -> diffusion -> utils -> config.py functionality."""
...
class VideoDataConfig(DataConfig):
    """Video data config implementation."""
...
class ModelVideoConfig(ModelConfig):
    """Model video config implementation."""
    # stage1
...
class TextEncoderConfig(BaseConfig):
    """Text encoder config implementation."""
...
class ImageEncoderConfig(BaseConfig):
    """Image encoder config implementation."""
...
class SchedulerConfig(BaseConfig):
    """Scheduler config implementation."""
...
class TrainVideoConfig(TrainingConfig):
    """Train video config implementation."""
...
class ControlNetConfig(BaseConfig):
    """Control net config implementation."""
...
class WanTextEncoderConfig(BaseConfig):
    """Wan text encoder config implementation."""
...
class DistillConfig(BaseConfig):
    """Distill config implementation."""
    pass


@dataclass
class SanaVideoConfig(BaseConfig):
    """Sana video config implementation."""
...
class SanaVideoStage1Config(BaseConfig):
    """Sana video stage config implementation."""
    data: DataConfig
    model: ModelVideoConfig
    vae: AEConfig
    text_encoder: TextEncoderConfig
