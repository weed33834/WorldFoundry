...
"""Module for base_models -> diffusion_model -> image -> sana -> scripts -> inference.py functionality."""
...
class SanaInference(SanaConfig):
    ...
    config: Optional[str] = _sana_config_path("sana_config", "1024ms", "Sana_1600M_img1024.yaml")
...
if __name__ == "__main__":
    ...
    def guidance_type_select(default_guidance_type, pag_scale, attn_type):
        """Guidance type select.

        Args:
            default_guidance_type: The default guidance type.
            pag_scale: The pag scale.
