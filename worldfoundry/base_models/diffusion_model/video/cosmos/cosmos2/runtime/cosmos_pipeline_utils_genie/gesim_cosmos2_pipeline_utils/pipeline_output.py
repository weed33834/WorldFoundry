"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_pipeline_utils_genie -> gesim_cosmos2_pipeline_utils -> pipeline_output.py functionality."""
