...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> configs -> action_conditioned -> defaults -> data.py functionality."""
...
def register_training_and_val_data_action_conditioned():
    """Register training and val data action conditioned."""
