...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> tokenizers -> tokenizer.py functionality."""
    ...
    if pretrained_path is None:
        ...
        if get_rank() == 0:
            ...
            if load_mean_std:
                ...
                img_mean, img_std = load_serialized(img_mean_std, map_location=device)
                video_mean, video_std = load_serialized(video_mean_std, map_location=device)
