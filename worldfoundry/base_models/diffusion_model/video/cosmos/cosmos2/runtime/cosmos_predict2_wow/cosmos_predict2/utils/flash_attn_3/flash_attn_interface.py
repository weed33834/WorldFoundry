...
"""
Copied from flash-attention repository, with necessary modifications to register FA3 as PyTorch operation.
It's requires to use FA3 with Selective Activation Checkpointing.
Original source: https://github.com/Dao-AILab/flash-attention/blob/27f501dbe011f4371bff938fe7e09311ab3002fa/hopper/flash_attn_interface.py
Used to build docker images with FA3 support.
...
def _flash_attn_forward(
    ...
    """Helper function to flash attn forward.
    ...
    Args:
        ...
        qv: The qv.
        out: The out.
        cu_seqlens_q: The cu seqlens q.
        cu_seqlens_k: The cu seqlens k.
        cu_seqlens_k_new: The cu seqlens k new.
        seqused_q: The seqused q.
        seqused_k: The seqused k.
        max_seqlen_q: The max seqlen q.
        max_seqlen_k: The max seqlen k.
        page_table: The page table.
        kv_batch_idx: The kv batch idx.
        leftpad_k: The leftpad k.
        rotary_cos: The rotary cos.
        rotary_sin: The rotary sin.
        q_descale: The q descale.
        k_descale: The k descale.
        v_descale: The v descale.
        softmax_scale: The softmax scale.
        causal: The causal.
        window_size_left: The window size left.
        window_size_right: The window size right.
        softcap: The softcap.
        rotary_interleaved: The rotary interleaved.
        scheduler_metadata: The scheduler metadata.
        num_splits: The num splits.
        pack_gqa: The pack gqa.
        sm_margin: The sm margin.
...
def _flash_attn_backward(
    ...
    """Helper function to flash attn backward.
    ...
    Args:
        ...
        v: The v.
        out: The out.
        softmax_lse: The softmax lse.
        cu_seqlens_q: The cu seqlens q.
        cu_seqlens_k: The cu seqlens k.
        sequed_q: The sequed q.
        sequed_k: The sequed k.
        max_seqlen_q: The max seqlen q.
        max_seqlen_k: The max seqlen k.
        dq: The dq.
        dk: The dk.
...
def flash_attn_combine(out_partial, lse_partial, out=None, out_dtype=None):
    ...
    Args:
        out_partial: The out partial.
        lse_partial: The lse partial.
        out: The out.
...
def get_scheduler_metadata(
    ...
    Args:
        ...
        max_seqlen_k: The max seqlen k.
        num_heads_q: The num heads q.
        num_heads_kv: The num heads kv.
        headdim: The headdim.
        cache_seqlens: The cache seqlens.
        qkv_dtype: The qkv dtype.
        headdim_v: The headdim v.
        cu_seqlens_q: The cu seqlens q.
        cu_seqlens_k_new: The cu seqlens k new.
        cache_leftpad: The cache leftpad.
        page_size: The page size.
        max_seqlen_k_new: The max seqlen k new.
        causal: The causal.
        window_size: The window size.
        has_softcap: The has softcap.
        num_splits: The num splits.
        pack_gqa: The pack gqa.
        sm_margin: The sm margin.
    """
