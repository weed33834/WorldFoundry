...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> pipelines -> video2world.py functionality."""
...
class Video2WorldPipeline(BasePipeline):
    ...
    def from_config(
        ...
        Args:
            ...
            device: The device.
            torch_dtype: The torch dtype.
            load_prompt_refiner: The load prompt refiner.
