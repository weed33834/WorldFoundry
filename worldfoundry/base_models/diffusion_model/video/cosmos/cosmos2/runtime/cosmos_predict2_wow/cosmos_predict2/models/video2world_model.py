...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> models -> video2world_model.py functionality."""
...
class Predict2ModelManagerConfig:
    """Predict model manager config implementation."""
...
class Predict2Video2WorldModelConfig:
    """Predict video world model config implementation."""
...
class Predict2Video2WorldModel(ImaginaireModel):
    """Predict video world model implementation."""
    ...
    def add_lora_to_model(
        ...
        Args:
            ...
            lora_target_modules: The lora target modules.
    ...
    def training_step(self, data_batch: dict, data_batch_idx: int) -> tuple[dict, torch.Tensor]:
        ...
        Args:
            data_batch: The data batch.
            data_batch_idx: The data batch idx.
