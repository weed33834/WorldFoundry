...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> configs -> vid2vid -> defaults -> conditioner.py functionality."""
...
class Vid2VidCondition(T2VCondition):
    ...
    def set_video_condition(
        ...
        for idx in range(B):
            ...
            # -------------------------------------- PD ----------------------------------------- +
            # condition_video_input_mask_B_C_T_H_W[idx, :, :1, :, :] += 1
            # -------------------------------------- PD ----------------------------------------- -
