...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> pipelines -> text2image.py functionality."""
...
class Text2ImagePipeline(BasePipeline):
    ...
    def __call__(
        ...
        Args:
            ...
            use_cuda_graphs: The use cuda graphs.
