...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> networks -> neighborhood_attn.py functionality."""
...
try:
    ...
    def neighborhood_attention_generic(*args, **kwargs):
        """Neighborhood attention generic."""
...
class NeighborhoodAttention(nn.Module):
    ...
    def __init__(self, gna_parameters, base_attn_op):
        ...
        Args:
            gna_parameters: The gna parameters.
            base_attn_op: The base attn op.
        """
