...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> data -> webdataloader.py functionality."""
...
class WebDataLoader(_DataLoader):
    """Web data loader implementation."""
    def __init__(
        self,
