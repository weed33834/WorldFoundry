...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> schedulers -> rectified_flow_scheduler.py functionality."""
...
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.runge_kutta import (
    reg_x0_euler_step,
    res_x0_rk2_step,
)
    ...
    def __init__(
        ...
        **kpm2_kwargs,
        ...
        Args:
            ...
            order: The order.
            t_scaling_factor: The t scaling factor.
            use_double_precision: The use double precision.
        """
        super().__init__(
