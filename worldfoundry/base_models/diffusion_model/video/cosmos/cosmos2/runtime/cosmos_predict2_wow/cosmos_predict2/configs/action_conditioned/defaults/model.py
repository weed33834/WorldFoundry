...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> configs -> action_conditioned -> defaults -> model.py functionality."""
...
def register_model_action_conditioned() -> None:
    """Register model action conditioned.
