...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2_wow -> cosmos_predict2 -> data -> datasets.py functionality."""
...
class TensorDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, base_path, metadata_path, steps_per_epoch, debug_without_randomness=False):
        ...
        Args:
            ...
            metadata_path: The metadata path.
            steps_per_epoch: The steps per epoch.
            debug_without_randomness: The debug without randomness.
        """
