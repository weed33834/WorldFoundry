...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> lazy_config -> instantiate.py functionality."""
...
from cosmos_predict2._src.imaginaire.lazy_config.registry import _convert_target_to_string, locate
