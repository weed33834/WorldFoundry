...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> easy_io -> file_client.py functionality."""
...
from cosmos_predict2._src.imaginaire.utils.easy_io.backends import (
    BaseStorageBackend,
    HTTPBackend,
    LocalBackend,
    MSCBackend,
...
class FileClient:
    ...
    def _register_backend(cls, name, backend, force=False, prefixes=None):
        """Helper function to register backend.
