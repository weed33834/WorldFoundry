...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> checkpointer -> tp.py functionality."""

from cosmos_predict2._src.imaginaire.checkpointer.ddp import Checkpointer as DDPCheckpointer
