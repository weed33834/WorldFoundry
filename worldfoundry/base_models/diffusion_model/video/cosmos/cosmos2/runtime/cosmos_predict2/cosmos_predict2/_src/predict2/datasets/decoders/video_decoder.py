...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> datasets -> decoders -> video_decoder.py functionality."""
...
def basic_check_on_inputs(
    ...
    Args:
        n_video_frames: The n video frames.
        n_target_frames: The n target frames.
