...
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            vision_width: The vision width.
            vision_patch_size: The vision patch size.
            context_length: The context length.
            vocab_size: The vocab size.
            transformer_width: The transformer width.
            transformer_heads: The transformer heads.
            transformer_layers: The transformer layers.
        """
        super().__init__()
...
def convert_weights(model: nn.Module):
    ...
    def _convert_weights_to_fp16(ll):
        """Helper function to convert weights to fp16.
