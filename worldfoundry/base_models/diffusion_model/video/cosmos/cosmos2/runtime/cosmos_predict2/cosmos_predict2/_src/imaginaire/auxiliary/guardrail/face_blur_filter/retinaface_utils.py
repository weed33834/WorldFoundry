...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> auxiliary -> guardrail -> face_blur_filter -> retinaface_utils.py functionality."""
...
def _check_keys(model, pretrained_state_dict):
    """Helper function to check keys.

    Args:
        model: The model.
        pretrained_state_dict: The pretrained state dict.
    """
