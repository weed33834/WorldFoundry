...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> validator.py functionality."""
...
class InputImage(Validator):
    ...
    def __init__(
        ...
        Args:
            ...
            hidden: The hidden.
            tooltip: The tooltip.
            supported_formats: The supported formats.
        """
        self.default = default
        self.hidden = hidden
        self.tooltip = tooltip
