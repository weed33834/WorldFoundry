...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> easy_io -> backends -> boto3_backend.py functionality."""
...
from cosmos_predict2._src.imaginaire.utils.easy_io.backends.base_backend import (
    BaseStorageBackend,
    has_method,
    mkdir_or_exist,
)
from cosmos_predict2._src.imaginaire.utils.easy_io.backends.boto3_client import Boto3Client
...
class Boto3Backend(BaseStorageBackend):
    ...
    **Deprecated**. Use the MSC backend instead.
    ...
    def _replace_prefix(self, filepath: Union[str, Path]) -> str:
        """Helper function to replace prefix.
    ...
    def list_dir_or_file(  # pylint: disable=too-many-arguments
        ...
        def _list_dir_or_file(dir_path, list_dir, list_file, suffix, recursive):
            """Helper function to list dir or file.
