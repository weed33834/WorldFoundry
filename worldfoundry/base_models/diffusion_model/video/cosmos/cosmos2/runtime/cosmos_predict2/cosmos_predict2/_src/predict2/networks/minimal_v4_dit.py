...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> networks -> minimal_v4_dit.py functionality."""
...
def flex_attention_op(
    ...
    Args:
        q_B_S_H_D: The q b s h d.
        k_B_S_H_D: The k b s h d.
        v_B_S_H_D: The v b s h d.
        attn_mask: The attn mask.
        flatten_heads: The flatten heads.
...
class Attention(nn.Module):
    ...
    def compute_attention(
        ...
        Args:
            ...
            kv_cache_cfg: The kv cache cfg.
            kv_state: The kv state.
        """
        additional_args = {}
...
class InferenceDiT(InferenceCheckpointModule):
    ...
    def __init__(
        ...
        Args:
            ...
            use_wan_fp32_strategy: The use wan fp32 strategy.
            zero_init_action_embedder: The zero init action embedder.
    ...
    def fully_shard(self, mesh, offload_policy=None):
        ...
        Args:
            mesh: The mesh.
            offload_policy: The offload policy.
        """
        for i, block in enumerate(self.blocks):
