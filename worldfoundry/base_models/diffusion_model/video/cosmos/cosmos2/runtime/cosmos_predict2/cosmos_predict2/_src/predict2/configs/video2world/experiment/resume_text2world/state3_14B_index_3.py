...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> configs -> video2world -> experiment -> resume_text2world -> state3_14B_index_3.py functionality."""
...
def build_debug_runs(job):
    ...
    return [wo_resume, resume_probe_wo_resume]


"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-3-Size-14B-Res-480-Fps-16-Note-video_data1pt3_augmentor
...
"""
# config-check config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-22-Size-14B-Res-720-Fps-16-Note-T24_05_22_accumulated_hq_wan
"""
...
"""
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-25-Size-14B-Res-256-Fps-16-Note-T24_05_27_accumulated_hq_wan_resume_probe_wo_resume" ckpt_type=minimal
"""
...
"""
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-26-Size-14B-Res-256-Fps-16-Note-T24_05_27_accumulated_hq_wan_rerun_resume_probe_wo_resume" ckpt_type=minimal
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-27-Size-14B-Res-480p-Fps-16-Note-T24_05_28_accumulated_hq_wan"

torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-27-Size-14B-Res-480p-Fps-16-Note-T24_05_28_accumulated_hq_wan_resume_probe_wo_resume" ckpt_type=minimal
"""
...
"""
# run local debug
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-35-Size-14B-Res-720-Fps-16-Note-T24_06_04_data_tune_sigma_from_33_resume_probe_wo_resume" ckpt_type=minimal model.config.net.num_blocks=2
"""
...
"""
# local debug
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-38-Size-14B-Res-720-Fps-16-Note-T24_HQV3_from_35_resume_probe_wo_resume" ckpt_type=minimal model.config.net.num_blocks=2
"""
...
"""
# local debug
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-40-Size-14B-Res-720-Fps-16-Note-T24_HQV3pt1_from_38_resume_probe_wo_resume" ckpt_type=minimal model.config.net.num_blocks=2
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-43-Size-14B-Res-720-Fps-16-Note-T24_HQV5_from_40
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-45-Size-14B-Res-720-Fps-16-Note-T24_HQV2_1_from_35"
# config-check dataloader
...
"""
# print
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-50-Size-14B-Res-720-Fps-16-Note-T24_HQV5_SHIFT24_from_40"

local train 14B with shift24
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-50-Size-14B-Res-720-Fps-16-Note-T24_HQV5_SHIFT24_from_40_resume_probe_wo_resume" model.config.net.num_blocks=10
"""
...
"""
test locally
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-51-Size-14B-Res-720-Fps-16-Note-T24_DATA_0612_from_43_resume_probe_wo_resume" model.config.net.num_blocks=10
"""
...
"""
# local run it
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-52-Size-14B-Res-720-Fps-16-Note-T24_DATA_0612_from_51_resume_probe_wo_resume" model.config.net.num_blocks=10
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-53-Size-14B-Res-720-Fps-16-Note-T24_DATA_0612_HARDCODED_20STEPS_from_51"

# local run it
torchrun --nproc_per_node=4 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-53-Size-14B-Res-720-Fps-16-Note-T24_DATA_0612_HARDCODED_20STEPS_from_51_resume_probe_wo_resume" model.config.net.num_blocks=10 model_parallel.context_parallel_size=4 ckpt_type=minimal
"""
...
for _item, _item_wo_resume, _item_resume_probe_wo_resume in [
    [
    ...
    if _item_resume_probe_wo_resume is not None:
        cs.store(
            group="experiment",
            package="_global_",
            name=f"{_item['job']['name']}_resume_probe_wo_resume",
            node=_item_resume_probe_wo_resume,
        )
