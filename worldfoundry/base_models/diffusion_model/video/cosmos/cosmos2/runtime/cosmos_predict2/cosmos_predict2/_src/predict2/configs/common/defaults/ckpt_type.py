...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> configs -> common -> defaults -> ckpt_type.py functionality."""

from typing import Dict

from hydra.core.config_store import ConfigStore

from cosmos_predict2._src.imaginaire.checkpointer.dummy import Checkpointer as DummyCheckpointer
