...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> easy_io -> handlers -> imageio_video_handler.py functionality."""
...
class ImageioVideoHandler(BaseFileHandler):
    """Imageio video handler implementation."""
    str_like = False
