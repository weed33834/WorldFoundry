...
def get_continuous_action(d_acts, c_act_max, c_act_min, n_bins):
    ...
    Args:
        d_acts: The d acts.
        c_act_max: The c act max.
        c_act_min: The c act min.
        n_bins: The n bins.
    """
...
def get_converted_fp32_paths(deepspeed_ckpt_path):
    """Get converted fp32 paths.

    Args:
        deepspeed_ckpt_path: The deepspeed ckpt path.
    """
...
class Resize_Preprocess:
    """Video preprocessing class for resizing frames to a specific size."""
...
class Preprocess:
    """Video preprocessing class for resizing clips while maintaining aspect ratio."""
    ...
    def resize_scale(clip, target_height, target_width, interpolation_mode):
        """Resize video clip while maintaining aspect ratio."""
