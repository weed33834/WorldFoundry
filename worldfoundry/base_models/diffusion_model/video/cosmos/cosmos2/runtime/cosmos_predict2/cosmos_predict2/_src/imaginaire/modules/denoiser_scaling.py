...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> modules -> denoiser_scaling.py functionality."""
...
class RectifiedFlowScaling:
    """Rectified flow scaling implementation."""
    def __init__(self, sigma_data: float = 1.0, t_scaling_factor: float = 1.0, loss_weight_uniform: bool = True):
        ...
        Args:
            ...
            loss_weight_uniform: The loss weight uniform.
        """
