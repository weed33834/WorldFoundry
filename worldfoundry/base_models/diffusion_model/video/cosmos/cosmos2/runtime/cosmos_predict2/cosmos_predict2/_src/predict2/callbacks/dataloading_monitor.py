...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> callbacks -> dataloading_monitor.py functionality."""
...
class DetailedDataLoadingSpeedMonitor(Callback):
    """Detailed data loading speed monitor implementation."""
    def __init__(
        self,
        every_n: int,
        step_size: int = 1,
