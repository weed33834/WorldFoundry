...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> datasets -> utils.py functionality."""
...
def get_aspect_ratios_from_wdinfos(wdinfos: list[str]) -> list[str]:
    """Get aspect ratios from wdinfos.
