...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> checkpointer -> ddp.py functionality."""
...
class Checkpointer(AbstractCheckpointer):
    ...
    def _map_state_dict_path_during_save(self, state_dict, checkpoint_file, model) -> dict[str, StateDictItemPath]:
        """Helper function to map state dict path during save.
