...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> functional -> lr_scheduler.py functionality."""
...
class TeroPolyScheduler:
    """Tero poly scheduler implementation."""
    def __init__(
        self,
        total_Mimg: int,
        batch_size: int,
        ...
        Args:
            total_Mimg: The total mimg.
            batch_size: The batch size.
            ref_Mimg: The ref mimg.
            ref_batches: The ref batches.
            max_lr_ratio: The max lr ratio.
            min_lr_ratio: The min lr ratio.
            rampup_Mimg: The rampup mimg.
            rampdown_Mimg: The rampdown mimg.
            verbosity_interval: The verbosity interval.
            formula: The formula.
            poly_exp: The poly exp.
        """
...
class LambdaWarmUpCosineScheduler:
    ...
    def __init__(self, warm_up_steps, f_min, f_max, f_start, cycle_lengths, verbosity_interval=0):
        ...
        Args:
            warm_up_steps: The warm up steps.
            f_min: The f min.
            f_max: The f max.
            f_start: The f start.
            cycle_lengths: The cycle lengths.
            verbosity_interval: The verbosity interval.
        """
