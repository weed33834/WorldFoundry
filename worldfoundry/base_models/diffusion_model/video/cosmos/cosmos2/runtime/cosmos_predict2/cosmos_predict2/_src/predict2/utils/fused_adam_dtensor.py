...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> utils -> fused_adam_dtensor.py functionality."""
...
class FusedAdam(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        Args:
            ...
            betas: The betas.
            eps: The eps.
            adam_w_mode: The adam w mode.
            weight_decay: The weight decay.
            amsgrad: The amsgrad.
            capturable: The capturable.
            master_weights: The master weights.
        """
        if amsgrad:
