...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> inference -> get_umt5_emb.py functionality."""
...
class UMT5EncoderModel:
    ...
    def __init__(
        ...
        Args:
            ...
            credential_path: The credential path.
            enable_fsdp_shard: The enable fsdp shard.
        """
