...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> callbacks -> grad_clip.py functionality."""
...
class _MagnitudeRecord:
    """Magnitude record implementation."""
    state: float = 0
    iter_count: int = 0
