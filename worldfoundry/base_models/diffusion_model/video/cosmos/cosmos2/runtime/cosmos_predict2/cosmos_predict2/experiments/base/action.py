...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> experiments -> base -> action.py functionality."""
...
def load_experiment_config(experiment_name: str, default_config: LazyDict) -> LazyDict:
    ...
    if yaml_file.exists():
        ...
        def merge_configs(default_dict, override_dict):
            ...
            Args:
                default_dict: The default dict.
                override_dict: The override dict.
            """
...
_default_groot_config = LazyDict(
    dict(
        ...
        checkpoint=dict(
            ...
            # load_path="data/checkpoints/cosmos_logs/exp1201/pretrain/checkpoints/iter_000100000/",
