...
def _attn_fwd_inner(
    ...
    """Helper function to attn fwd inner.
    ...
    Args:
        ...
        q: The q.
        tq: The tq.
        K_block_ptr: The k block ptr.
        V_block_ptr: The v block ptr.
        tK_block_ptr: The tk block ptr.
        tV_block_ptr: The tv block ptr.
        start_m: The start m.
        sm_scale: The sm scale.
        BLOCK_M: The block m.
        BLOCK_N: The block n.
        STAGE: The stage.
        offs_m: The offs m.
        offs_n: The offs n.
        SEQ_LEN_KV: The seq len kv.
        HEAD_DIM_V: The head dim v.
        bf16_v: The bf16 v.
    """
...
def _attn_fwd(
    ...
    Args:
        ...
        Out: The out.
        tOut: The tout.
        stride_qz: The stride qz.
        stride_qh: The stride qh.
        stride_qm: The stride qm.
        stride_qd: The stride qd.
        stride_kz: The stride kz.
        stride_kh: The stride kh.
        stride_kn: The stride kn.
        stride_kd: The stride kd.
        stride_vz: The stride vz.
        stride_vh: The stride vh.
        stride_vn: The stride vn.
        stride_vd: The stride vd.
        stride_oz: The stride oz.
        stride_oh: The stride oh.
        stride_om: The stride om.
        stride_od: The stride od.
        Z: The z.
        H: The h.
        SEQ_LEN_Q: The seq len q.
        SEQ_LEN_KV: The seq len kv.
        HEAD_DIM_QK: The head dim qk.
        HEAD_DIM_V: The head dim v.
        BLOCK_M: The block m.
        BLOCK_N: The block n.
        STAGE: The stage.
...
class _attention(torch.autograd.Function):
    ...
    def backward(ctx, dout, *args):
        ...
        # _worldfoundry_scaled_dot_product_attention and this implementation use (batch_size, nheads, seqlen, headdim)
