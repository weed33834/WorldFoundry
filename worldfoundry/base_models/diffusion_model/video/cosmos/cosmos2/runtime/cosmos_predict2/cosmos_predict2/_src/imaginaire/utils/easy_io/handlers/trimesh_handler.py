...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> easy_io -> handlers -> trimesh_handler.py functionality."""
...
class TrimeshHandler(BaseFileHandler):
    """Trimesh handler implementation."""
    format: str
    str_like = False
