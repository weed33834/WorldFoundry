...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> networks -> clip.py functionality."""
...
class CLIPModel:
    ...
    def visual(self, videos_B_C_H_W_n1_p1):
        ...
        Args:
            videos_B_C_H_W_n1_p1: The videos b c h w n1 p1.
        """
        # preprocess
...
class Wan2pt1CLIPEmb(AbstractEmbModel):
    ...
    def forward(
        ...
        Args:
            ...
            media_latents: The media latents.
