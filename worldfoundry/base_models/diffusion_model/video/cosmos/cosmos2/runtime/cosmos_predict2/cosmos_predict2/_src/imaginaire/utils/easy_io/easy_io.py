...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> easy_io -> easy_io.py functionality."""
...
from cosmos_predict2._src.imaginaire.utils.easy_io.backends import backends, prefix_to_backends
from cosmos_predict2._src.imaginaire.utils.easy_io.file_client import FileClient
from cosmos_predict2._src.imaginaire.utils.easy_io.handlers import file_handlers
...
def _parse_uri_prefix(uri: Union[str, Path]) -> str:
    ...
    Examples:
        >>> _parse_uri_prefix('local/path/of/your/file')
        ''
