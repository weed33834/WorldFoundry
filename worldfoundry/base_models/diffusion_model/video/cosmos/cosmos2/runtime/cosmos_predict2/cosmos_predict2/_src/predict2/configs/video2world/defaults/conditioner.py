...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> configs -> video2world -> defaults -> conditioner.py functionality."""
...
class Video2WorldCondition(Text2WorldCondition):
    ...
    def edit_for_inference(
        ...
        Args:
            is_cfg_conditional: The is cfg conditional.
...
class Video2WorldConditionV2(Video2WorldCondition):
    ...
    def set_video_condition(
        ...
        Args:
            ...
            random_min_num_conditional_frames: The random min num conditional frames.
            random_max_num_conditional_frames: The random max num conditional frames.
            num_conditional_frames: The num conditional frames.
            conditional_frames_probs: The conditional frames probs.
