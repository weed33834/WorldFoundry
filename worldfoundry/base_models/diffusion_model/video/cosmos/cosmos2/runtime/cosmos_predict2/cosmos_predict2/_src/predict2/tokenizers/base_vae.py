...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> tokenizers -> base_vae.py functionality."""
...
class SDVAE(BaseVAE):
    ...
    def __init__(self, batch_size=16, count_std: bool = False, is_downsample: bool = True) -> None:
        ...
        Args:
            ...
            count_std: The count std.
            is_downsample: The is downsample.
