...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> guardrail -> face_blur_filter -> face_blur_filter.py functionality."""
...
import numpy as np
import torch
from cosmos_predict2._src.predict2.guardrail.face_blur_filter.retinaface_utils import (
    decode_batch,
...
class RetinaFaceFilter(PostprocessingGuardrail):
    ...
    def __init__(
        ...
        """
        self.checkpoint = f"{GUARDRAIL1_CHECKPOINT_DIR}/face_blur_filter/Resnet50_Final.pth"
        self.cfg = cfg_re50
