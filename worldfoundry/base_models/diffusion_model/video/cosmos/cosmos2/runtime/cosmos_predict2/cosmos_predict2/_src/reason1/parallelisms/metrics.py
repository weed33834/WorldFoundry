...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> reason1 -> parallelisms -> metrics.py functionality."""
...
from cosmos_predict2._src.reason1.parallelisms.torchtitan_utilts import (  # projects/cosmos/reasoning/v1/parallelisms/torchtitan_utilts.py
    device_module,
    device_type,
)
...
class DeviceMemoryMonitor:
    """Device memory monitor implementation."""
    ...
    def _to_gib(self, memory_in_bytes):
        """Helper function to to gib.

        Args:
            memory_in_bytes: The memory in bytes.
        """
...
def build_metric_logger(job_config: JobConfig, parallel_dims: ParallelDims, tag: Optional[str] = None) -> BaseLogger:
    """
