...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> callbacks -> heart_beat.py functionality."""
...
class HeartBeat(EveryN):
    ...
    def __init__(self, every_n: int, step_size: int = 1, update_interval_in_minute: int = 20, save_s3: bool = False):
        ...
        Args:
            ...
            update_interval_in_minute: The update interval in minute.
            save_s3: The save s3.
        """
