...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> networks -> wan2pt1.py functionality."""
...
class VideoRopePosition3DEmb(VideoPositionEmb):
    ...
    def __init__(
        ...
        Args:
            ...
            len_w: The len w.
            len_t: The len t.
            h_extrapolation_ratio: The h extrapolation ratio.
            w_extrapolation_ratio: The w extrapolation ratio.
            t_extrapolation_ratio: The t extrapolation ratio.
        """
        super().__init__()
        self.max_h = len_h
        self.max_w = len_w
...
class SelfAttnOp(DotProductAttention):
    ...
    def forward(
        ...
        Args:
            q_B_L_H_D: The q b l h d.
            k_B_L_H_D: The k b l h d.
            v_B_L_H_D: The v b l h d.
