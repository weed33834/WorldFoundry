...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> callbacks -> device_monitor.py functionality."""
...
class DeviceMonitor(EveryN):
    ...
    def __init__(
        ...
        Args:
            ...
            save_s3: The save s3.
            upload_every_n_mul: The upload every n mul.
            log_memory_detail: The log memory detail.
        """
