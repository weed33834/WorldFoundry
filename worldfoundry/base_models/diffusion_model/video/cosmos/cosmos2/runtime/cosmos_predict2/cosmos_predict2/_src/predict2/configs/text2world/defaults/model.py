...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> configs -> text2world -> defaults -> model.py functionality."""
...
from cosmos_predict2._src.predict2.models.text2world_model import Text2WorldModelConfig
from cosmos_predict2._src.predict2.models.text2world_wan2pt1_model import Text2WorldModelWan2pt1Config
from cosmos_predict2._src.predict2.models.text2world_wan2pt1_model import WANDiffusionModel as Text2WorldWan2pt1Model
