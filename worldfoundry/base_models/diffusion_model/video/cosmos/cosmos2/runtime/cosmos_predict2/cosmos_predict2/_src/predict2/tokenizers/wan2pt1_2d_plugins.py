...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> tokenizers -> wan2pt1_2d_plugins.py functionality."""
...
def _create_adj_groups(
    ...
    """Helper function to create adj groups.

    Args:
        grid_shape: The grid shape.
        cp_group: The cp group.
...
class _ModulePlugin:
    ...
    def __init__(self, module, module_id, plugin_config, cp_group, grid_shape, in_row_adj_groups, in_col_adj_groups):
        ...
        Args:
            ...
            cp_group: The cp group.
            grid_shape: The grid shape.
            in_row_adj_groups: The in row adj groups.
            in_col_adj_groups: The in col adj groups.
        """
        self.module = module
...
class _Conv2DSafeNewPluginStride2(_ModulePlugin):
    ...
    def _pad_with_unidirectional_transfer(self, h):
        """Helper function to pad with unidirectional transfer.
    ...
    def _pad_width_with_concat(self, h):
        """Helper function to pad width with concat.
    ...
    def _pad_height_with_concat(self, h):
        """Helper function to pad height with concat.
    ...
    def _handle_diagonal_transfer(self, h):
        """Helper function to handle diagonal transfer.
...
class _WanAttentionPlugin(_ModulePlugin):
    ...
    def __init__(
        ...
        Args:
            ...
            in_row_adj_groups: The in row adj groups.
            in_col_adj_groups: The in col adj groups.
            all_gather_before_attention: The all gather before attention.
            cp_split_after_attention: The cp split after attention.
        """
...
def _wanattention_plugin_mount(
    ...
    """Helper function to wanattention plugin mount.
...
def _conv_3d_plugin_mount(
    ...
    """Helper function to conv 3d plugin mount.
...
def _conv_2d_plugin_stride2_mount(
    ...
    """Helper function to conv 2d plugin stride2 mount.
...
def _conv_2d_plugin_mount(
    ...
    """Helper function to conv 2d plugin mount.
...
def _resample_plugin_mount(
    ...
    """Helper function to resample plugin mount.
