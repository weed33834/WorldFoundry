...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> datasets -> webdataset -> augmentors -> augmentor.py functionality."""
...
class IterableAugmentor:
    """Iterable augmentor implementation."""
    def __init__(self, input_keys: list, output_keys: Optional[list] = None, args: Optional[dict] = None) -> None:
        r"""Base augmentor class
