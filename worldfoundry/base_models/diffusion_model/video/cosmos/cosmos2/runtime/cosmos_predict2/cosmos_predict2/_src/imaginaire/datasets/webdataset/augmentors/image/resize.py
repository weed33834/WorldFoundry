...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> datasets -> webdataset -> augmentors -> image -> resize.py functionality."""
...
from cosmos_predict2._src.imaginaire.datasets.webdataset.augmentors.image.misc import (
...
class ResizeSmallestSide(Augmentor):
    """Resize smallest side implementation."""
...
class ResizeLargestSide(Augmentor):
    """Resize largest side implementation."""
    def __init__(self, input_keys: list, output_keys: Optional[list] = None, args: Optional[dict] = None) -> None:
        """Init.
...
class ResizeLargestSideAspectPreserving(Augmentor):
    """Resize largest side aspect preserving implementation."""
    def __init__(self, input_keys: list, output_keys: Optional[list] = None, args: Optional[dict] = None) -> None:
        """Init.
