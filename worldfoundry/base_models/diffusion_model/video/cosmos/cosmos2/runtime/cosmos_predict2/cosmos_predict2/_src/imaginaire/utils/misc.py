...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> utils -> misc.py functionality."""
...
class StragglerDetectorV2:
    ...
    def __init__(
        ...
        Args:
            enabled: The enabled.
            report_freq: The report freq.
            profile_freq: The profile freq.
            max_diff: The max diff.
    ...
    def profile_section(self, name: str, section_enabled: bool, profile_cuda: bool = True):
        ...
        Args:
            name: The name.
            section_enabled: The section enabled.
            profile_cuda: The profile cuda.
        """
    ...
    def _aggregate_section_results(self, local_section_summaries):
        """Helper function to aggregate section results.

        Args:
            local_section_summaries: The local section summaries.
        """
        data = []
