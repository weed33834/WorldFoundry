...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> conditioner.py functionality."""
...
class TextAttr(AbstractEmbModel):
    ...
    def __init__(
        ...
        Args:
            ...
            dropout_rate: The dropout rate.
            use_empty_string: The use empty string.
            empty_string_embeddings_path: The empty string embeddings path.
            credential_path: The credential path.
        """
        super().__init__()
