...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> camera -> configs -> multiview_camera -> config.py functionality."""
...
from cosmos_predict2._src.predict2.camera.configs.multiview_camera.conditioner import register_conditioner
from cosmos_predict2._src.predict2.camera.configs.multiview_camera.data import register_camera_data
from cosmos_predict2._src.predict2.camera.configs.multiview_camera.model import register_model
from cosmos_predict2._src.predict2.camera.configs.multiview_camera.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package(
        "cosmos_predict2._src.predict2.camera.configs.multiview_camera.experiment", reload=True
    )
    return c
