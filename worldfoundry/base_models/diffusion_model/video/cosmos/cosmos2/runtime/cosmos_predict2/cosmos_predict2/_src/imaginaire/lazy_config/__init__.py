...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> imaginaire -> lazy_config -> __init__.py functionality."""
...
from cosmos_predict2._src.imaginaire.lazy_config.lazy import LazyCall, LazyConfig
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.omegaconf_patch import to_object
