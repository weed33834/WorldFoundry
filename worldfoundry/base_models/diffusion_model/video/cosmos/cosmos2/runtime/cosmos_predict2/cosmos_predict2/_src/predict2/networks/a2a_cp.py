...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> networks -> a2a_cp.py functionality."""
...
class DistributedAttention(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            local_attention: The local attention.
