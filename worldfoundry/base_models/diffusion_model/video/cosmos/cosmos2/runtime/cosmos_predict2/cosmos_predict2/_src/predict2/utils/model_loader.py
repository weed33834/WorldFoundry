...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> utils -> model_loader.py functionality."""
...
def load_model_state_dict_from_checkpoint(
    ...
    Args:
        model: The model.
        config: The config.
        s3_checkpoint_dir: The s3 checkpoint dir.
        load_ema_to_reg: The load ema to reg.
        local_cache_dir: The local cache dir.
        override_cache: The override cache.
    """
