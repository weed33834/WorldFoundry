...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> reason1 -> parallelisms -> optimizer.py functionality."""
...
def _optimizer_cls(params: List[nn.Parameter], optimizer_kwargs: Dict[str, Any], name: str):
    """Helper function to optimizer cls.

    Args:
        params: The params.
        optimizer_kwargs: The optimizer kwargs.
        name: The name.
    """
    if name == "Adam":
...
class OptimizersContainer(Stateful):
    ...
    def __init__(
        ...
        Args:
            ...
            optimizer_kwargs: The optimizer kwargs.
            name: The name.
            lr_multiplier: The lr multiplier.
            model_part_names: The model part names.
