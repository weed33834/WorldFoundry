...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos2 -> runtime -> cosmos_predict2 -> cosmos_predict2 -> _src -> predict2 -> configs -> video2world -> experiment -> resume_text2world -> stage3_2B_ablation.py functionality."""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-3-Size-2B-Res-480-Fps-16-Note-qwen_video_only_later_frames
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-5-Size-2B-Res-480-Fps-16-Note-qwen_joint_full_frames
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-6-Size-2B-Res-480-Fps-16-Note-qwen_joint_full_frames
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-6-Size-2B-Res-480-Fps-16-Note-qwen_joint_full_frames_resume_probe_wo_resume
"""
...
torchrun --nproc_per_node=8 --master_port=12342 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-8-Size-2B-Res-480p-Fps-16-Note-new_data_resume_probe_wo_resume"
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-10-Size-2B-Res-480p-Fps-16-Note-05_22_pretrain2pt2_hq_wan"
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-11-Size-2B-Res-720-Fps-16-Note-05_22_accumulated_hq_wan_wo_resume"

# debug: train with mock data and wo_resume
NVTE_FUSED_ATTN=0 torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-11-Size-2B-Res-720-Fps-16-Note-05_22_accumulated_hq_wan_resume_probe_wo_resume" ckpt_type=minimal
"""
...
"""
# locally run
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-15-Size-2B-Res-256-Fps-16-Note-05_27_accumulated_hq_wan_resume_probe_wo_resume" ckpt_type=minimal
# config-check dataloader
...
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-16-Size-2B-Res-480p-Fps-16-Note-05_28_accumulated_hq_wan_resume_probe_wo_resume ckpt_type=minimal
"""
...
"""
# print config
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config-check --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-18-Size-2B-Res-720-Fps-16-Note-06_02_accumulated_hq_wan

test locally
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment=Stage-c_pt_4-Index-18-Size-2B-Res-720-Fps-16-Note-06_02_accumulated_hq_wan_resume_probe_wo_resume ckpt_type=minimal
"""
...
"""
# run local debug
torchrun --nproc_per_node=8 --master_port=12341 -m scripts.train --config=projects/cosmos/diffusion/v2/configs/video2world/config.py -- experiment="Stage-c_pt_4-Index-20-Size-2B-Res-720-Fps-16-Note-06_04_accumulated_hq_wan_from_19_resume_probe_wo_resume" ckpt_type=minimal model.config.net.num_blocks=2
"""
