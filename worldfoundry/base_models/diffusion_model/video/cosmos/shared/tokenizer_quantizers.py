...
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.tokenizer_module_utils import (
    default,
    entropy,
    pack_one,
    rearrange,
...
class ResidualFSQuantizer(nn.Module):
    ...
    def __init__(self, levels: list[int], num_quantizers: int, **ignore_kwargs):
        ...
        Args:
            levels: The levels.
            num_quantizers: The num quantizers.
        """
        super().__init__()
    ...
    def indices_to_codes(self, indices_stack: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            indices_stack: The indices stack.
...
class FSQuantizer(nn.Module):
    ...
    def __init__(
        ...
        **ignore_kwargs,
        ...
        Args:
            levels: The levels.
            dim: The dim.
            num_codebooks: The num codebooks.
            keep_num_codebooks_dim: The keep num codebooks dim.
            scale: The scale.
        """
        super().__init__()
    ...
    def _scale_and_shift(self, zhat_normalized: torch.Tensor) -> torch.Tensor:
        """Helper function to scale and shift.

        Args:
            zhat_normalized: The zhat normalized.
    ...
    def _scale_and_shift_inverse(self, zhat: torch.Tensor) -> torch.Tensor:
        """Helper function to scale and shift inverse.
...
class VectorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        **ignore_kwargs,
        ...
        Args:
            ...
            beta: The beta.
            remap: The remap.
            unknown_index: The unknown index.
            sane_index_shape: The sane index shape.
            legacy: The legacy.
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False):
        ...
        Args:
            z: The z.
            temp: The temp.
            rescale_logits: The rescale logits.
            return_logits: The return logits.
        """
