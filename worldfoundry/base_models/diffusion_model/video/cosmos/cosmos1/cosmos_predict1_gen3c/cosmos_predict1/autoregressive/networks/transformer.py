...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> networks -> transformer.py functionality."""
...
class Transformer(nn.Module):
    ...
    def _create_rope_config(self) -> Dict:
        """Helper function to create rope config.
    ...
    def _create_abs_pos_emb_config(self):
        """Helper function to create abs pos emb config."""
        shape_map = {
            "3D": self.params["video_latent_shape"],
            "1D": None,
        }
    ...
    def _initialize_abs_pos_emb(self):
        """Helper function to initialize abs pos emb."""
