...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> diffusion -> module -> blocks.py functionality."""
...
class FinalLayer(nn.Module):
    ...
    def forward(
        ...
        Args:
            x_BT_HW_D: The x bt hw d.
            emb_B_D: The emb b d.
            adaln_lora_B_3D: The adaln lora b 3d.
        """
        if self.use_adaln_lora:
...
class GeneralDITTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            crossattn_mask: The crossattn mask.
