...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> diffusion -> networks -> general_dit_multiview.py functionality."""
...
class MultiviewGeneralDIT(GeneralDIT):
    ...
    def __init__(
        ...
        Args:
            ...
            extra_per_block_abs_pos_emb_type: The extra per block abs pos emb type.
            ...
            n_views: The n views.
            view_condition_dim: The view condition dim.
            traj_condition_dim: The traj condition dim.
            concat_view_embedding: The concat view embedding.
            concat_traj_embedding: The concat traj embedding.
            add_repeat_frame_embedding: The add repeat frame embedding.
        """
