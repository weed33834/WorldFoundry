...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> diffusion_decoder -> inference.py functionality."""
...
def diffusion_decoder_process_tokens(
    ...
    """Diffusion decoder process tokens.

    Args:
        model: The model.
        indices_tensor: The indices tensor.
        dd_sampling_config: The dd sampling config.
        original_video_example: The original video example.
        t5_emb_batch: The t5 emb batch.
    """
