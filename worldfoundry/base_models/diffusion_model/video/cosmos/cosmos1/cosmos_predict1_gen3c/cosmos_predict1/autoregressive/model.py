...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> model.py functionality."""
...
def update_model_config(model_config, inference_tensor_parallel_size):
    ...
    Args:
        ...
        inference_tensor_parallel_size: The inference tensor parallel size.
    """
