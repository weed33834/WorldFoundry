...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> utils -> lazy_config -> lazy.py functionality."""
...
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.lazy_config_file_io import PathManager
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.lazy_config_registry import _convert_target_to_string
...
def _validate_py_syntax(filename):
    """Helper function to validate py syntax.
...
def _cast_to_config(obj):
    """Helper function to cast to config.
...
def _random_package_name(filename):
    """Helper function to random package name.
...
def _patch_import():
    ...
    def find_relative_file(original_file, relative_import_path, level):
        ...
        Args:
            original_file: The original file.
            relative_import_path: The relative import path.
            level: The level.
        """
