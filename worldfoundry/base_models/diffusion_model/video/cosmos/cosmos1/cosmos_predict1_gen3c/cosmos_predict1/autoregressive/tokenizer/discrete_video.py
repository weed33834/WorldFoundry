...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> tokenizer -> discrete_video.py functionality."""
...
class BaseDiscreteVideoFSQTokenizer(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            latent_chunk_duration: The latent chunk duration.
...
class DiscreteVideoFSQStateDictTokenizer(BaseDiscreteVideoFSQTokenizer):
    ...
    def __init__(
        ...
        Args:
            enc_fp: The enc fp.
            dec_fp: The dec fp.
            tokenizer_module: The tokenizer module.
            name: The name.
            latent_ch: The latent ch.
            is_bf16: The is bf16.
            pixel_chunk_duration: The pixel chunk duration.
