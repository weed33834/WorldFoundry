...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> modules -> attention.py functionality."""
...
def scaled_dot_product_attention(
    ...
    y = _worldfoundry_scaled_dot_product_attention(
        q,
        k,
        v,
        attn_mask=mask,
