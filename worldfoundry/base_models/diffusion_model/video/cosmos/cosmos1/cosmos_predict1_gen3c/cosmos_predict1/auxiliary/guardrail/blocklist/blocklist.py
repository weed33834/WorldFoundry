...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> auxiliary -> guardrail -> blocklist -> blocklist.py functionality."""
...
class Blocklist(ContentSafetyGuardrail):
    ...
    def __init__(
        ...
        Args:
            ...
            guardrail_partial_match_min_chars: The guardrail partial match min chars.
            guardrail_partial_match_letter_count: The guardrail partial match letter count.
