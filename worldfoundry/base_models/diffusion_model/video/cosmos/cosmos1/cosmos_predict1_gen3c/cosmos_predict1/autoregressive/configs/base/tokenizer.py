...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> configs -> base -> tokenizer.py functionality."""
...
def create_discrete_video_fsq_tokenizer_state_dict_config(
    ...
    """Create discrete video fsq tokenizer state dict config.
