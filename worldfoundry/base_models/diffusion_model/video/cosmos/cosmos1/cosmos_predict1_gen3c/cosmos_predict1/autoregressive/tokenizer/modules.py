...
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.autoregressive_tokenizer_patching import Patcher3D, UnPatcher3D
...
class CausalConv3d(nn.Module):
    ...
    def _replication_pad(self, x: torch.Tensor) -> torch.Tensor:
        """Helper function to replication pad.
...
class CausalHybridUpsample3d(nn.Module):
    ...
    def __init__(self, in_channels: int, spatial_up: bool = True, temporal_up: bool = True, **ignore_kwargs) -> None:
        ...
        Args:
            ...
            spatial_up: The spatial up.
            temporal_up: The temporal up.
...
class CausalHybridDownsample3d(nn.Module):
    ...
    def __init__(
        ...
        Args:
            in_channels: The in channels.
            spatial_down: The spatial down.
            temporal_down: The temporal down.
    ...
    def __init__(
        ...
        **ignore_kwargs,
        ...
        Args:
            ...
            channels_mult: The channels mult.
            num_res_blocks: The num res blocks.
            attn_resolutions: The attn resolutions.
            dropout: The dropout.
            resolution: The resolution.
            z_channels: The z channels.
            spatial_compression: The spatial compression.
            temporal_compression: The temporal compression.
