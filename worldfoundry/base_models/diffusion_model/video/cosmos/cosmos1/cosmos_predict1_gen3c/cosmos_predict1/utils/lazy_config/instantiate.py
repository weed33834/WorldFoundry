...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> utils -> lazy_config -> instantiate.py functionality."""
...
from worldfoundry.base_models.diffusion_model.video.cosmos.shared.lazy_config_registry import _convert_target_to_string, locate

__all__ = ["dump_dataclass", "instantiate"]


def is_dataclass_or_attrs(target):
    """Is dataclass or attrs.
