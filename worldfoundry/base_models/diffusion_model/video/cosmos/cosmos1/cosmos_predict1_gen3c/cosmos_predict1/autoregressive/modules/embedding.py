...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> modules -> embedding.py functionality."""
...
class RotaryPositionEmbedding(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            apply_yarn: The apply yarn.
            scale: The scale.
            extrapolation_factor: The extrapolation factor.
            attn_factor: The attn factor.
            beta_fast: The beta fast.
            beta_slow: The beta slow.
            rope_dim: The rope dim.
            latent_shape: The latent shape.
            original_latent_shape: The original latent shape.
            pad_to_multiple_of: The pad to multiple of.
        """
        super().__init__()
...
class RotaryPositionEmbeddingPytorchV2(RotaryPositionEmbedding):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            seq_len: The seq len.
            training_type: The training type.
        """
        super().__init__(
            **kwargs,
        )
