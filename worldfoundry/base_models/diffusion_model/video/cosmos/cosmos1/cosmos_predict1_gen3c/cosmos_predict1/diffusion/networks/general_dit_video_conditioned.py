...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> diffusion -> networks -> general_dit_video_conditioned.py functionality."""
...
class VideoExtendGeneralDIT(GeneralDIT):
    ...
    def build_additional_timestamp_embedder(self):
        """Build additional timestamp embedder."""
