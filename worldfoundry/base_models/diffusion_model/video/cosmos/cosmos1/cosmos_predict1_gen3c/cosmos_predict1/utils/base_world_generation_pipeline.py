...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> utils -> base_world_generation_pipeline.py functionality."""
...
class BaseWorldGenerationPipeline(ABC):
    ...
    def _offload_network(self):
        """Helper function to offload network."""
        if self.model.model:
    ...
    def _offload_tokenizer(self):
        """Helper function to offload tokenizer."""
