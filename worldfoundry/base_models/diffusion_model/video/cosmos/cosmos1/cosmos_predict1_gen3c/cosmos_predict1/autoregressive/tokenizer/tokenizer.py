...
"""Module for base_models -> diffusion_model -> video -> cosmos -> cosmos1 -> cosmos_predict1_gen3c -> cosmos_predict1 -> autoregressive -> tokenizer -> tokenizer.py functionality."""
...
def update_vocab_size(
    ...
    Args:
        existing_vocab_size: The existing vocab size.
        to_be_added_vocab_size: The to be added vocab size.
        training_type: The training type.
        add_special_tokens: The add special tokens.
        video_special_tokens: The video special tokens.
    """
    # New vocab size
