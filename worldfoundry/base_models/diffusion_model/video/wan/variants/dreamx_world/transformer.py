...
from worldfoundry.base_models.diffusion_model.video.wan.wan_2p1.modules.prope import prope_qkv
...
class WanTransformer3DModel(WanTransformerMethodsMixin, ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def enable_multi_gpus_inference(self,):
        from .distributed.wan_xfuser import sp_prope_forward, usp_attn_forward
