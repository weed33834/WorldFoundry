"""Module for base_models -> diffusion_model -> video -> wan -> variants -> echo_infinity -> wan -> modules -> t5.py functionality."""
...
class T5EncoderModel:
    ...
    def __init__(self, text_len, dtype=torch.bfloat16, device=torch.cuda.current_device(), checkpoint_path=None, tokenizer_path=None, shard_fn=None):
        """Init.
