...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> animate.py functionality."""
...
class WanAnimate:
    ...
    def get_valid_len(self, real_len, clip_len=81, overlap=1):
        ...
        Args:
            real_len: The real len.
            clip_len: The clip len.
            overlap: The overlap.
        """
    ...
    def padding_resize(self, img_ori, height=512, width=512, padding_color=(0, 0, 0), interpolation=cv2.INTER_LINEAR):
        ...
        Args:
            ...
            height: The height.
            width: The width.
            padding_color: The padding color.
    ...
    def prepare_source(self, src_pose_path, src_face_path, src_ref_path):
        ...
        Args:
            src_pose_path: The src pose path.
            src_face_path: The src face path.
            src_ref_path: The src ref path.
        """
    ...
    def prepare_source_for_replace(self, src_bg_path, src_mask_path):
        """Prepare source for replace.

        Args:
            src_bg_path: The src bg path.
            src_mask_path: The src mask path.
        """
