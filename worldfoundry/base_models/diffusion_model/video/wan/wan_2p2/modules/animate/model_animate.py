...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> model_animate.py functionality."""
...
class WanAnimateSelfAttention(WanSelfAttention):
    """Wan animate self attention implementation."""
...
class WanAnimateCrossAttention(WanSelfAttention):
    """Wan animate cross attention implementation."""
    def __init__(
        self,
        dim,
        num_heads,
...
class WanAnimateAttentionBlock(nn.Module):
    """Wan animate attention block implementation."""
    def __init__(self,
                 dim,
                 ffn_dim,
                 num_heads,
...
class WanAnimateModel(ModelMixin, ConfigMixin, PeftAdapterMixin):
    """Wan animate model implementation."""
    ...
    def __init__(self,
        ...
        Args:
            ...
            cross_attn_norm: The cross attn norm.
            eps: The eps.
            motion_encoder_dim: The motion encoder dim.
