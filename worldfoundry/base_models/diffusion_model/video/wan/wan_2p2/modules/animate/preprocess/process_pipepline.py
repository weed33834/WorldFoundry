...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> preprocess -> process_pipepline.py functionality."""
...
import worldfoundry.base_models.perception_core.segment.sam2.modeling.sam.transformer as transformer
transformer.USE_FLASH_ATTN = False
transformer.MATH_KERNEL_ON = True
transformer.OLD_GPU = True
from worldfoundry.base_models.diffusion_model.video.wan.wan_2p2.modules.animate.preprocess.sam_utils import (
...
class ProcessPipeline():
    ...
    def __init__(self, det_checkpoint_path, pose2d_checkpoint_path, sam_checkpoint_path, flux_kontext_path):
        ...
        Args:
            det_checkpoint_path: The det checkpoint path.
            pose2d_checkpoint_path: The pose2d checkpoint path.
            sam_checkpoint_path: The sam checkpoint path.
            flux_kontext_path: The flux kontext path.
        """
    ...
    def __call__(self, video_path, refer_image_path, output_path, resolution_area=[1280, 720], fps=30, iterations=3, k=7, w_len=1, h_len=1, retarget_flag=False, use_flux=False, replace_flag=False):
        ...
        Args:
            ...
            refer_image_path: The refer image path.
            output_path: The output path.
            resolution_area: The resolution area.
            fps: The fps.
            iterations: The iterations.
            k: The k.
            w_len: The w len.
            h_len: The h len.
            retarget_flag: The retarget flag.
            use_flux: The use flux.
            replace_flag: The replace flag.
        """
        if replace_flag:
