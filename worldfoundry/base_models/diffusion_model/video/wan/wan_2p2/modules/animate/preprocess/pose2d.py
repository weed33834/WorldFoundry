...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> preprocess -> pose2d.py functionality."""
...
class SimpleOnnxInference(object):
    """Simple onnx inference implementation."""
    def __init__(self, checkpoint, device='cuda', reverse_input=False, **kwargs):
        ...
        Args:
            ...
            device: The device.
            reverse_input: The reverse input.
        """
...
class Yolo(SimpleOnnxInference):
    ...
    def __init__(self, checkpoint, device='cuda', threshold_conf=0.05, threshold_multi_persons=0.1, input_resolution=(640, 640), threshold_iou=0.5, threshold_bbox_shape_ratio=0.4, cat_id=[1], select_type='max', strict=True, sorted_func=None, **kwargs):
        ...
        Args:
            checkpoint: The checkpoint.
            device: The device.
            threshold_conf: The threshold conf.
            threshold_multi_persons: The threshold multi persons.
            input_resolution: The input resolution.
            threshold_iou: The threshold iou.
            threshold_bbox_shape_ratio: The threshold bbox shape ratio.
            cat_id: The cat id.
            select_type: The select type.
            strict: The strict.
            sorted_func: The sorted func.
        """
    ...
    def process_results(self, results, shape_raw, cat_id=[1], single_person=True):
        ...
        Args:
            results: The results.
            shape_raw: The shape raw.
            cat_id: The cat id.
            single_person: The single person.
        """
    ...
    def postprocess_threading(self, outputs, shape_raw, person_results, i, single_person=True, **kwargs):
        """Postprocess threading.

        Args:
            outputs: The outputs.
            shape_raw: The shape raw.
            person_results: The person results.
            i: The i.
            single_person: The single person.
        """
