...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> preprocess -> retarget_pose.py functionality."""
...
def deal_hand_keypoints(hand_res, r_ratio, l_ratio, hand_score_th = 0.5):
    ...
    Args:
        hand_res: The hand res.
        r_ratio: The r ratio.
        l_ratio: The l ratio.
        hand_score_th: The hand score th.
    """
...
def get_scaled_pose(canvas, src_canvas, keypoints, keypoints_hand, bone_ratio_list, delta_ground_x, delta_ground_y,
    ...
    Args:
        canvas: The canvas.
        src_canvas: The src canvas.
        keypoints: The keypoints.
        keypoints_hand: The keypoints hand.
        bone_ratio_list: The bone ratio list.
        delta_ground_x: The delta ground x.
        delta_ground_y: The delta ground y.
        rescaled_src_ground_x: The rescaled src ground x.
        body_flag: The body flag.
        id: The id.
...
def rescale_shorten_skeleton(ratio_list, src_length_list, dst_length_list):
    """Rescale shorten skeleton.

    Args:
        ratio_list: The ratio list.
        src_length_list: The src length list.
        dst_length_list: The dst length list.
    """
...
def write_to_poses(data_to_json, none_idx, dst_shape, bone_ratio_list, delta_ground_x, delta_ground_y, rescaled_src_ground_x, body_flag, scale_min):
    ...
    Args:
        data_to_json: The data to json.
        none_idx: The none idx.
        dst_shape: The dst shape.
        bone_ratio_list: The bone ratio list.
        delta_ground_x: The delta ground x.
        delta_ground_y: The delta ground y.
        rescaled_src_ground_x: The rescaled src ground x.
...
def calculate_scale_ratio(skeleton, skeleton_edit, scale_ratio_flag):
    ...
    Args:
        skeleton: The skeleton.
        skeleton_edit: The skeleton edit.
        scale_ratio_flag: The scale ratio flag.
    """
    if scale_ratio_flag:
...
def retarget_pose(src_skeleton, dst_skeleton, all_src_skeleton, src_skeleton_edit, dst_skeleton_edit, threshold=0.4):
    ...
    Args:
        src_skeleton: The src skeleton.
        dst_skeleton: The dst skeleton.
        all_src_skeleton: The all src skeleton.
        src_skeleton_edit: The src skeleton edit.
        dst_skeleton_edit: The dst skeleton edit.
        threshold: The threshold.
    """
...
def get_retarget_pose(tpl_pose_meta0, refer_pose_meta, tpl_pose_metas, tql_edit_pose_meta0, refer_edit_pose_meta):
    ...
    Args:
        tpl_pose_meta0: The tpl pose meta0.
        refer_pose_meta: The refer pose meta.
        tpl_pose_metas: The tpl pose metas.
        tql_edit_pose_meta0: The tql edit pose meta0.
        refer_edit_pose_meta: The refer edit pose meta.
    """
