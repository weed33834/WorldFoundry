...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> preprocess -> utils.py functionality."""
...
def get_mask_body_img(img_copy, hand_mask, k=7, iterations=1):
    ...
    Args:
        img_copy: The img copy.
        hand_mask: The hand mask.
        k: The k.
...
def resize_by_area(image, target_area, keep_aspect_ratio=True, divisor=64, padding_color=(0, 0, 0)):
    ...
    Args:
        image: The image.
        target_area: The target area.
        keep_aspect_ratio: The keep aspect ratio.
        divisor: The divisor.
...
def get_frame_indices(frame_num, video_fps, clip_length, train_fps):
    ...
    Args:
        ...
        clip_length: The clip length.
        train_fps: The train fps.
    """
