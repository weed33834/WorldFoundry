...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> animate -> preprocess -> sam_utils.py functionality."""

from worldfoundry.base_models.perception_core.segment.sam2.utils import misc as sam2_misc
from worldfoundry.base_models.perception_core.segment.sam2.utils.misc import *
...
from worldfoundry.base_models.perception_core.segment.sam2.build_sam import _load_checkpoint
from worldfoundry.base_models.perception_core.segment.sam2.utils.misc import (
...
def _load_img_v2_as_tensor(img, image_size):
    """Helper function to load img v2 as tensor.
...
def build_sam2_video_predictor(
    ...
    Args:
        ...
        device: The device.
        mode: The mode.
        hydra_overrides_extra: The hydra overrides extra.
        apply_postprocessing: The apply postprocessing.
    """
    hydra_overrides = [
        "++model._target_=worldfoundry.base_models.diffusion_model.video.wan.wan_2p2.modules.animate.preprocess.video_predictor.SAM2VideoPredictor",
    ]
