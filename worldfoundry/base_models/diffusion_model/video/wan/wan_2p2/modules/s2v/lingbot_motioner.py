"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> s2v -> lingbot_motioner.py functionality."""
...
from ..lingbot_model import flash_attention
...
class SwinSelfAttention(SelfAttention):
    """Swin self attention implementation."""
...
class CasualSelfAttention(SelfAttention):
    """Casual self attention implementation."""
...
class MotionerAttentionBlock(nn.Module):
    """Motioner attention block implementation."""
    ...
    def __init__(self,
        ...
        Args:
            ...
            eps: The eps.
            self_attn_block: The self attn block.
        """
        super().__init__()
        self.dim = dim
...
class MotionerTransformers(nn.Module, PeftAdapterMixin):
    """Motioner transformers implementation."""
    ...
    def __init__(
        ...
        Args:
            ...
            motion_stride: The motion stride.
