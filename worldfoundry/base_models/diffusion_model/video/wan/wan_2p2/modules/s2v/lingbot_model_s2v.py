"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p2 -> modules -> s2v -> lingbot_model_s2v.py functionality."""
...
from .lingbot_audio_utils import AudioInjector_WAN, CausalAudioEncoder
from .lingbot_motioner import FramePackMotioner, MotionerTransformers
...
class WanS2VSelfAttention(WanSelfAttention):
    """Wan v self attention implementation."""
...
class WanS2VAttentionBlock(WanAttentionBlock):
    """Wan v attention block implementation."""
...
class WanModel_S2V(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            adain_mode: The adain mode.
            audio_inject_layers: The audio inject layers.
            zero_init: The zero init.
            zero_timestep: The zero timestep.
            enable_motioner: The enable motioner.
            add_last_motion: The add last motion.
            enable_tsm: The enable tsm.
            trainable_token_pos_emb: The trainable token pos emb.
            motion_token_num: The motion token num.
            enable_framepack: The enable framepack.
    ...
    def process_motion_transformer_motioner(self,
                                            ...
                                            drop_motion_frames=False,
                                            add_last_motion=True):
        """Process motion transformer motioner.
