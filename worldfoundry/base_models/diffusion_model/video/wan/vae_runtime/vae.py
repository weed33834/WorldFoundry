"""Module for base_models -> diffusion_model -> video -> wan -> vae_runtime -> vae.py functionality."""
...
from worldfoundry.base_models.diffusion_model.video.wan.wan_2p1.modules.vae import (
    AttentionBlock,
    CausalConv3d,
    RMS_norm,
    Upsample,
...
class ResidualBlock(nn.Module):
    ...
    def forward(self, x, feat_cache_1, feat_cache_2):
        ...
        Args:
            x: The x.
            feat_cache_1: The feat cache 1.
            feat_cache_2: The feat cache 2.
        """
        h = self.shortcut(x)
...
class Resample(nn.Module):
    ...
    def forward(self, x, is_first_frame, feat_cache):
        ...
        Args:
            x: The x.
            is_first_frame: The is first frame.
...
class VAEDecoderWrapperSingle(nn.Module):
    """Vae decoder wrapper single implementation."""
    def __init__(self):
        """Init."""
        super().__init__()
