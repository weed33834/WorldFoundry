...
"""Module for base_models -> diffusion_model -> video -> wan -> wan_2p1 -> configs -> base.py functionality."""

from dataclasses import dataclass, field, fields
from typing import Any

from ..sp.logger import init_logger
...
class ModelConfig:
    ...
    def update_model_arch(self, source_model_dict: dict[str, Any]) -> None:
        ...
        Args:
            source_model_dict: The source model dict.
