...
from worldfoundry.base_models.diffusion_model.video.wan.components.action_attention_wan2p2 import flash_attention
from worldfoundry.base_models.diffusion_model.video.wan.components.action_conditioning_wan2p2 import ActionModule

# --- Int8 Quantization Support ---
_CACHED_TRITON_KERNELS = None
TRITON_KERNELS_PATH = os.path.join(
    os.path.dirname(os.path.dirname(__file__)),
    "components",
    "int8_triton_kernels.py",
)
