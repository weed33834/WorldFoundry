...
"""Module for base_models -> diffusion_model -> video -> wan -> official_wan2_1_runtime -> wan -> vace.py functionality."""
...
class WanVace(WanT2V):
    ...
    def prepare_source(self, src_video, src_mask, src_ref_images, num_frames,
        ...
        Args:
            src_video: The src video.
            src_mask: The src mask.
            src_ref_images: The src ref images.
...
class WanVaceMP(WanVace):
    ...
    def __init__(self,
        ...
        Args:
            ...
            use_usp: The use usp.
            ulysses_size: The ulysses size.
            ring_size: The ring size.
        """
        self.config = config
    ...
    def mp_worker(self, gpu, gpu_infer, pmi_rank, pmi_world_size, in_q_list,
        ...
        Args:
            gpu: The gpu.
            gpu_infer: The gpu infer.
            pmi_rank: The pmi rank.
            pmi_world_size: The pmi world size.
            in_q_list: The in q list.
            out_q: The out q.
            initialized_events: The initialized events.
            work_env: The work env.
        """
        try:
    ...
    def generate(self,
        ...
        Args:
            ...
            input_masks: The input masks.
            input_ref_images: The input ref images.
            size: The size.
            frame_num: The frame num.
            context_scale: The context scale.
            shift: The shift.
            sample_solver: The sample solver.
            sampling_steps: The sampling steps.
            guide_scale: The guide scale.
            n_prompt: The n prompt.
            seed: The seed.
            offload_model: The offload model.
        """
