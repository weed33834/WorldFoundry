...
"""Module for base_models -> diffusion_model -> video -> wan -> official_wan2_1_runtime -> wan -> utils -> prompt_extend.py functionality."""
...
class PromptExpander:
    ...
    def decide_system_prompt(self, tar_lang="zh", multi_images_input=False):
        ...
        Args:
            ...
            multi_images_input: The multi images input.
        """
        zh = tar_lang == "zh"
...
class DashScopePromptExpander(PromptExpander):
    ...
    def __init__(self,
        ...
        if dashscope is None:
            raise ImportError("dashscope is required only when Wan prompt extension is enabled.")
