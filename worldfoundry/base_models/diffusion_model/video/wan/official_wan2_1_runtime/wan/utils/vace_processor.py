...
"""Module for base_models -> diffusion_model -> video -> wan -> official_wan2_1_runtime -> wan -> utils -> vace_processor.py functionality."""
...
class VaceImageProcessor(object):
    """Vace image processor implementation."""
    ...
    def _pillow_convert(self, image, cvt_type='RGB'):
        """Helper function to pillow convert.

        Args:
            image: The image.
            cvt_type: The cvt type.
        """
    ...
    def _image_preprocess(self, img, oh, ow, normalize=True, **kwargs):
        """Helper function to image preprocess.
...
class VaceVideoProcessor(object):
    """Vace video processor implementation."""
    ...
    def __init__(self, downsample, min_area, max_area, min_fps, max_fps,
        ...
        Args:
            downsample: The downsample.
            min_area: The min area.
            max_area: The max area.
            min_fps: The min fps.
            max_fps: The max fps.
            zero_start: The zero start.
            seq_len: The seq len.
            keep_last: The keep last.
        """
        self.downsample = downsample
    ...
    def _video_preprocess(self, video, oh, ow):
        """Helper function to video preprocess.
    ...
    def _get_frameid_bbox_default(self, fps, frame_timestamps, h, w, crop_box,
                                  rng):
        """Helper function to get frameid bbox default.

        Args:
            fps: The fps.
            frame_timestamps: The frame timestamps.
            h: The h.
            w: The w.
    ...
    def _get_frameid_bbox_adjust_last(self, fps, frame_timestamps, h, w,
                                      crop_box, rng):
        """Helper function to get frameid bbox adjust last.
    ...
    def _get_frameid_bbox(self, fps, frame_timestamps, h, w, crop_box, rng):
        """Helper function to get frameid bbox.
