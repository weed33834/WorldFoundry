...
"""Module for base_models -> diffusion_model -> video -> wan -> official_wan2_1_runtime -> wan -> modules -> vace_model.py functionality."""
...
class BaseWanAttentionBlock(WanAttentionBlock):
    """Base wan attention block implementation."""
