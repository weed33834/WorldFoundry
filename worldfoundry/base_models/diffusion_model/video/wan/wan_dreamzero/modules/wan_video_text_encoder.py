"""Module for base_models -> diffusion_model -> video -> wan -> wan_dreamzero -> modules -> wan_video_text_encoder.py functionality."""
...
class WanTextEncoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            shared_pos: The shared pos.
            dropout: The dropout.
            text_encoder_pretrained_path: The text encoder pretrained path.
        """
...
class WanTextEncoderStateDictConverter:
    """Wan text encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
