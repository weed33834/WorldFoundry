"""Module for base_models -> diffusion_model -> video -> wan -> wan_dreamzero -> modules -> wan_video_dit.py functionality."""
...
class RotaryPositionEmbeddingNoPolarOp(nn.Module):
    """Rotary position embedding no polar op implementation."""
...
class RotaryPositionEmbeddingWithPolarOp(nn.Module):
    """Rotary position embedding with polar op implementation."""
    def __init__(self, num_heads: int, head_dim: int):
        """Init.
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            diffusion_model_pretrained_path: The diffusion model pretrained path.
        """
        super().__init__()
        self.dim = dim
