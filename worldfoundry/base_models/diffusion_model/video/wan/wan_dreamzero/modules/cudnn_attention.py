...
class DotProductAttention(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            num_gqa_groups: The num gqa groups.
            attention_dropout: The attention dropout.
            qkv_format: The qkv format.
            attn_mask_type: The attn mask type.
    ...
    def forward(
        ...
        def _get_cu_seqlens(max_seqlen: int) -> torch.Tensor:
            """Helper function to get cu seqlens.
...
def fused_attn(
    ...
    Args:
        ...
        k: The k.
        v: The v.
        fake_dtype: The fake dtype.
        window_size: The window size.
        attn_bias: The attn bias.
        cu_seqlens_q_padded: The cu seqlens q padded.
        cu_seqlens_kv_padded: The cu seqlens kv padded.
        page_table_k: The page table k.
        page_table_v: The page table v.
        attn_scale: The attn scale.
        dropout: The dropout.
        fast_zero_fill: The fast zero fill.
        qkv_layout: The qkv layout.
        attn_bias_type: The attn bias type.
        attn_mask_type: The attn mask type.
        softmax_type: The softmax type.
        deterministic: The deterministic.
        softmax_offset: The softmax offset.
...
def fused_attn_bwd_op(
    ...
    Args:
        ...
        out: The out.
        d_out: The d out.
        dqkv_nominal_dtype: The dqkv nominal dtype.
        dqkv_te_dtype: The dqkv te dtype.
        aux_ctx_tensors: The aux ctx tensors.
        cu_seqlens_q_padded: The cu seqlens q padded.
        cu_seqlens_kv_padded: The cu seqlens kv padded.
