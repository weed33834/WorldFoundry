...
class CLIP(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            text_mlp_ratio: The text mlp ratio.
            text_heads: The text heads.
            text_layers: The text layers.
            text_causal: The text causal.
            text_pool: The text pool.
            text_head_bias: The text head bias.
            logit_bias: The logit bias.
            activation: The activation.
            attn_dropout: The attn dropout.
            proj_dropout: The proj dropout.
            embedding_dropout: The embedding dropout.
...
class WanImageEncoder(torch.nn.Module):
    """Wan image encoder implementation."""

    def __init__(self, image_encoder_pretrained_path: str=None):
        """Init.

        Args:
            image_encoder_pretrained_path: The image encoder pretrained path.
        """
        super().__init__()
        # init model
...
class WanImageEncoderStateDictConverter:
    """Wan image encoder state dict converter implementation."""
    def __init__(self):
        """Init."""
        pass
