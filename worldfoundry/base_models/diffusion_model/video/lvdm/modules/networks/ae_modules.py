...
"""Module for base_models -> diffusion_model -> video -> lvdm -> modules -> networks -> ae_modules.py functionality."""
...
from worldfoundry.base_models.diffusion_model.video.lvdm.modules.attention import LinearAttention
