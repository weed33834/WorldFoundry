"""Module for base_models -> diffusion_model -> video -> skyreels_v3 -> skyreels_v3 -> modules -> transformer.py functionality."""
...
def rope_apply(
    ...
    Args:
        ...
        num_token_list: The num token list.
        num_frame_list: The num frame list.
        grid_size_list: The grid size list.
    """
