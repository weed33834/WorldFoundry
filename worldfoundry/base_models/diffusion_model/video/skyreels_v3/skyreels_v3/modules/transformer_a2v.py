...
"""Module for base_models -> diffusion_model -> video -> skyreels_v3 -> skyreels_v3 -> modules -> transformer_a2v.py functionality."""
...
class RotaryPositionalEmbedding1D(nn.Module):
    """Rotary positional embedding d implementation."""
    ...
    def precompute_freqs_cis_1d(self, pos_indices):
        """Precompute freqs cis 1d.

        Args:
            pos_indices: The pos indices.
        """
...
class SingleStreamAttention(nn.Module):
    """Single stream attention implementation."""
    def __init__(
        self,
        dim: int,
        ...
        Args:
            dim: The dim.
            encoder_hidden_states_dim: The encoder hidden states dim.
...
class SingleStreamMutiAttention(SingleStreamAttention):
    """Single stream muti attention implementation."""
    def __init__(
        self,
        dim: int,
        encoder_hidden_states_dim: int,
        ...
        Args:
            ...
            proj_drop: The proj drop.
            eps: The eps.
            class_range: The class range.
            class_interval: The class interval.
    ...
    def forward(
        ...
        Args:
            ...
            encoder_hidden_states: The encoder hidden states.
            shape: The shape.
            x_ref_attn_map: The x ref attn map.
            enable_sp: The enable sp.
            human_num: The human num.
...
class WanAttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            norm_input_visual: The norm input visual.
            class_range: The class range.
            class_interval: The class interval.
        """
        super().__init__()
...
class AudioProjModel(ModelMixin, ConfigMixin):
    """Audio proj model implementation."""
    def __init__(
        self,
        seq_len=5,
        seq_len_vf=12,
        ...
        Args:
            seq_len: The seq len.
            seq_len_vf: The seq len vf.
            blocks: The blocks.
            channels: The channels.
            intermediate_dim: The intermediate dim.
            output_dim: The output dim.
            context_tokens: The context tokens.
            norm_output_audio: The norm output audio.
        """
        super().__init__()
    ...
    def forward(self, audio_embeds, audio_embeds_vf):
        ...
        Args:
            ...
            audio_embeds_vf: The audio embeds vf.
        """
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            cross_attn_norm: The cross attn norm.
            eps: The eps.
            audio_window: The audio window.
            intermediate_dim: The intermediate dim.
            output_dim: The output dim.
            context_tokens: The context tokens.
            vae_scale: The vae scale.
            norm_input_visual: The norm input visual.
            norm_output_audio: The norm output audio.
        """
        super().__init__()
    ...
    def forward(
        ...
        Args:
            ...
            ref_target_masks: The ref target masks.
            audio_mask: The audio mask.
            block_offload: The block offload.
        """
