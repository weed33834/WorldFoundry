"""Module for base_models -> diffusion_model -> video -> skyreels_v3 -> skyreels_v3 -> pipelines -> talking_avatar_pipeline.py functionality."""
...
class TalkingAvatarPipeline:
    """Talking avatar pipeline implementation."""
    @classmethod
    def init_dit_model(
        cls,
        checkpoint_dir: str,
    ...
    def __init__(
        ...
        Args:
            ...
            use_usp: The use usp.
            num_timesteps: The num timesteps.
            use_timestep_transform: The use timestep transform.
            offload: The offload.
            low_vram: The low vram.
        """
        ...
        if use_usp:
            ...
            from worldfoundry.core.attention.avatar_context_parallel import (
    ...
    def generate(
        ...
        Args:
            ...
            size_buckget: The size buckget.
            motion_frame: The motion frame.
            drop_frame: The drop frame.
            frame_num: The frame num.
            shift: The shift.
            sampling_steps: The sampling steps.
            text_guide_scale: The text guide scale.
            audio_guide_scale: The audio guide scale.
            n_prompt: The n prompt.
            connection_prompt: The connection prompt.
            seed: The seed.
            max_frames_num: The max frames num.
