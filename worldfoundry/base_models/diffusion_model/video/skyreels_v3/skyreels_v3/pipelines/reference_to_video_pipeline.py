"""Module for base_models -> diffusion_model -> video -> skyreels_v3 -> skyreels_v3 -> pipelines -> reference_to_video_pipeline.py functionality."""
...
class WanSkyReelsA2WanT2VPipeline(DiffusionPipeline, WanLoraLoaderMixin):
    ...
    def _execution_device(self):
        """Helper function to execution device."""
...
class ReferenceToVideoPipeline:
    """Reference to video pipeline implementation."""
    def __init__(
        self,
        model_path: str,
        device: str = "cuda",
        ...
        if self.use_usp:
            from worldfoundry.core.attention.reference_context_parallel import (
