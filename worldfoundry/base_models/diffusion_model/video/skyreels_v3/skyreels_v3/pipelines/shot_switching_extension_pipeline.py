"""Module for base_models -> diffusion_model -> video -> skyreels_v3 -> skyreels_v3 -> pipelines -> shot_switching_extension_pipeline.py functionality."""
...
class ShotSwitchingExtensionPipeline:
    ...
    def __init__(
        ...
        if use_usp:
            ...
            from worldfoundry.core.attention.extension_context_parallel import (
                usp_attn_forward,
                usp_dit_forward,
            )
