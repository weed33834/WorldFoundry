...
"""Module for base_models -> diffusion_model -> video -> vchitect -> vchitect_runtime -> models -> VchitectXL.py functionality."""
...
from worldfoundry.core.io import load_json
...
class VchitectXLTransformerModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            joint_attention_dim: The joint attention dim.
            caption_projection_dim: The caption projection dim.
            pooled_projection_dim: The pooled projection dim.
            out_channels: The out channels.
            pos_embed_max_size: The pos embed max size.
            tp_size: The tp size.
            rope_scaling_factor: The rope scaling factor.
        """
        super().__init__()
    ...
    def from_pretrained_temporal(cls, pretrained_model_path, torch_dtype, logger, subfolder=None, tp_size=1):
        ...
        state_dict = load_core_state_dict(model_file, device="cpu")
