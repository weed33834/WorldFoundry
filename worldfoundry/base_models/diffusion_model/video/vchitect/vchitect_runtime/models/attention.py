...
"""Module for base_models -> diffusion_model -> video -> vchitect -> vchitect_runtime -> models -> attention.py functionality."""
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            dropout: The dropout.
            bias: The bias.
            upcast_attention: The upcast attention.
            upcast_softmax: The upcast softmax.
            cross_attention_norm: The cross attention norm.
            cross_attention_norm_num_groups: The cross attention norm num groups.
            qk_norm: The qk norm.
            added_kv_proj_dim: The added kv proj dim.
            norm_num_groups: The norm num groups.
            spatial_norm_dim: The spatial norm dim.
            out_bias: The out bias.
            scale_qk: The scale qk.
            only_cross_attention: The only cross attention.
            eps: The eps.
            rescale_output_factor: The rescale output factor.
            residual_connection: The residual connection.
            _from_deprecated_attn_block: The from deprecated attn block.
            processor: The processor.
            out_dim: The out dim.
            context_pre_only: The context pre only.
            tp_size: The tp size.
        """
        super().__init__()
        ...
        # _worldfoundry_scaled_dot_product_attention for native Flash/memory_efficient_attention
...
class CustomDiffusionAttnProcessor(nn.Module):
    ...
    def __init__(
        ...
        Args:
            train_kv: The train kv.
            train_q_out: The train q out.
...
class JointAttnProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        hidden_states = hidden_states = _worldfoundry_scaled_dot_product_attention(
...
class VchitectAttnProcessor:
    """Vchitect attn processor implementation."""
    ...
    def __call__(
        ...
        **kwargs,
        ...
        hidden_states_temp = hidden_states_temp = _worldfoundry_scaled_dot_product_attention(
        ...
        cross_output = _worldfoundry_scaled_dot_product_attention(
...
class AttnProcessorNPU:
    ...
    fp32 is used, _worldfoundry_scaled_dot_product_attention will be used for computation, but the acceleration effect on NPU is
    not significant.
...
class SpatialNorm(nn.Module):
    ...
    def __init__(
        ...
        Args:
            f_channels: The f channels.
            zq_channels: The zq channels.
        """
        super().__init__()
...
class LoRAAttnProcessor(nn.Module):
    """Lo ra attn processor implementation."""
    def __init__(
        self,
        hidden_size: int,
        cross_attention_dim: Optional[int] = None,
        ...
        **kwargs,
        ...
        Args:
            ...
            cross_attention_dim: The cross attention dim.
            rank: The rank.
            network_alpha: The network alpha.
        """
...
class IPAdapterAttnProcessor(nn.Module):
    ...
    def __call__(
        ...
        Args:
            ...
            temb: The temb.
            scale: The scale.
            ip_adapter_masks: The ip adapter masks.
        """
        residual = hidden_states
            ...
            if not skip:
                if mask is not None:
                    ...
                    for i in range(current_num_images):
                        ...
                        # the output of sdp = (batch, num_heads, seq_len, head_dim)
                        # TODO: add support for attn.scale when we move to Torch 2.1
                        _current_ip_hidden_states = _worldfoundry_scaled_dot_product_attention(
                    ...
                    # the output of sdp = (batch, num_heads, seq_len, head_dim)
                    # TODO: add support for attn.scale when we move to Torch 2.1
                    current_ip_hidden_states = _worldfoundry_scaled_dot_product_attention(
                        query, ip_key, ip_value, attn_mask=None, dropout_p=0.0, is_causal=False
                    )
