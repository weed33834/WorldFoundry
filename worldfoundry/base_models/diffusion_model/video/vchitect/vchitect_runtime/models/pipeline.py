...
"""Module for base_models -> diffusion_model -> video -> vchitect -> vchitect_runtime -> models -> pipeline.py functionality."""
...
from .VchitectXL import VchitectXLTransformerModel
...
def load_text_encoders(load_path, class_one, class_two, class_three, precision="fp16"):
    ...
    Args:
        ...
        class_one: The class one.
        class_two: The class two.
        class_three: The class three.
...
class VchitectXLPipeline():
    ...
    def _get_t5_prompt_embeds(
        ...
        """Helper function to get t5 prompt embeds.
    ...
    def _get_clip_prompt_embeds(
        ...
        """Helper function to get clip prompt embeds.
        ...
        Args:
            ...
            clip_model_index: The clip model index.
        """
        device = device or self.execution_device
    ...
    def check_inputs(
        ...
        Args:
            prompt: The prompt.
            prompt_2: The prompt 2.
            prompt_3: The prompt 3.
            height: The height.
            width: The width.
            negative_prompt: The negative prompt.
            negative_prompt_2: The negative prompt 2.
            negative_prompt_3: The negative prompt 3.
            prompt_embeds: The prompt embeds.
            negative_prompt_embeds: The negative prompt embeds.
            pooled_prompt_embeds: The pooled prompt embeds.
            negative_pooled_prompt_embeds: The negative pooled prompt embeds.
    ...
    def __call__(
        ...
        pooled_prompt_embeds = pooled_prompt_embeds.to(dtype=transformer_dtype)
        ...
        for v_idx in range(latents.shape[1]):
            image = self.vae.decode(latents[:,v_idx].to(dtype=vae_dtype), return_dict=False)[0]
