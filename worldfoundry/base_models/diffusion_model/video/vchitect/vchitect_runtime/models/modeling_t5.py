...
class T5DenseActDense(nn.Module):
    """Dense act dense implementation."""
...
class T5DenseGatedActDense(nn.Module):
    """Dense gated act dense implementation."""
    def __init__(self, config: T5Config):
        """Init.
...
class T5Attention(nn.Module):
    ...
    def __init__(self, config: T5Config, has_relative_attention_bias=False):
        ...
        Args:
            config: The config.
            has_relative_attention_bias: The has relative attention bias.
        """
        super().__init__()
...
class T5LayerSelfAttention(nn.Module):
    """Layer self attention implementation."""
    ...
    def forward(
        ...
        Args:
            ...
            position_bias: The position bias.
            layer_head_mask: The layer head mask.
...
class T5LayerCrossAttention(nn.Module):
    """Layer cross attention implementation."""
    ...
    def forward(
        ...
        Args:
            hidden_states: The hidden states.
            key_value_states: The key value states.
            attention_mask: The attention mask.
            position_bias: The position bias.
            layer_head_mask: The layer head mask.
            past_key_value: The past key value.
            use_cache: The use cache.
            query_length: The query length.
            output_attentions: The output attentions.
        """
        normed_hidden_states = self.layer_norm(hidden_states)
...
class T5Block(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            encoder_decoder_position_bias: The encoder decoder position bias.
            layer_head_mask: The layer head mask.
            cross_attn_layer_head_mask: The cross attn layer head mask.
            past_key_value: The past key value.
            use_cache: The use cache.
            output_attentions: The output attentions.
...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _shift_right(self, input_ids):
        """Helper function to shift right.
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        Args:
            ...
            cross_attn_head_mask: The cross attn head mask.
...
class T5Model(T5PreTrainedModel):
    ...
    def _tie_weights(self):
        """Helper function to tie weights."""
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    """For conditional generation implementation."""
    _keys_to_ignore_on_load_unexpected = [
        "decoder.block.0.layer.1.EncDecAttention.relative_attention_bias.weight",
    ]
    ...
    def _reorder_cache(self, past_key_values, beam_idx):
        """Helper function to reorder cache.

        Args:
            past_key_values: The past key values.
            beam_idx: The beam idx.
        """
...
class T5ForSequenceClassification(T5PreTrainedModel):
    """For sequence classification implementation."""
