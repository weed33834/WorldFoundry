...
"""Module for base_models -> diffusion_model -> video -> cosmos2p5 -> pipeline -> pipeline_cosmos2_5_predict.py functionality."""
...
class Cosmos2_5_PredictBasePipeline(DiffusionPipeline):
    ...
    def _match_num_frames(self, video: torch.Tensor, target_num_frames: int) -> torch.Tensor:
        """Helper function to match num frames.

        Args:
            video: The video.
            target_num_frames: The target num frames.
