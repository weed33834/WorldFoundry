...
"""Module for base_models -> diffusion_model -> video -> cosmos2p5 -> pipeline -> pipeline_cosmos2_5_transfer.py functionality."""
...
def _maybe_pad_or_trim_video(video: torch.Tensor, num_frames: int):
    """Helper function to maybe pad or trim video.
...
class Cosmos2_5_TransferPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        Args:
            ...
            safety_checker: The safety checker.
        """
        super().__init__()
    ...
    def _get_prompt_embeds(
        ...
        """Helper function to get prompt embeds.
    ...
    def prepare_latents(
        ...
        Args:
            ...
            height: The height.
            width: The width.
            num_frames_in: The num frames in.
            num_frames_out: The num frames out.
            do_classifier_free_guidance: The do classifier free guidance.
            dtype: The dtype.
            device: The device.
            generator: The generator.
            latents: The latents.
            num_cond_latent_frames: The num cond latent frames.
    ...
    def check_inputs(
        ...
        Args:
            ...
            num_ar_conditional_frames: The num ar conditional frames.
            num_ar_latent_conditional_frames: The num ar latent conditional frames.
            num_frames_per_chunk: The num frames per chunk.
            num_frames: The num frames.
            conditional_frame_timestep: The conditional frame timestep.
        """
