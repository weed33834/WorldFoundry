...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> models -> text_encoders -> byT5 -> __init__.py functionality."""
...
class ByT5Mapper(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, hidden_dim, out_dim1, use_residual=True):
        ...
        Args:
            ...
            out_dim1: The out dim1.
            use_residual: The use residual.
        """
        super().__init__()
        if use_residual:
