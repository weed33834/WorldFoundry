"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> optim -> muon.py functionality."""
...
class Muon(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        Args:
            lr: The lr.
            wd: The wd.
            muon_params: The muon params.
            momentum: The momentum.
            nesterov: The nesterov.
            ns_steps: The ns steps.
            adamw_params: The adamw params.
            adamw_betas: The adamw betas.
            adamw_eps: The adamw eps.
        """
