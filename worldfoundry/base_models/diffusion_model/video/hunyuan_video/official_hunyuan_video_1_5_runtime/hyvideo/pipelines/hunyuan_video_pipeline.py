...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> pipelines -> hunyuan_video_pipeline.py functionality."""
...
class HunyuanVideo_1_5_Pipeline(DiffusionPipeline):
    """Hunyuan video pipeline implementation."""
    ...
    def __init__(
        ...
        Args:
            ...
            embedded_guidance_scale: The embedded guidance scale.
            progress_bar_config: The progress bar config.
            vision_num_semantic_tokens: The vision num semantic tokens.
            vision_states_dim: The vision states dim.
            glyph_byT5_v2: The glyph byt5 v2.
            byt5_model: The byt5 model.
            byt5_tokenizer: The byt5 tokenizer.
            byt5_max_length: The byt5 max length.
            prompt_format: The prompt format.
            execution_device: The execution device.
            vision_encoder: The vision encoder.
            enable_offloading: The enable offloading.
        """
        super().__init__()
    ...
    def _load_byt5(cls, cached_folder, glyph_byT5_v2, byt5_max_length, device):
        """Helper function to load byt5.

        Args:
            cached_folder: The cached folder.
            glyph_byT5_v2: The glyph byt5 v2.
            byt5_max_length: The byt5 max length.
            device: The device.
        """
    ...
    def get_task_mask(self, task_type, latent_target_length):
        ...
        Args:
            ...
            latent_target_length: The latent target length.
        """
        if task_type == "t2v":
    ...
    def load_sr_transformer_upsampler(cls, cached_folder, sr_version, transformer_dtype=torch.bfloat16, device=None):
        """Load sr transformer upsampler.

        Args:
            cached_folder: The cached folder.
            sr_version: The sr version.
            transformer_dtype: The transformer dtype.
            device: The device.
        """
    ...
    def get_transformer_version(resolution, task, cfg_distilled=False, step_distilled=False, sparse_attn=False):
        ...
        Args:
            ...
            task: The task.
            cfg_distilled: The cfg distilled.
            step_distilled: The step distilled.
            sparse_attn: The sparse attn.
        """
    ...
    def create_pipeline(cls, pretrained_model_name_or_path, transformer_version, create_sr_pipeline=False, transformer_dtype=torch.bfloat16, device=None, transformer_init_device=None, **kwargs):
        ...
        Args:
            ...
            transformer_version: The transformer version.
            create_sr_pipeline: The create sr pipeline.
            transformer_dtype: The transformer dtype.
            device: The device.
            transformer_init_device: The transformer init device.
        """
    ...
    def get_offloading_config(memory_limitation=None):
        ...
        Args:
            memory_limitation: The memory limitation.
        """
    ...
    def _load_text_encoders(cls, pretrained_model_path, device):
        """Helper function to load text encoders.
    ...
    def _load_vision_encoder(cls, pretrained_model_name_or_path, device):
        """Helper function to load vision encoder.
