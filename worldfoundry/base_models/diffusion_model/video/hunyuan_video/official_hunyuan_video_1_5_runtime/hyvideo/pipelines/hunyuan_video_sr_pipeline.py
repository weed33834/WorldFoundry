...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> pipelines -> hunyuan_video_sr_pipeline.py functionality."""
...
class BucketMap:
    ...
    def __init__(self, lr_base_size, hr_base_size, lr_patch_size, hr_patch_size):
        ...
        Args:
            lr_base_size: The lr base size.
            hr_base_size: The hr base size.
            lr_patch_size: The lr patch size.
            hr_patch_size: The hr patch size.
        """
...
class HunyuanVideo_1_5_SR_Pipeline(HunyuanVideo_1_5_Pipeline):
    ...
    def __init__(
        ...
        Args:
            ...
            base_resolution: The base resolution.
