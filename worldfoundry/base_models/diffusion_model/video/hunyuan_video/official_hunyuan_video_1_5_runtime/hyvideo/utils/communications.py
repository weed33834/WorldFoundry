...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> utils -> communications.py functionality."""
...
class SeqAllToAll4D(torch.autograd.Function):
    """Seq all to all d implementation."""
    @staticmethod
    def forward(
        ctx: Any,
        ...
        Args:
            ...
            group: The group.
            input: The input.
            scatter_idx: The scatter idx.
            gather_idx: The gather idx.
...
def all_to_all_4D(
    ...
    Args:
        input_: The input.
        group: The group.
        scatter_dim: The scatter dim.
        gather_dim: The gather dim.
    """
