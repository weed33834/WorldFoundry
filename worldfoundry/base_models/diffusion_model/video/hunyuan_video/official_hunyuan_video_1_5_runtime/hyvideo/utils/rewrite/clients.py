...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> utils -> rewrite -> clients.py functionality."""
...
class NonStreamResponse(object):
    """Non stream response implementation."""
    def __init__(self):
        """Init."""
        self.response = ""
...
class DeepSeekClient(object):
    """Deep seek client implementation."""
