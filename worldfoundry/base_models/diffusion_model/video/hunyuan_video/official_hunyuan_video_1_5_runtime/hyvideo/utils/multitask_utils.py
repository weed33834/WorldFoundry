...
"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_1_5_runtime -> hyvideo -> utils -> multitask_utils.py functionality."""
...
def merge_tensor_by_mask(tensor_1, tensor_2, mask, dim):
    """Merge tensor by mask.

    Args:
        tensor_1: The tensor 1.
        tensor_2: The tensor 2.
        mask: The mask.
        dim: The dim.
    """
