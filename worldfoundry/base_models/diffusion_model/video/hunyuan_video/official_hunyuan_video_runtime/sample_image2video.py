"""Module for base_models -> diffusion_model -> video -> hunyuan_video -> official_hunyuan_video_runtime -> sample_image2video.py functionality."""
...
def main():
    ...
    if 'LOCAL_RANK' not in os.environ or int(os.environ['LOCAL_RANK']) == 0:
        for i, sample in enumerate(samples):
            ...
            save_videos_grid(sample, cur_save_path, fps=int(args.fps))
