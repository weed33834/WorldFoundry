...
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.model_protocol import ModelType

if TYPE_CHECKING:
    from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.loader.fuse_loras import FuseRule
