...
Usage via the ``ModuleOps`` pattern (preferred)::
    from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae import MEMORY_EFFICIENT_DECODE
...
Or applied directly to an existing decoder::
    from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.memory_efficient_decode import (
...
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.convolution import CausalConv3d
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.ops import unpatchify
...
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.sampling import DepthToSpaceUpsample

if TYPE_CHECKING:
    from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.video_vae import VideoDecoder
...
def enable_memory_efficient_decode(decoder: nn.Module) -> nn.Module:
    ...
    from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.model.video_vae.video_vae import VideoDecoder  # noqa: PLC0415
