...
class Modality:
    ...
    Attributes:
        ...
        attention_mask: Optional 2-D self-attention mask, shape ``(B, T, T)``.
            ...
            :class:`~worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.conditioning.types.attention_strength_wrapper.ConditioningItemAttentionStrengthWrapper`.
    """
