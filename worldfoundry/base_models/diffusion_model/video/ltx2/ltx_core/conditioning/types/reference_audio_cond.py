...
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.conditioning.mask_utils import update_attention_mask
...
class AudioConditionByReferenceLatent:
    ...
    Mirrors :class:`worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.conditioning.types.reference_video_cond.VideoConditionByReferenceLatent`
    ...
    :meth:`worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.tools.LatentTools.clear_conditioning`.
    Args:
