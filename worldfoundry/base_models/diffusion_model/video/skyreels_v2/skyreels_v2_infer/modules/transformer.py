...
"""Module for base_models -> diffusion_model -> video -> skyreels_v2 -> skyreels_v2_infer -> modules -> transformer.py functionality."""
...
class WanModel(ModelMixin, ConfigMixin, PeftAdapterMixin):
    ...
    def initialize_teacache(self, enable_teacache=True, num_steps=25, teacache_thresh=0.15, use_ret_steps=False, ckpt_dir=''):
        ...
        Args:
            enable_teacache: The enable teacache.
            num_steps: The num steps.
            teacache_thresh: The teacache thresh.
            use_ret_steps: The use ret steps.
