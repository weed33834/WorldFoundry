...
"""Module for base_models -> diffusion_model -> video -> step_video -> step_video_runtime -> stepvideo -> diffusion -> video_pipeline.py functionality."""
...
class StepVideoPipelineOutput(BaseOutput):
    """Step video pipeline output implementation."""
...
class StepVideoPipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        ...
        Args:
            prompt: The prompt.
            neg_magic: The neg magic.
            pos_magic: The pos magic.
        """
