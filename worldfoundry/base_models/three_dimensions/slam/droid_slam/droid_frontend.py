"""Module for base_models -> three_dimensions -> slam -> droid_slam -> droid_frontend.py functionality."""
...
class DroidFrontend:
    ...
    def _init_next_state(self):
        """Helper function to init next state."""
