...
# croppping utilities
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> dust3r -> dust3r -> utils -> cropping.py functionality."""
...
def camera_matrix_of_crop(input_camera_matrix, input_resolution, output_resolution, scaling=1, offset_factor=0.5, offset=None):
    """Camera matrix of crop.

    Args:
        input_camera_matrix: The input camera matrix.
        input_resolution: The input resolution.
        output_resolution: The output resolution.
        scaling: The scaling.
        offset_factor: The offset factor.
        offset: The offset.
    """
...
def bbox_from_intrinsics_in_out(input_camera_matrix, output_camera_matrix, output_resolution):
    """Bbox from intrinsics in out.

    Args:
        input_camera_matrix: The input camera matrix.
        output_camera_matrix: The output camera matrix.
        output_resolution: The output resolution.
    """
