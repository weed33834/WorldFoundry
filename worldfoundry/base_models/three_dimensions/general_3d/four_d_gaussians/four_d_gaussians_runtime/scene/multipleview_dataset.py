"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> multipleview_dataset.py functionality."""
...
class multipleview_dataset(Dataset):
    """Multipleview dataset implementation."""
    def __init__(
        self,
        cam_extrinsics,
        cam_intrinsics,
