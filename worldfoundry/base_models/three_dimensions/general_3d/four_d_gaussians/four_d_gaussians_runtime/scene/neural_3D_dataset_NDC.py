"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> neural_3D_dataset_NDC.py functionality."""
...
class Neural3D_NDC_Dataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            is_stack: The is stack.
            cal_fine_bbox: The cal fine bbox.
            N_vis: The n vis.
            time_scale: The time scale.
            scene_bbox_min: The scene bbox min.
            scene_bbox_max: The scene bbox max.
            N_random_pose: The n random pose.
            bd_factor: The bd factor.
            eval_step: The eval step.
            eval_index: The eval index.
            sphere_scale: The sphere scale.
        """
        self.img_wh = (
            int(1352 / downsample),
            int(1014 / downsample),
