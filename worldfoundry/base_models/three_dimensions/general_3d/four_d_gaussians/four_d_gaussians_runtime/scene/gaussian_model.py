...
"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> gaussian_model.py functionality."""
...
try:
    ...
    def distCUDA2(points):
        ...
        distances = torch.cdist(points, points, p=2).pow(2)
        distances.fill_diagonal_(float("inf"))
        kth = min(3, max(1, points.shape[0] - 1))
        return distances.topk(kth, largest=False).values.mean(dim=1)
...
class GaussianModel:
    ...
    def setup_functions(self):
        ...
        def build_covariance_from_scaling_rotation(scaling, scaling_modifier, rotation):
            """Build covariance from scaling rotation.

            Args:
                scaling: The scaling.
                scaling_modifier: The scaling modifier.
    ...
    def restore(self, model_args, training_args):
        ...
        Args:
            ...
            training_args: The training args.
        """
        (self.active_sh_degree, 
        self._xyz, 
        deform_state,
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float, time_line: int):
        ...
        Args:
            pcd: The pcd.
            spatial_lr_scale: The spatial lr scale.
            time_line: The time line.
        """
    ...
    def _prune_optimizer(self, mask):
        """Helper function to prune optimizer.
    ...
    def cat_tensors_to_optimizer(self, tensors_dict):
        """Cat tensors to optimizer.

        Args:
            tensors_dict: The tensors dict.
        """
        optimizable_tensors = {}
        for group in self.optimizer.param_groups:
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_deformation_table):
        ...
        Args:
            new_xyz: The new xyz.
            new_features_dc: The new features dc.
            new_features_rest: The new features rest.
            new_opacities: The new opacities.
            new_scaling: The new scaling.
            new_rotation: The new rotation.
            new_deformation_table: The new deformation table.
        """
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        Args:
            grads: The grads.
            grad_threshold: The grad threshold.
            scene_extent: The scene extent.
            N: The n.
        """
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent, density_threshold=20, displacement_scale=20, model_path=None, iteration=None, stage=None):
        ...
        Args:
            ...
            displacement_scale: The displacement scale.
    ...
    def add_point_by_mask(self, selected_pts_mask, perturb=0):
        ...
        Args:
            selected_pts_mask: The selected pts mask.
            perturb: The perturb.
        """
    ...
    def prune(self, max_grad, min_opacity, extent, max_screen_size):
        ...
        Args:
            max_grad: The max grad.
            min_opacity: The min opacity.
            extent: The extent.
            max_screen_size: The max screen size.
        """
    ...
    def add_densification_stats(self, viewspace_point_tensor, update_filter):
        ...
        Args:
            viewspace_point_tensor: The viewspace point tensor.
    ...
    def _plane_regulation(self):
        """Helper function to plane regulation."""
    ...
    def _time_regulation(self):
        """Helper function to time regulation."""
        multi_res_grids = self._deformation.deformation_net.grid.grids
        total = 0
        # model.grids is 6 x [1, rank * F_dim, reso, reso]
        for grids in multi_res_grids:
    ...
    def _l1_regulation(self):
        """Helper function to l1 regulation."""
                # model.grids is 6 x [1, rank * F_dim, reso, reso]
        multi_res_grids = self._deformation.deformation_net.grid.grids
    ...
    def compute_regulation(self, time_smoothness_weight, l1_time_planes_weight, plane_tv_weight):
        ...
        Args:
            time_smoothness_weight: The time smoothness weight.
            l1_time_planes_weight: The l1 time planes weight.
            plane_tv_weight: The plane tv weight.
        """
