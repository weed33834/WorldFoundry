"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> hyper_loader.py functionality."""
...
class Load_hyper_data(Dataset):
    """Load hyper data implementation."""
    def __init__(self, 
                 datadir, 
                 ratio=1.0,
                 use_bg_points=False,
