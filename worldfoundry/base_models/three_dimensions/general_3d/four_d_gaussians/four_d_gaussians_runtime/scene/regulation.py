"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> regulation.py functionality."""
...
class TimeSmoothness(Regularizer):
    """Time smoothness implementation."""
    def __init__(self, initial_value, what: str = 'field'):
        """Init.
