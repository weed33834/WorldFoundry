"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> scene -> camera.py functionality."""
...
def get_3D_points_from_depth(opt,center,ray,depth,multi_samples=False):
    ...
    Args:
        ...
        ray: The ray.
        depth: The depth.
        multi_samples: The multi samples.
    """
...
def get_novel_view_poses(opt,pose_anchor,N=60,scale=1):
    """Get novel view poses.

    Args:
        opt: The opt.
        pose_anchor: The pose anchor.
        N: The n.
        scale: The scale.
    """
