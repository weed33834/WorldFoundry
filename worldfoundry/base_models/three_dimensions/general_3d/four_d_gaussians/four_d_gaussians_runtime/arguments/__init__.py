...
"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> arguments -> __init__.py functionality."""
...
class PipelineParams(ParamGroup):
    """Pipeline params implementation."""
...
class ModelHiddenParams(ParamGroup):
    """Model hidden params implementation."""
    def __init__(self, parser):
        """Init.
...
class OptimizationParams(ParamGroup):
    """Optimization params implementation."""
    def __init__(self, parser):
        """Init.
