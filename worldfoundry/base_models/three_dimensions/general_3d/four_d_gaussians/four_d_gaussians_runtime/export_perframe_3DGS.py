"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> export_perframe_3DGS.py functionality."""
...
def render_sets(dataset : ModelParams, hyperparam, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool, skip_video: bool):
    ...
    Args:
        dataset: The dataset.
        hyperparam: The hyperparam.
        iteration: The iteration.
        pipeline: The pipeline.
        skip_train: The skip train.
        skip_test: The skip test.
        skip_video: The skip video.
    """
    with torch.no_grad():
...
def construct_list_of_attributes(feature_dc_shape, feature_rest_shape, scaling_shape,rotation_shape):
    ...
    Args:
        feature_dc_shape: The feature dc shape.
        feature_rest_shape: The feature rest shape.
        scaling_shape: The scaling shape.
        rotation_shape: The rotation shape.
    """
    l = ['x', 'y', 'z', 'nx', 'ny', 'nz']
...
def init_3DGaussians_ply(points, scales, rotations, opactiy, shs, feature_shape):
    ...
    Args:
        ...
        opactiy: The opactiy.
        shs: The shs.
        feature_shape: The feature shape.
    """
