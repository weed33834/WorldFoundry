"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> utils -> point_utils.py functionality."""
...
def downsample_point_cloud_cluster(points, voxel_size):
    """Downsample point cloud cluster.
...
def visualize_point_cloud(points, low_density_points, new_points):
    ...
    Args:
        points: The points.
        low_density_points: The low density points.
