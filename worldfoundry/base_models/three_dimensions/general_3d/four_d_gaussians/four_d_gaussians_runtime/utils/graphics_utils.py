...
"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> utils -> graphics_utils.py functionality."""
...
class BasicPointCloud(NamedTuple):
    """Basic point cloud implementation."""
    points : np.array
    colors : np.array
    normals : np.array

def geom_transform_points(points, transf_matrix):
    """Geom transform points.

    Args:
        points: The points.
        transf_matrix: The transf matrix.
    """
    P, _ = points.shape
