"""Module for base_models -> three_dimensions -> general_3d -> four_d_gaussians -> four_d_gaussians_runtime -> utils -> pose_utils.py functionality."""
...
def smooth_camera_poses(cameras, num_interpolations=5):
    ...
    Args:
        cameras: The cameras.
        num_interpolations: The num interpolations.
    """
    smoothed_cameras = []
    smoothed_times = []
