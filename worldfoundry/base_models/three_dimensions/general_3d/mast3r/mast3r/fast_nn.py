...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> mast3r -> mast3r -> fast_nn.py functionality."""
...
def fast_reciprocal_NNs(pts1, pts2, subsample_or_initxy1=8, ret_xy=True, pixel_tol=0, ret_basin=False,
    ...
    Args:
        pts1: The pts1.
        pts2: The pts2.
        subsample_or_initxy1: The subsample or initxy1.
        ret_xy: The ret xy.
        pixel_tol: The pixel tol.
        ret_basin: The ret basin.
        device: The device.
    """
...
def extract_correspondences_nonsym(A, B, confA, confB, subsample=8, device=None, ptmap_key='pred_desc', pixel_tol=0):
    """Extract correspondences nonsym.
