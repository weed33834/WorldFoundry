...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> mast3r -> mast3r -> cloud_opt -> sparse_ga.py functionality."""
...
from worldfoundry.base_models.three_dimensions.general_3d.dust3r.dust3r.viz.scene3d_dust import SceneViz


class SparseGA():
    """Sparse ga implementation."""
    def __init__(self, img_paths, pairs_in, res_fine, anchors, canonical_paths=None):
        """Init.

        Args:
            img_paths: The img paths.
            pairs_in: The pairs in.
            res_fine: The res fine.
            anchors: The anchors.
            canonical_paths: The canonical paths.
        """
        def fetch_img(im):
            """Fetch img.
...
def sparse_scene_optimizer(imgs, subsample, imsizes, pps, base_focals, core_depth, anchors, corres, corres2d,
    ...
    Args:
        ...
        imsizes: The imsizes.
        pps: The pps.
        base_focals: The base focals.
        core_depth: The core depth.
        anchors: The anchors.
        corres: The corres.
        corres2d: The corres2d.
        preds_21: The preds 21.
        canonical_paths: The canonical paths.
        mst: The mst.
        ...
        lossd: The lossd.
        opt_pp: The opt pp.
        opt_depth: The opt depth.
        schedule: The schedule.
        depth_mode: The depth mode.
        exp_depth: The exp depth.
        lora_depth: The lora depth.
        shared_intrinsics: The shared intrinsics.
        init: The init.
        device: The device.
        dtype: The dtype.
        matching_conf_thr: The matching conf thr.
        loss_dust3r_w: The loss dust3r w.
        verbose: The verbose.
        dbg: The dbg.
    """
    ...
    def make_K_cam_depth(log_focals, pps, trans, quats, log_sizes, core_depth):
        ...
        Args:
            log_focals: The log focals.
            pps: The pps.
            trans: The trans.
            quats: The quats.
            log_sizes: The log sizes.
            core_depth: The core depth.
        """
        # make intrinsics
...
def make_pts3d(anchors, K, cam2w, depthmaps, base_focals=None, ret_depth=False):
    ...
    Args:
        ...
        K: The k.
        cam2w: The cam2w.
        depthmaps: The depthmaps.
        base_focals: The base focals.
        ret_depth: The ret depth.
    """
    focals = K[:, 0, 0]
    invK = inv(K)
    all_pts3d = []
...
def prepare_canonical_data(imgs, tmp_pairs, subsample, order_imgs=False, min_conf_thr=0,
    ...
    Args:
        imgs: The imgs.
        tmp_pairs: The tmp pairs.
        subsample: The subsample.
        order_imgs: The order imgs.
...
def condense_data(imgs, tmp_paths, canonical_views, preds_21, dtype=torch.float32):
    ...
    Args:
        imgs: The imgs.
        tmp_paths: The tmp paths.
        canonical_views: The canonical views.
        preds_21: The preds 21.
        dtype: The dtype.
    """
...
def anchor_depth_offsets(canon_depth, pixels, subsample=8):
    """Anchor depth offsets.

    Args:
        canon_depth: The canon depth.
        pixels: The pixels.
        subsample: The subsample.
    """
...
def spectral_clustering(graph, k=None, normalized_cuts=False):
    ...
    Args:
        graph: The graph.
        k: The k.
        normalized_cuts: The normalized cuts.
    """
...
def lora_encode_normed(lora_proj, x, min_norm, global_norm=False):
    ...
    Args:
        lora_proj: The lora proj.
        x: The x.
        min_norm: The min norm.
        global_norm: The global norm.
    """
    # encode the pointmap
...
def spectral_projection_of_depthmaps(imgs, intrinsics, depthmaps, subsample, cache_path=None, **kw):
    """Spectral projection of depthmaps.
...
def show_reconstruction(shapes_or_imgs, K, cam2w, pts3d, gt_cam2w=None, gt_K=None, cam_size=None, masks=None, **kw):
    ...
    Args:
        shapes_or_imgs: The shapes or imgs.
        K: The k.
        cam2w: The cam2w.
        pts3d: The pts3d.
        gt_cam2w: The gt cam2w.
        gt_K: The gt k.
