...
"""Module for base_models -> three_dimensions -> general_3d -> mast3r -> mast3r -> cloud_opt -> triangulation.py functionality."""
...
def matches_to_depths(intrinsics, # input camera intrinsics     [B, Ncams, 3, 3]
    ...
    Args:
        ...
        min_num_valids_ratio: The min num valids ratio.
    """
