...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> mast3r -> mast3r -> utils -> coarse_to_fine.py functionality."""
...
def _start_pos(total_size, win_size, overlap):
    """Helper function to start pos.

    Args:
        total_size: The total size.
        win_size: The win size.
        overlap: The overlap.
    """
...
def _make_overlapping_grid(H, W, size, overlap):
    """Helper function to make overlapping grid.
...
def _norm_windows(cell2, H2, W2, forced_resolution=None):
    """Helper function to norm windows.

    Args:
        cell2: The cell2.
        H2: The h2.
        W2: The w2.
        forced_resolution: The forced resolution.
    """
...
def _weight_pixels(cell, pix, assigned, gauss_var=2):
    """Helper function to weight pixels.

    Args:
        cell: The cell.
        pix: The pix.
        assigned: The assigned.
        gauss_var: The gauss var.
    """
...
def greedy_selection(corres_weights, target=0.9):
    ...
    Args:
        corres_weights: The corres weights.
        target: The target.
    """
...
def select_pairs_of_crops(img_q, img_b, pos2d_in_query, pos2d_in_ref, maxdim=512, overlap=.5, forced_resolution=None):
    """Select pairs of crops.

    Args:
        img_q: The img q.
        img_b: The img b.
        pos2d_in_query: The pos2d in query.
        pos2d_in_ref: The pos2d in ref.
        maxdim: The maxdim.
        overlap: The overlap.
        forced_resolution: The forced resolution.
    """
