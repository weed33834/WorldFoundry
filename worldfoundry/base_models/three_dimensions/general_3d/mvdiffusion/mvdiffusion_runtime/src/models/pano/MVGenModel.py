"""Module for base_models -> three_dimensions -> general_3d -> mvdiffusion -> mvdiffusion_runtime -> src -> models -> pano -> MVGenModel.py functionality."""
...
class MultiViewBaseModel(nn.Module):
    """Multi view base model implementation."""
