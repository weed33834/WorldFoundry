"""Module for base_models -> three_dimensions -> general_3d -> shape_of_motion -> shape_of_motion_runtime -> flow3d -> renderer.py functionality."""
...
class Renderer:
    ...
    def __init__(
        ...
        self.viewer = None
        if port is not None:
            if DynamicViewer is None:
                raise RuntimeError("Shape-of-Motion interactive viewer requires nerfview/viser; omit port for non-interactive inference.")
