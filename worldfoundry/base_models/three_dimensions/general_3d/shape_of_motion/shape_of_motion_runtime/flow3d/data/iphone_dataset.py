"""Module for base_models -> three_dimensions -> general_3d -> shape_of_motion -> shape_of_motion_runtime -> flow3d -> data -> iphone_dataset.py functionality."""
...
class iPhoneDataConfig:
    """I phone data config implementation."""
    data_dir: str
    start: int = 0
    end: int = -1
...
class iPhoneDataset(BaseDataset):
    """I phone dataset implementation."""
    def __init__(
        self,
        data_dir: str,
        start: int = 0,
