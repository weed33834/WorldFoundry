"""Module for base_models -> three_dimensions -> general_3d -> shape_of_motion -> shape_of_motion_runtime -> flow3d -> data -> nvidia_dataset.py functionality."""
...
class NvidiaDataConfig:
    """Nvidia data config implementation."""
    data_dir: str
    start: int = 0
    end: int = -1
