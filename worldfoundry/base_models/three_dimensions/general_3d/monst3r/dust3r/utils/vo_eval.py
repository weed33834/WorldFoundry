"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> vo_eval.py functionality."""
...
def load_timestamps(time_file, traj_format="replica"):
    ...
    Args:
        time_file: The time file.
        traj_format: The traj format.
    """
...
def plot_trajectory(
    ...
    Args:
        ...
        filename: The filename.
        align: The align.
        correct_scale: The correct scale.
    """
    pred_traj = make_traj(pred_traj)
