"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> po_utils -> improc.py functionality."""
...
def _generic_transform_sk_3d(transform, in_type='', out_type=''):
    """Helper function to generic transform sk 3d.

    Args:
        transform: The transform.
        in_type: The in type.
        out_type: The out type.
    """
    def apply_transform_individual(input_):
        """Apply transform individual.
...
def back2color(i, blacken_zeros=False):
    ...
    Args:
        i: The i.
        blacken_zeros: The blacken zeros.
    """
    if blacken_zeros:
...
def convert_occ_to_height(occ, reduce_axis=3):
    """Convert occ to height.

    Args:
        occ: The occ.
        reduce_axis: The reduce axis.
    """
...
class Summ_writer(object):
    ...
    def __init__(self, writer, global_step, log_freq=10, fps=8, scalar_freq=100, just_gif=False):
        ...
        Args:
            ...
            log_freq: The log freq.
            fps: The fps.
            scalar_freq: The scalar freq.
            just_gif: The just gif.
        """
        self.writer = writer
    ...
    def summ_traj2ds_on_rgbs_py(self, name, trajs, rgbs_color, valids=None, frame_ids=None, only_return=False, show_dots=False, cmap='coolwarm', vals=None, linewidth=1):
        """Summ traj2ds on rgbs py.

        Args:
            name: The name.
            trajs: The trajs.
            rgbs_color: The rgbs color.
            valids: The valids.
            frame_ids: The frame ids.
            only_return: The only return.
            show_dots: The show dots.
    ...
    def summ_traj2ds_on_rgbs2(self, name, trajs, visibles, rgbs, valids=None, frame_ids=None, only_return=False, show_dots=True, cmap=None, linewidth=1):
        """Summ traj2ds on rgbs2.

        Args:
            name: The name.
            trajs: The trajs.
            visibles: The visibles.
            rgbs: The rgbs.
            valids: The valids.
            frame_ids: The frame ids.
            only_return: The only return.
