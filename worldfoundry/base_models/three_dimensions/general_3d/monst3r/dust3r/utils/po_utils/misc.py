"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> po_utils -> misc.py functionality."""
...
class SimplePool():
    ...
    def sample(self, with_replacement=True):
        ...
        Args:
            with_replacement: The with replacement.
        """
