"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> po_utils -> basic.py functionality."""
...
def reduce_masked_median(x, mask, keep_batch=False):
    """Reduce masked median.

    Args:
        x: The x.
        mask: The mask.
        keep_batch: The keep batch.
    """
...
def normalize_grid2d(grid_y, grid_x, Y, X, clamp_extreme=True):
    ...
    Args:
        ...
        Y: The y.
        X: The x.
        clamp_extreme: The clamp extreme.
    """
    # make things in [-1,1]
