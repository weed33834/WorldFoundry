"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> po_utils -> geom.py functionality."""

import torch
import dust3r.utils.po_utils.basic
import numpy as np
import torchvision.ops as ops
from dust3r.utils.po_utils.basic import print_
...
def get_camM_T_camXs(origin_T_camXs, ind=0):
    ...
    Args:
        origin_T_camXs: The origin t camxs.
        ind: The ind.
    """
...
def crop_and_resize(im, boxlist, PH, PW, boxlist_is_normalized=False):
    ...
    Args:
        ...
        PH: The ph.
        PW: The pw.
        boxlist_is_normalized: The boxlist is normalized.
    """
    B, C, H, W = im.shape
...
def get_boxlist_from_centroid_and_size(cy, cx, h, w):#, clip=False):
    """Get boxlist from centroid and size.
...
def convert_box2d_to_intrinsics(box2d, pix_T_cam, H, W, use_image_aspect_ratio=True, mult_padding=1.0):
    ...
    Args:
        ...
        H: The h.
        W: The w.
        use_image_aspect_ratio: The use image aspect ratio.
        mult_padding: The mult padding.
    """
