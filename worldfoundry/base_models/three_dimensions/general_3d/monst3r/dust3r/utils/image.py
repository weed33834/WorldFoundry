...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> image.py functionality."""
...
def load_prev_video_results(prev_output_dir, num_frames, index=None):
    """Load prev video results.

    Args:
        prev_output_dir: The prev output dir.
...
def get_overlaied_gif(folder, img_format="frame_*.png", mask_format="dynamic_mask_*.png", output_path="_overlaied.gif"):
    ...
    Args:
        folder: The folder.
        img_format: The img format.
        mask_format: The mask format.
