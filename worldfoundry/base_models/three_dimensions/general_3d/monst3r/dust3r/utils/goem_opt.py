"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> utils -> goem_opt.py functionality."""
...
def depth_regularization_si_weighted(depth_pred, depth_init, pixel_wise_weight=None, pixel_wise_weight_scale=1, pixel_wise_weight_bias=1, eps=1e-6, pixel_weight_normalize=False):
    """Depth regularization si weighted.

    Args:
        depth_pred: The depth pred.
        depth_init: The depth init.
        pixel_wise_weight: The pixel wise weight.
        pixel_wise_weight_scale: The pixel wise weight scale.
        pixel_wise_weight_bias: The pixel wise weight bias.
        eps: The eps.
        pixel_weight_normalize: The pixel weight normalize.
    """
    # scale compute:
...
class WarpImage(torch.nn.Module):
    ...
    def warp_image(self, base_coord, img_1, flow_2_1):
        ...
        Args:
            base_coord: The base coord.
            img_1: The img 1.
            flow_2_1: The flow 2 1.
        """
...
class CameraIntrinsics(nn.Module):
    """Camera intrinsics implementation."""
    def __init__(self, init_focal_length=0.45, pixel_size=None):
        """Init.

        Args:
            init_focal_length: The init focal length.
    ...
    def register_shape(self, orig_shape, opt_shape) -> None:
        ...
        Args:
            orig_shape: The orig shape.
            opt_shape: The opt shape.
    ...
    def get_K_and_inv(self, with_batch_dim=True) -> torch.Tensor:
        ...
        Args:
            with_batch_dim: The with batch dim.
...
def warp_by_disp(src_R, src_t, tgt_R, tgt_t, K, src_disp, coord, inv_K, debug_mode=False, use_depth=False):
    ...
    Args:
        ...
        tgt_t: The tgt t.
        K: The k.
        src_disp: The src disp.
        coord: The coord.
        inv_K: The inv k.
        debug_mode: The debug mode.
        use_depth: The use depth.
    """
...
class CameraPoseDeltaCollection(torch.nn.Module):
    """Camera pose delta collection implementation."""
    ...
    def forward(self, list_of_index):
        ...
        Args:
            list_of_index: The list of index.
        """
        se_3 = []
        t_out = []
...
class DepthBasedWarping(nn.Module):
    """Depth based warping implementation."""
    # tested
    ...
    def reproject_depth(self, src_R, src_t, src_disp, tgt_R, tgt_t, tgt_disp, K_src, K_inv_src, K_trg, K_inv_trg, eps=1e-6, check_shape=False):
        ...
        Args:
            ...
            tgt_R: The tgt r.
            tgt_t: The tgt t.
            tgt_disp: The tgt disp.
            K_src: The k src.
            K_inv_src: The k inv src.
            K_trg: The k trg.
            K_inv_trg: The k inv trg.
            eps: The eps.
            check_shape: The check shape.
        """
        if check_shape:
            check_R_shape(src_R)
            check_R_shape(tgt_R)
