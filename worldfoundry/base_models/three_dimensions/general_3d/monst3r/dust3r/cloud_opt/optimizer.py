"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> cloud_opt -> optimizer.py functionality."""
...
sam2_checkpoint = os.environ.get("WORLDFOUNDRY_MONST3R_SAM2_CHECKPOINT") or str(sam2_checkpoint_path())
model_cfg = os.environ.get("WORLDFOUNDRY_MONST3R_SAM2_CONFIG") or sam2_config_name()
...
class PointCloudOptimizer(BasePCOptimizer):
    ...
    def get_flow(self, sintel_ckpt=False): #TODO: test with gt flow
        ...
        flow_model_path = os.environ.get(
            "WORLDFOUNDRY_MONST3R_FLOW_RAFT_MODEL",
            "third_party/RAFT/models/Tartan-C-T-TSKH-spring540x960-M.pth",
        )
        flow_net = load_RAFT() if sintel_ckpt else load_RAFT(flow_model_path)
