...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> dust3r -> cloud_opt -> init_im_poses.py functionality."""
...
def draw_edge_scores_map(edge_scores, save_path, n_imgs=None):
    """Draw edge scores map.

    Args:
        edge_scores: The edge scores.
...
def init_pts3d_poses_from_previous_result(prev_pts3d, prev_im_poses, im_focals, imshapes, edges, pred_i, pred_j, conf_i, conf_j,
    ...
    """Init pts3d poses from previous result.

    Args:
        prev_pts3d: The prev pts3d.
        prev_im_poses: The prev im poses.
        im_focals: The im focals.
        imshapes: The imshapes.
        edges: The edges.
        pred_i: The pred i.
