"""Module for base_models -> three_dimensions -> general_3d -> monst3r -> third_party -> RAFT -> core -> update.py functionality."""
...
class SmallMotionEncoder(nn.Module):
    """Small motion encoder implementation."""
...
class BasicMotionEncoder(nn.Module):
    """Basic motion encoder implementation."""
    def __init__(self, args):
        """Init.
...
class SmallUpdateBlock(nn.Module):
    """Small update block implementation."""
...
class BasicUpdateBlock(nn.Module):
    """Basic update block implementation."""
