...
"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> third_party -> dust3r -> croco -> models -> croco_downstream.py functionality."""
...
class CroCoDownstreamMonocularEncoder(CroCoNet):
    """Cro co downstream monocular encoder implementation."""
...
class CroCoDownstreamBinocular(CroCoNet):
    """Cro co downstream binocular implementation."""
    def __init__(self, head, **kwargs):
