...
"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> third_party -> dust3r -> croco -> utils -> misc.py functionality."""
...
class NativeScalerWithGradNormCount:
    """Native scaler with grad norm count implementation."""
    ...
    def __call__(
        ...
        Args:
            ...
            clip_grad: The clip grad.
            parameters: The parameters.
            create_graph: The create graph.
            update_grad: The update grad.
        """
...
def save_model(
    ...
    Args:
        args: The args.
        epoch: The epoch.
        model_without_ddp: The model without ddp.
        optimizer: The optimizer.
        loss_scaler: The loss scaler.
        fname: The fname.
        best_so_far: The best so far.
    """
...
def _get_num_layer_for_vit(var_name, enc_depth, dec_depth):
    """Helper function to get num layer for vit.
...
def get_parameter_groups(
    ...
    Args:
        ...
        layer_decay: The layer decay.
        skip_list: The skip list.
        no_lr_scale_list: The no lr scale list.
    """
