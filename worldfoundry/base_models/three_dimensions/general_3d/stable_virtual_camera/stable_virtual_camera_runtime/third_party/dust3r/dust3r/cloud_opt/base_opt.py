...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> third_party -> dust3r -> dust3r -> cloud_opt -> base_opt.py functionality."""
...
class BasePCOptimizer(nn.Module):
    ...
    def _init_from_views(
        ...
        Args:
            ...
            iterationsCount: The iterationscount.
            same_focals: The same focals.
            verbose: The verbose.
        """
        super().__init__()
