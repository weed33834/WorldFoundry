...
# --------------------------------------------------------
"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> third_party -> dust3r -> dust3r -> cloud_opt -> __init__.py functionality."""
...
class GlobalAlignerMode(Enum):
    """Global aligner mode implementation."""
...
def global_aligner(
    ...
    Args:
        dust3r_output: The dust3r output.
        device: The device.
        mode: The mode.
    """
    # extract all inputs
