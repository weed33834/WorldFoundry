"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> seva -> modules -> layers.py functionality."""
...
class TimestepEmbedSequential(nn.Sequential):
    """Timestep embed sequential implementation."""
...
class ResBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            out_channels: The out channels.
            dense_in_channels: The dense in channels.
            dropout: The dropout.
        """
        super().__init__()
