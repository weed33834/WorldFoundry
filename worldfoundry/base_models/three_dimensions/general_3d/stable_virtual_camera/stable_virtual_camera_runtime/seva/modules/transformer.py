"""Module for base_models -> three_dimensions -> general_3d -> stable_virtual_camera -> stable_virtual_camera_runtime -> seva -> modules -> transformer.py functionality."""
...
class TransformerBlockTimeMix(nn.Module):
    """Transformer block time mix implementation."""
    def __init__(
        self,
        dim: int,
        n_heads: int,
...
class SkipConnect(nn.Module):
    ...
    def forward(
        ...
        Args:
            x_spatial: The x spatial.
            x_temporal: The x temporal.
...
class MultiviewTransformer(nn.Module):
    """Multiview transformer implementation."""
    def __init__(
        self,
        in_channels: int,
        n_heads: int,
        ...
        Args:
            ...
            d_head: The d head.
            name: The name.
            unflatten_names: The unflatten names.
            depth: The depth.
            context_dim: The context dim.
            dropout: The dropout.
        """
