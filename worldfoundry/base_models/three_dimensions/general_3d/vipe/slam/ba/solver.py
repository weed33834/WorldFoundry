...
"""Module for base_models -> three_dimensions -> general_3d -> vipe -> slam -> ba -> solver.py functionality."""
...
class Solver:
    ...
    def _warn_if_no_terms(self, group_name: str):
        """Helper function to warn if no terms.
