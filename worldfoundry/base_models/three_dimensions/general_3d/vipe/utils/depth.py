...
"""Module for base_models -> three_dimensions -> general_3d -> vipe -> utils -> depth.py functionality."""
...
def normal_weight_from_xyz(xyz: torch.Tensor, robust: bool = True) -> torch.Tensor:
    ...
    from worldfoundry.base_models.three_dimensions.general_3d.vipe.ext import _C
...
def bilinear_splatting_inplace(
    ...
    """Bilinear splatting inplace.

    Args:
        data: The data.
        uv: The uv.
        out_data: The out data.
        out_weight: The out weight.
    """
