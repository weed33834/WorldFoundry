"""Module for base_models -> three_dimensions -> point_clouds -> pi3 -> pi3 -> models -> pi3x.py functionality."""
...
class Pi3X(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        Args:
            ckpt: The ckpt.
            use_multimodal: The use multimodal.
        """
        super().__init__()
    ...
    def encode(
        ...
        Args:
            imgs: The imgs.
            with_prior: The with prior.
            depths: The depths.
            rays: The rays.
            intrinsics: The intrinsics.
            poses: The poses.
            mask_add_depth: The mask add depth.
            mask_add_ray: The mask add ray.
            mask_add_pose: The mask add pose.
        """
        B, N, _, H, W = imgs.shape
        device = imgs.device
    ...
    def _chunked_conv_head(self, head, feat, patch_h, patch_w, chunk_size=64):
        """Helper function to chunked conv head.
    ...
    def decode(self, hidden, N, H, W, poses, use_pose_mask):
        ...
        Args:
            ...
            W: The w.
            poses: The poses.
            use_pose_mask: The use pose mask.
        """
        device = hidden.device
