...
"""Module for base_models -> three_dimensions -> point_clouds -> pi3 -> pi3 -> models -> layers -> block.py functionality."""
...
class CrossBlockRope(nn.Module):
    """Cross block rope implementation."""
    def __init__(
        self,
        dim: int,
        num_heads: int,
...
class PoseInjectBlock(nn.Module):
    """Pose inject block implementation."""
    def __init__(
        self,
        dim: int,
        num_heads: int,
...
class CrossOnlyBlockRope(nn.Module):
    """Cross only block rope implementation."""
    def __init__(
        self,
        dim: int,
        num_heads: int,
