"""Module for base_models -> three_dimensions -> point_clouds -> pi3 -> pi3 -> pipe -> pi3x_vo.py functionality."""
...
class Pi3XVO:
    ...
    def _compute_sim3_umeyama_masked(self, src_points, tgt_points, src_mask, tgt_mask):
        """Helper function to compute sim3 umeyama masked.

        Args:
            src_points: The src points.
            tgt_points: The tgt points.
    ...
    def _apply_sim3_to_points(self, points, sim3):
        """Helper function to apply sim3 to points.
