"""Module for base_models -> three_dimensions -> point_clouds -> pi3 -> pi3 -> utils -> geometry.py functionality."""
...
def get_gt_warp(depth1, depth2, T_1to2, K1, K2, depth_interpolation_mode = 'bilinear', relative_depth_error_threshold = 0.05, H = None, W = None):
    ...
    Args:
        ...
        K1: The k1.
        K2: The k2.
        depth_interpolation_mode: The depth interpolation mode.
        relative_depth_error_threshold: The relative depth error threshold.
        H: The h.
        W: The w.
    """
...
def recover_intrinsic_from_rays_d(
    ...
    """Recover intrinsic from rays d.

    Args:
        rays_d: The rays d.
        ndc_coords: The ndc coords.
        force_center_principal_point: The force center principal point.
    """
