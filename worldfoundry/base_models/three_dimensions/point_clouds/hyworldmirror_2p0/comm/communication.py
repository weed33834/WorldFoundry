"""Module for base_models -> three_dimensions -> point_clouds -> hyworldmirror_2p0 -> comm -> communication.py functionality."""
...
def all2all(tensor, scatter_dim, gather_dim, cur_group, async_op):
    ...
    Args:
        ...
        cur_group: The cur group.
        async_op: The async op.
    """
