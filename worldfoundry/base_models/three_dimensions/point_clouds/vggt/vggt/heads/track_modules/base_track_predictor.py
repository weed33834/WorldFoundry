...
"""Module for base_models -> three_dimensions -> point_clouds -> vggt -> vggt -> heads -> track_modules -> base_track_predictor.py functionality."""
...
class BaseTrackerPredictor(nn.Module):
    """Base tracker predictor implementation."""
    def __init__(
        self,
        stride=1,
        corr_levels=5,
        ...
        Args:
            stride: The stride.
            corr_levels: The corr levels.
            corr_radius: The corr radius.
            latent_dim: The latent dim.
            hidden_size: The hidden size.
            use_spaceatt: The use spaceatt.
            depth: The depth.
            max_scale: The max scale.
            predict_conf: The predict conf.
        """
