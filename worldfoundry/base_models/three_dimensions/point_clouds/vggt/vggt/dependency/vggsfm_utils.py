...
"""Module for base_models -> three_dimensions -> point_clouds -> vggt -> vggt -> dependency -> vggsfm_utils.py functionality."""
...
_VGGSFM_TRACKER_URL = "https://huggingface.co/facebook/VGGSfM/resolve/main/vggsfm_v2_tracker.pt"
...
def build_vggsfm_tracker(model_path=None):
    ...
    if model_path is None:
        tracker.load_state_dict(torch.hub.load_state_dict_from_url(_VGGSFM_TRACKER_URL))
    else:
