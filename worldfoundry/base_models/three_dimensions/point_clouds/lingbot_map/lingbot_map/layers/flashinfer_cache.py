...
class FlashInferKVCacheManager:
    ...
    def __init__(
        ...
        Args:
            ...
            max_num_frames: The max num frames.
            tokens_per_frame: The tokens per frame.
            num_heads: The num heads.
            head_dim: The head dim.
            dtype: The dtype.
            device: The device.
            num_special_tokens: The num special tokens.
            scale_frames: The scale frames.
            sliding_window: The sliding window.
            max_total_frames: The max total frames.
            force_fp32: The force fp32.
            fa3: The fa3.
        """
        ...
        # instead gather paged K/V into a dense tensor and use _worldfoundry_scaled_dot_product_attention
    ...
    def _gather_kv(self, block_idx: int):
        ...
        supports fp16/bf16) and instead run _worldfoundry_scaled_dot_product_attention in fp32.
    ...
    def compute_attention(self, block_idx: int, q: Tensor) -> Tensor:
        ...
        and uses _worldfoundry_scaled_dot_product_attention in fp32 instead of the FA2 kernel.
