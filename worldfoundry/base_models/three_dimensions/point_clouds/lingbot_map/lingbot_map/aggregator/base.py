...
class AggregatorBase(nn.Module, ABC):
    ...
    def __init__(
        ...
        Args:
            ...
            use_reentrant: The use reentrant.
    ...
    def _build_patch_embed(
        ...
        if "conv" in patch_embed:
            ...
            # The released LingBot-Map checkpoint contains the final model
            # weights. Loading a separate DINOv2 patch-embed checkpoint is
            # optional and should only happen when the caller provides one.
            if pretrained_path:
                try:
