"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_runtime -> worldfoundry_runtime.py functionality."""
...
class PixelSplatRuntime:
    ...
    def _runtime_root() -> Path:
        ...
        Returns:
            The return value.
        """
        return package_root("worldfoundry.base_models.three_dimensions.point_clouds.pixelsplat_runtime")
    ...
    def _base_source_root() -> Path:
        ...
        Returns:
            The return value.
        """
        return Path(__file__).resolve().parents[1] / "pixelsplat_full"
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        command = [python, "-m", "src.main", *overrides]
