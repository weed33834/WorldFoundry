"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> model_wrapper.py functionality."""
...
from worldfoundry.base_models.three_dimensions.point_clouds.pixelsplat_full.src.misc.image_io import save_image
from ..misc.LocalLogger import LOG_PATH, LocalLogger
from ..misc.step_tracker import StepTracker
from .decoder.decoder import Decoder, DepthRenderingMode
from .encoder import Encoder

EncoderVisualizer = object


@dataclass
class OptimizerCfg:
    """Optimizer cfg implementation."""
    lr: float
    warm_up_steps: int
...
class ModelWrapper(LightningModule):
    ...
    def __init__(
        ...
        Args:
            optimizer_cfg: The optimizer cfg.
            test_cfg: The test cfg.
            train_cfg: The train cfg.
            encoder: The encoder.
            encoder_visualizer: The encoder visualizer.
            decoder: The decoder.
            losses: The losses.
    ...
    def validation_step(self, batch, batch_idx):
        ...
        Args:
            ...
            batch_idx: The batch idx.
        """
        from worldfoundry.base_models.three_dimensions.point_clouds.pixelsplat_full.src.misc.image_io import prep_image
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.annotation import add_label
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.layout import add_border, hcat, vcat
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.validation_in_3d import render_cameras, render_projections
    ...
    def render_video_wobble(self, batch: BatchedExample) -> None:
        ...
        Returns:
            The return value.
        """
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.camera_trajectory.wobble import (
            generate_wobble,
        )
    ...
    def render_video_interpolation(self, batch: BatchedExample) -> None:
        ...
        Returns:
            The return value.
        """
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.camera_trajectory.interpolation import (
    ...
    def render_video_interpolation_exaggerated(self, batch: BatchedExample) -> None:
        """Render video interpolation exaggerated.
    ...
    def render_video_generic(
        ...
        """Render video generic.

        Args:
            batch: The batch.
            trajectory_fn: The trajectory fn.
            name: The name.
            num_frames: The num frames.
            smooth: The smooth.
            loop_reverse: The loop reverse.
        ...
        from worldfoundry.base_models.three_dimensions.point_clouds.pixelsplat_full.src.misc.image_io import prep_image
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.annotation import add_label
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.color_map import apply_color_map_to_image
        from worldfoundry.studio.visualization.plugins.scene3d.pixelsplat_full.visualization.layout import add_border, hcat, vcat
