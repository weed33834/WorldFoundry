"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> epipolar -> epipolar_sampler.py functionality."""
...
class EpipolarSampling:
    """Epipolar sampling implementation."""
...
class EpipolarSampler(nn.Module):
    """Epipolar sampler implementation."""
    num_samples: int
    index_v: Index
    transpose_v: Index
    transpose_ov: Index
