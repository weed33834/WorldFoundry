"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> epipolar -> image_self_attention.py functionality."""
...
class ImageSelfAttentionCfg:
    """Image self attention cfg implementation."""
    patch_size: int
    num_octaves: int
    num_layers: int
    num_heads: int
...
class ImageSelfAttention(nn.Module):
    """Image self attention implementation."""
