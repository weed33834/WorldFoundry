"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> common -> gaussian_adapter.py functionality."""
...
from worldfoundry.base_models.three_dimensions.point_clouds.pixelsplat_full.src.misc.sh_rotation import rotate_sh
