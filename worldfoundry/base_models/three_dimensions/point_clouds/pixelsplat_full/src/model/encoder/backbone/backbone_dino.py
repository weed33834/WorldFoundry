"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> backbone -> backbone_dino.py functionality."""
...
class BackboneDino(Backbone[BackboneDinoCfg]):
    ...
    def __init__(self, cfg: BackboneDinoCfg, d_in: int) -> None:
        ...
        self.dino = torch.hub.load(str(dino_hub), cfg.model, source="local", pretrained=False)
