"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> epipolar -> distribution.py functionality."""
...
class Distribution(nn.Module):
    ...
    def forward(
        ...
        Args:
            queries: The queries.
            keys: The keys.
            force_last_token: The force last token.
