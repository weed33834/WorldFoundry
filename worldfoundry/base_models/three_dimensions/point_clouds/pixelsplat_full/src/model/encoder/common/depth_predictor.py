"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> model -> encoder -> common -> depth_predictor.py functionality."""
...
class DepthPredictor(nn.Module):
    """Depth predictor implementation."""
