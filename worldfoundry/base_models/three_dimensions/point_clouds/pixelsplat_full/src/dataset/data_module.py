"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> dataset -> data_module.py functionality."""
...
class DataLoaderStageCfg:
    """Data loader stage cfg implementation."""
    batch_size: int
    num_workers: int
...
@dataclass
class DataLoaderCfg:
    """Data loader cfg implementation."""
...
class DataModule(LightningDataModule):
    ...
    def __init__(
        ...
        Args:
            ...
            data_loader_cfg: The data loader cfg.
            step_tracker: The step tracker.
            dataset_shim: The dataset shim.
