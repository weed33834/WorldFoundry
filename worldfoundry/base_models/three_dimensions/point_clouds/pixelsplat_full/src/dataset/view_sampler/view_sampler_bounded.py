"""Module for base_models -> three_dimensions -> point_clouds -> pixelsplat_full -> src -> dataset -> view_sampler -> view_sampler_bounded.py functionality."""
...
class ViewSamplerBoundedCfg:
    """View sampler bounded cfg implementation."""
...
class ViewSamplerBounded(ViewSampler[ViewSamplerBoundedCfg]):
    """View sampler bounded implementation."""
