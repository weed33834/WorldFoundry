"""Module for base_models -> three_dimensions -> point_clouds -> cut3r -> inference.py functionality."""
...
def merge_chunk_dict(old_dict, curr_dict, add_number):
    ...
    Args:
        old_dict: The old dict.
        curr_dict: The curr dict.
        add_number: The add number.
    """
    new_dict = {}
...
def _interleave_imgs(img1, img2):
    """Helper function to interleave imgs.
...
def loss_of_one_batch(
    ...
    Args:
        ...
        symmetrize_batch: The symmetrize batch.
        use_amp: The use amp.
        ret: The ret.
