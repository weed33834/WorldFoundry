...
"""Module for base_models -> three_dimensions -> point_clouds -> cut3r -> pos_embed.py functionality."""
...
try:
    from worldfoundry.base_models.three_dimensions.general_3d.dust3r.croco.models.curope import cuRoPE2D
