"""Module for base_models -> three_dimensions -> depth -> midas -> backbones -> utils.py functionality."""
...
class ProjectReadout(nn.Module):
    """Project readout implementation."""
