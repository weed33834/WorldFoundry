"""Module for base_models -> three_dimensions -> depth -> moge -> model -> v2.py functionality."""
    ...
    def __init__(self, 
        ...
        **deprecated_kwargs
        ...
        Args:
            encoder: The encoder.
            neck: The neck.
            points_head: The points head.
            mask_head: The mask head.
            normal_head: The normal head.
            scale_head: The scale head.
