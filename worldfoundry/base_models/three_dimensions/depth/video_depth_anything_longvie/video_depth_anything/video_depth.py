...
"""Module for base_models -> three_dimensions -> depth -> video_depth_anything_longvie -> video_depth_anything -> video_depth.py functionality."""
...
from worldfoundry.base_models.three_dimensions.depth.depth_anything.depth_anything_v2.util.transform import Resize, NormalizeImage, PrepareForNet

from models.vda.utils.util import compute_scale_and_shift, get_interpolate_frames
...
class VideoDepthAnything(nn.Module):
    """Video depth anything implementation."""
    def __init__(
        self,
        encoder='vitl',
        features=256, 
    ...
    def infer_video_depth(self, frames, target_fps, input_size=518, device='cuda'):
        ...
        pre_input = None
        # resize_height = 540
        # resize_width = int(540/frame_height*frame_width)
