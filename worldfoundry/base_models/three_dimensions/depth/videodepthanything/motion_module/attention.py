...
"""Module for base_models -> three_dimensions -> depth -> videodepthanything -> motion_module -> attention.py functionality."""
...
from worldfoundry.base_models.three_dimensions.general_3d.vipe.ext.xformers import memory_efficient_attention
...
class CrossAttention(nn.Module):
    ...
    def _sliced_attention(self, query, key, value, sequence_length, dim, attention_mask):
        """Helper function to sliced attention.
    ...
    def _memory_efficient_attention_xformers(self, query, key, value, attention_mask):
        """Helper function to memory efficient attention xformers.
    ...
    def _memory_efficient_attention_split(self, query, key, value, attention_mask):
        """Helper function to memory efficient attention split.
