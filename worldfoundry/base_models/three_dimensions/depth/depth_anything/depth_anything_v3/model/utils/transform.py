...
"""Module for base_models -> three_dimensions -> depth -> depth_anything -> depth_anything_v3 -> model -> utils -> transform.py functionality."""
...
def cam_quat_xyzw_to_world_quat_wxyz(cam_quat_xyzw, c2w):
    """Cam quat xyzw to world quat wxyz.

    Args:
        cam_quat_xyzw: The cam quat xyzw.
        c2w: The c2w.
    """
