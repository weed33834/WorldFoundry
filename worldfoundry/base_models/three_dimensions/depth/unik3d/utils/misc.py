"""Module for base_models -> three_dimensions -> depth -> unik3d -> utils -> misc.py functionality."""
...
def get_num_layer_for_swin(var_name, num_max_layer, layers_per_stage):
    """Get num layer for swin.

    Args:
        var_name: The var name.
        num_max_layer: The num max layer.
        layers_per_stage: The layers per stage.
    """
...
def load_checkpoint_swin(model, checkpoint_model):
    """Load checkpoint swin.

    Args:
        model: The model.
        checkpoint_model: The checkpoint model.
    """
...
class ProfileMethod:
    ...
    def __init__(self, model, func_name, track_statistics=True, verbose=False):
        ...
        Args:
            ...
            track_statistics: The track statistics.
            verbose: The verbose.
        """
        self.model = model
...
class ProfileFunction:
    """Profile function implementation."""
