"""Module for base_models -> llm_mllm_core -> mllm -> open_flamingo -> src -> flamingo_lm.py functionality."""
...
class FlamingoLayer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            gated_cross_attn_layer: The gated cross attn layer.
    ...
    def condition_media_locations(self, media_locations):
        """Condition media locations.

        Args:
            media_locations: The media locations.
        """
        self.media_locations = media_locations

    def condition_use_cached_media(self, use_cached_media):
        """Condition use cached media.

        Args:
            use_cached_media: The use cached media.
        """
...
class FlamingoLMMixin(nn.Module):
    ...
    def set_decoder_layers_attr_name(self, decoder_layers_attr_name):
        """Set decoder layers attr name.

        Args:
            decoder_layers_attr_name: The decoder layers attr name.
        """
        self.decoder_layers_attr_name = decoder_layers_attr_name

    def _get_decoder_layers(self):
        """Helper function to get decoder layers."""
        return getattr_recursive(self, self.decoder_layers_attr_name)

    def _set_decoder_layers(self, value):
        """Helper function to set decoder layers.
