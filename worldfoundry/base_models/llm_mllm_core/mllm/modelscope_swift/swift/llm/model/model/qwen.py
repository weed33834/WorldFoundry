...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import TemplateType
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_device_count, get_dist_setting, get_env_args, get_logger
...
def patch_qwen_vl_utils(vision_process):
    ...
    def _new_read_video_decord(ele: dict):
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import load_file
