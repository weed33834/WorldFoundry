...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_dist_setting, get_env_args, get_logger, use_torchacc
...
class Template(ProcessorMixin):
    ...
    def __init__(
        ...
        *,
        ...
        """
        from .template_meta import TemplateMeta
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.plugin import agent_templates, loss_scale_map
    ...
    def pre_forward_hook(self, model: nn.Module, args, kwargs):
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import to_device
    ...
    def fetch_inputs(batch: List[Dict[str, Any]], keys: Optional[List[str]] = None) -> Dict[str, Any]:
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import RowPreprocessor
        keys = keys or []
    ...
    def _torchacc_xtuner_data_collator(self, res, padding_to, tokenizer, padding_side):
        ...
        if use_torchacc():
            from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils.torchacc_utils import pad_and_split_batch
