...
_TEMPLATES_IMPORTED = False


def _ensure_templates_registered() -> None:
    global _TEMPLATES_IMPORTED
    if _TEMPLATES_IMPORTED:
        return
    importlib.import_module(".template", __package__)

    _TEMPLATES_IMPORTED = True
