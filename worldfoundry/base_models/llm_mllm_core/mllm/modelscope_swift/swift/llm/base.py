...
import swift
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_logger, parse_args, seed_everything
...
class SwiftPipeline(ABC, ProcessorMixin):
    ...
    def _compat_dsw_gradio(args) -> None:
        if (args.__class__.__name__ in {'WebUIArguments', 'AppArguments'} and 'JUPYTER_NAME' in os.environ
