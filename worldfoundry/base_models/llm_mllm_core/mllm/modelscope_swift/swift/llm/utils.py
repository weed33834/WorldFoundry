...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import deep_getattr, get_logger
...
def save_checkpoint(model: Optional[PreTrainedModel],
    ...
    if model is not None:
        if model.__class__.__name__ != 'SentenceTransformer':
            ...
            from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import copy_files_by_pattern
