...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import MODEL_MAPPING, HfConfigFactory, get_model_info_meta, get_model_name
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_dist_setting, get_logger
...
class ModelArguments:
    ...
    def _init_torch_dtype(self) -> None:
        ...
        if self.__class__.__name__ == 'TrainArguments':
