...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_logger, patch_getattr
...
class Reft(SwiftAdapter):
    ...
    def prepare_model(model: nn.Module, config: ReftConfig, adapter_name: str):
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils.import_utils import is_pyreft_available
