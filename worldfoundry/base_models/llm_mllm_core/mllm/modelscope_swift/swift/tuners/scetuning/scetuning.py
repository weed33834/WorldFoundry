...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.tuners.utils import ActivationMixin, SwiftAdapter, SwiftConfig, SwiftOutput
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import get_logger
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils.torch_utils import find_sub_module
...
class SCETuningConfig(SwiftConfig):
    ...
    def __post_init__(self):
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.tuners.mapping import SwiftTuners
