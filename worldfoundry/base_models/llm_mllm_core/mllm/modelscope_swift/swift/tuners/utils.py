...
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.llm import MODEL_ARCH_MAPPING, ModelKeys
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils import gc_collect
from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift.utils.constants import BIN_EXTENSIONS
...
def swift_to_peft_format(ckpt_dir: str, output_dir: str) -> str:
    if 'default' in os.listdir(ckpt_dir):  # swift_backend
        from worldfoundry.base_models.llm_mllm_core.mllm.modelscope_swift.swift import Swift
