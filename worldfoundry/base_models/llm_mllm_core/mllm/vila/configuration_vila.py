...
class VILAConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        image_encoder: str = (
            '{"_target_": "worldfoundry.base_models.llm_mllm_core.mllm.vila.media_encoder.BasicImageEncoder"}'
        ),
        video_encoder: str = (
            '{"_target_": "worldfoundry.base_models.llm_mllm_core.mllm.vila.media_encoder.BasicVideoEncoder"}'
        ),
        **kwargs,
    ):
