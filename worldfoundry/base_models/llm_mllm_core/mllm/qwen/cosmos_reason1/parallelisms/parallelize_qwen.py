...
"""Module for base_models -> llm_mllm_core -> mllm -> qwen -> cosmos_reason1 -> parallelisms -> parallelize_qwen.py functionality."""
...
from cosmos_predict2._src.reason1.configs.default.model_config import ActivationCheckpointConfig
from cosmos_predict2._src.reason1.configs.default.model_config import FSDP2ModelConfig as JobConfig
...
def _apply_ac_to_transformer_block(module: nn.Module, ac_config):
    """Helper function to apply ac to transformer block.

    Args:
        module: The module.
        ac_config: The ac config.
    """
    ...
    if use_op_sac:
        ...
        def _get_custom_policy(meta):
            """Helper function to get custom policy.

            Args:
                meta: The meta.
            """
            def _custom_policy(ctx, func, *args, **kwargs):
                """Helper function to custom policy.
        ...
        def selective_checkpointing_context_fn():
            """Selective checkpointing context fn."""
...
def apply_ac(model: nn.Module, ac_config: ActivationCheckpointConfig):
    ...
    if (
        ("vision" == ac_config.models or "vlm" == ac_config.models)
        and hasattr(model, "visual")
        and model.visual is not None
    ):
...
def apply_ddp(
    ...
    Args:
        model: The model.
        dp_mesh: The dp mesh.
        enable_compile: The enable compile.
