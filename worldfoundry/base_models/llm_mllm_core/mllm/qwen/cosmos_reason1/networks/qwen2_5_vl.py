...
"""Module for base_models -> llm_mllm_core -> mllm -> qwen -> cosmos_reason1 -> networks -> qwen2_5_vl.py functionality."""
...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    ...
    def _dynamic_frequency_update(self, position_ids, device):
        """Helper function to dynamic frequency update.
...
class Qwen2_5_VLForConditionalGenerationSimple(nn.Module):
    """Qwen vl for conditional generation simple implementation."""
