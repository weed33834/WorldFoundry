...
class VisionFlashAttention2(nn.Module):
    """Vision flash attention implementation."""
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        """Init.
...
class VisionSdpaAttention(nn.Module):
    """Vision sdpa attention implementation."""
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        """Init.
...
class Qwen2VLSdpaAttention(Qwen2VLAttention):
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Qwen2VLModel is using Qwen2VLSdpaAttention, but `_worldfoundry_scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
