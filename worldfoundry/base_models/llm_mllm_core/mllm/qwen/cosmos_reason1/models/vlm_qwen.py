...
"""Module for base_models -> llm_mllm_core -> mllm -> qwen -> cosmos_reason1 -> models -> vlm_qwen.py functionality."""
...
from worldfoundry.base_models.llm_mllm_core.mllm.qwen.cosmos_reason1.parallelisms.parallelize_qwen import (
    parallelize_qwen,
)
