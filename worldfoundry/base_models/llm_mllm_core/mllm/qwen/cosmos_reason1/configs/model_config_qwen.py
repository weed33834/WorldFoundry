...
"""Module for base_models -> llm_mllm_core -> mllm -> qwen -> cosmos_reason1 -> configs -> model_config_qwen.py functionality."""
...
class QwenVisionConfig:
    """Qwen vision config implementation."""
...
class QwenModelConfig(FSDP2ModelConfig):
    """Qwen model config implementation."""
