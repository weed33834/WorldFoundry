...
try:
    ...
    class SlidingWindowCache:  # type: ignore[no-redef]
        """Compatibility sentinel for Transformers versions without this cache class."""
...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    ...
    @staticmethod
    def _default_rope_parameters(config: Qwen2_5_VLConfig, device=None):
...
__all__ = ["Qwen2_5_VLModel", "Qwen2_5_VisionTransformerPretrainedModel", "get_rope_index"]
