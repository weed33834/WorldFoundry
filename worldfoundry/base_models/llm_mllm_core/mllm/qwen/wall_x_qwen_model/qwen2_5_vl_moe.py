"""Module for base_models -> llm_mllm_core -> mllm -> qwen -> wall_x_qwen_model -> qwen2_5_vl_moe.py functionality."""
...
class _SlidingWindowCachePlaceholder:
    """Sliding window cache placeholder implementation."""
    pass
...
class Qwen2_5_VisionPatchEmbed(nn.Module):
    """Qwen vision patch embed implementation."""
    def __init__(
        self,
        patch_size: int = 14,
...
class Qwen2_5_VisionRotaryEmbedding(nn.Module):
    """Qwen vision rotary embedding implementation."""
...
class Qwen2_5_VLPatchMerger(nn.Module):
    """Qwen vl patch merger implementation."""
...
class Qwen2_5_VLVisionFlashAttention2(nn.Module):
    """Qwen vl vision flash attention implementation."""
    ...
    def forward(
        ...
        Args:
            ...
            rotary_pos_emb: The rotary pos emb.
...
class Qwen2_5_VLVisionAttention(nn.Module):
    """Qwen vl vision attention implementation."""
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        """Init.
...
class Qwen2_5_VLVisionSdpaAttention(nn.Module):
    """Qwen vl vision sdpa attention implementation."""
    def __init__(self, dim: int, num_heads: int = 16) -> None:
        """Init.
    ...
    def forward(
        ...
        k = k.transpose(0, 1)
        v = v.transpose(0, 1)
        attn_output = _worldfoundry_scaled_dot_product_attention(q, k, v, attention_mask, dropout_p=0.0)
        attn_output = attn_output.transpose(0, 1)
        attn_output = attn_output.reshape(seq_length, -1)
        attn_output = self.proj(attn_output)
        return attn_output
...
class Qwen2_5_VLVisionBlock(nn.Module):
    """Qwen vl vision block implementation."""
    def __init__(self, config, attn_implementation: str = "sdpa") -> None:
        """Init.

        Args:
            config: The config.
            attn_implementation: The attn implementation.
...
class Qwen2_5_VLPreTrainedModel(PreTrainedModel):
    """Qwen vl pre trained model implementation."""
...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    """Qwen vision transformer pretrained model implementation."""
...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    """Qwen vl rotary embedding implementation."""
...
class Qwen2_5_VLSdpaAttention(Qwen2_5_VLAttention):
    """
    Qwen2 attention module using _worldfoundry_scaled_dot_product_attention. This module inherits from
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Qwen2_5_VLModel is using Qwen2_5_VLSdpaAttention, but `_worldfoundry_scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
...
class Qwen2_5_VLDecoderLayer(nn.Module):
    """Qwen vl decoder layer implementation."""
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        """Helper function to update causal mask.
        ...
        if (
            ...
            # using left padding. This is required by _worldfoundry_scaled_dot_product_attention memory-efficient attention path.
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    """Qwen vl for conditional generation implementation."""
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        Args:
            ...
            pixel_values_videos: The pixel values videos.
            image_grid_thw: The image grid thw.
            video_grid_thw: The video grid thw.
            second_per_grid_ts: The second per grid ts.
        """
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        """Helper function to expand inputs for generation.

        Args:
            expand_size: The expand size.
            is_encoder_decoder: The is encoder decoder.
            input_ids: The input ids.
        ...
        def _expand_dict_for_generation_visual(dict_to_expand):
            """Helper function to expand dict for generation visual.

            Args:
                dict_to_expand: The dict to expand.
            """
            ...
            def _repeat_interleave_samples(x, lengths, repeat_times):
                """Helper function to repeat interleave samples.

                Args:
                    x: The x.
                    lengths: The lengths.
                    repeat_times: The repeat times.
                """
        ...
        def _expand_dict_for_generation(dict_to_expand):
            """Helper function to expand dict for generation.
...
class Qwen2_5_VLACausalLMOutputWithPast(ModelOutput):
    """Qwen vla causal lm output with past implementation."""
    loss: torch.FloatTensor | None = None
...
class BlockSparseMLP(nn.Module):
    """Block sparse mlp implementation."""
    def __init__(self, config):
        """Init.
...
class SparseMoeBlock(nn.Module):
    """Sparse moe block implementation."""
    def __init__(self, config, num_experts: int):
        """Init.

        Args:
            config: The config.
            num_experts: The num experts.
        """
        super().__init__()
...
class Qwen2_5_VLDecoderLayer_with_MoE(nn.Module):
    """Qwen vl decoder layer with mo e implementation."""
...
class Qwen2_5_VLMoEModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Args:
            ...
            past_key_values: The past key values.
            inputs_embeds: The inputs embeds.
            moe_token_types: The moe token types.
            use_cache: The use cache.
            output_attentions: The output attentions.
            output_hidden_states: The output hidden states.
            return_dict: The return dict.
    ...
    def _update_causal_mask(
        ...
        if (
            ...
            # This is required for _worldfoundry_scaled_dot_product_attention's memory-efficient path
