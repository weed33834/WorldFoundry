"""Module for the Pandora operator implementation."""
...
class PandoraOperator(BaseOperator):
    """Operator for Pandora text-driven world/video generation."""
    ...
    def check_interaction(self, interaction):
        ...
        if interaction in (None, [], ()):
            return True
        raise ValueError("Pandora integration is prompt-only through the official gradio_app entry point.")
    ...
    def process_perception(
        ...
        **kwargs: Any,
        ...
        if images is not None or video is not None or ref_image_path is not None:
            raise ValueError("Pandora official app integration does not accept visual conditioning inputs.")
