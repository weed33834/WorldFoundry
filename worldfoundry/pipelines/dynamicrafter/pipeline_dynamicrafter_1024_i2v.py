"""Dynamicrafter 1024 I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.dynamicrafter.dynamicrafter_1024_i2v_synthesis import DynamiCrafter1024I2VSynthesis


class DynamiCrafter1024I2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for DynamiCrafter1024I2V."""

    SYNTHESIS_CLS = DynamiCrafter1024I2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='dynamicrafter-1024-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='dynamicrafter-1024-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for DynamiCrafter1024I2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for DynamiCrafter1024I2VPipeline."""
