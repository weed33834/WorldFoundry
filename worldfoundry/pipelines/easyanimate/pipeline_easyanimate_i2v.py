"""Easyanimate I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.easyanimate.easyanimate_i2v_synthesis import EasyAnimateI2VSynthesis


class EasyAnimateI2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for EasyAnimateI2V."""

    SYNTHESIS_CLS = EasyAnimateI2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='easyanimate-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='easyanimate-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for EasyAnimateI2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for EasyAnimateI2VPipeline."""
