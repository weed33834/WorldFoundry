"""Ltx2 I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.ltx2.ltx2_i2v_synthesis import LTX2I2VSynthesis


class LTX2I2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for LTX2I2V."""

    SYNTHESIS_CLS = LTX2I2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='ltx2-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='ltx2-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for LTX2I2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for LTX2I2VPipeline."""
