"""Gen 3 I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.runway.gen_3_i2v_synthesis import Gen3I2VSynthesis


class Gen3I2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for Gen3I2V."""

    SYNTHESIS_CLS = Gen3I2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='runway-gen-3-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='runway-gen-3-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for Gen3I2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for Gen3I2VPipeline."""
