"""Minimax I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.minimax.minimax_i2v_synthesis import MiniMaxI2VSynthesis


class MiniMaxI2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for MiniMaxI2V."""

    SYNTHESIS_CLS = MiniMaxI2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='minimax-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='minimax-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for MiniMaxI2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for MiniMaxI2VPipeline."""
