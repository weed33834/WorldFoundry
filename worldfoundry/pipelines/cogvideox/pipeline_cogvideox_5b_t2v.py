"""Cogvideox 5B T2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.cogvideox.cogvideox_5b_t2v_synthesis import CogVideoX5bT2VSynthesis


class CogVideoX5bT2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for CogVideoX5bT2V."""

    SYNTHESIS_CLS = CogVideoX5bT2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='cogvideox-5b-t2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='cogvideox-5b-t2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for CogVideoX5bT2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for CogVideoX5bT2VPipeline."""
