"""Cogvideox 2B T2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.cogvideox.cogvideox_2b_t2v_synthesis import CogVideoX2bT2VSynthesis


class CogVideoX2bT2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for CogVideoX2bT2V."""

    SYNTHESIS_CLS = CogVideoX2bT2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='cogvideox-2b-t2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='cogvideox-2b-t2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for CogVideoX2bT2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for CogVideoX2bT2VPipeline."""
