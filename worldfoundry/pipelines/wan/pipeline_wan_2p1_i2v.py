"""Wan 2P1 I2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.wan.wan_2p1_i2v_synthesis import Wan2p1I2VSynthesis


class Wan2p1I2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for Wan2p1I2V."""

    SYNTHESIS_CLS = Wan2p1I2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='wan-2.1-i2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='wan-2.1-i2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for Wan2p1I2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for Wan2p1I2VPipeline."""
