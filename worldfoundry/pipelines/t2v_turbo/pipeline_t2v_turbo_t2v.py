"""T2V Turbo T2V visual generation pipeline module."""
...
from ...synthesis.visual_generation.t2v_turbo.t2v_turbo_t2v_synthesis import T2VTurboT2VSynthesis


class T2VTurboT2VPipeline(PipelineABC):
    """Independent WorldFoundry pipeline for T2VTurboT2V."""

    SYNTHESIS_CLS = T2VTurboT2VSynthesis
    ...
    def __init__(
        ...
        self.memory_module = memory_module or VideoArtifactMemory(model_id='t2v-turbo-t2v')
        self.device = device
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cls(
            ...
            memory_module=VideoArtifactMemory(model_id='t2v-turbo-t2v'),
            device=device,
        )
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for T2VTurboT2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for T2VTurboT2VPipeline."""
