...
Three implementations of the :class:`~worldfoundry.synthesis.visual_generation.ltx2.ltx_pipelines.utils.types.Denoiser` protocol:
...
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.components.guiders import MultiModalGuider, MultiModalGuiderFactory, MultiModalGuiderParams
from worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.guidance.perturbations import (
...
from worldfoundry.synthesis.visual_generation.ltx2.ltx_pipelines.utils.helpers import modality_from_latent_state
from worldfoundry.synthesis.visual_generation.ltx2.ltx_pipelines.utils.types import DenoisedLatentResult
...
def _guided_denoise(  # noqa: PLR0913,PLR0915
    ...
    *,
    ...
    with :class:`~worldfoundry.base_models.diffusion_model.video.ltx2.ltx_core.batch_split.BatchSplitAdapter`, the transformer may
