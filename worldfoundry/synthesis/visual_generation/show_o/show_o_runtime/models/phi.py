...
class PhiSdpaAttention(PhiAttention):
    ...
    """
    SDPA attention module using _worldfoundry_scaled_dot_product_attention. This module inherits from
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "PhiModel is using PhiSdpaAttention, but `_worldfoundry_scaled_dot_product_attention` does not "
