...
class TemporalAxialAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        x = _worldfoundry_scaled_dot_product_attention(query=q, key=k, value=v, is_causal=self.is_causal)
...
class SpatialAxialAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        x = _worldfoundry_scaled_dot_product_attention(query=q, key=k, value=v, is_causal=False)
