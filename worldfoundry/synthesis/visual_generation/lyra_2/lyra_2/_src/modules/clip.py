...
from worldfoundry.base_models.diffusion_model.video.cosmos.cosmos2.runtime.cosmos_predict2.cosmos_predict2._src.predict2.networks.attention import (
    attention,
)
...
class CLIPModel:
    def __init__(
        ...
        checkpoint_path = os.environ.get("LYRA2_IMAGE_ENCODER_CKPT", checkpoint_path)
        tokenizer_path = os.environ.get("LYRA2_CLIP_TOKENIZER", tokenizer_path)
        self.dtype = dtype
        self.device = device
