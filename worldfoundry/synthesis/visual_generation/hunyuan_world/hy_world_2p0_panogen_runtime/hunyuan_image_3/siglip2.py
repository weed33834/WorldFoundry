...
class Siglip2SdpaAttention(Siglip2Attention):
    """
    Siglip2 attention module using _worldfoundry_scaled_dot_product_attention. This module inherits from
    ...
    def forward(
        ...
        if output_attentions:
            ...
            warnings.warn(
                "Siglip2Model is using Siglip2SdpaAttention, but `_worldfoundry_scaled_dot_product_attention` "
