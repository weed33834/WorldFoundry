...
# Adapted from https://github.com/huggingface/diffusers/blob/v0.31.0/src/diffusers/schedulers/scheduling_unipc_multistep.py
# (UniPC scheduler converted for flow matching).
#
# Upstream copyright preserved per Apache License, Version 2.0 §4(b):
