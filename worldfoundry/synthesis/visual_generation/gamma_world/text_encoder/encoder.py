...
from worldfoundry.core.configuration.flags import SMOKE
...
from worldfoundry.core.model_loading.text_embeddings import EmbeddingConcatStrategy as EmbeddingConcatStrategy
from worldfoundry.synthesis.visual_generation.gamma_world.text_encoder.checkpoint import (
    load_state_dict,
...
class TextEncoder:
    ...
    def compute_text_embeddings_online(
        ...
        with torch.no_grad():
            outputs_batch = self.model(input_ids_batch, {})
