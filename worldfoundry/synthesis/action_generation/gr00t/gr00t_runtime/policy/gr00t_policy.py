...
from gr00t.inference_support.embodiment_tags import FINETUNE_ONLY_TAGS, POSTTRAIN_TAGS, EmbodimentTag
from gr00t.inference_support.types import MessageType, ModalityConfig, VLAStepData
...
class Gr00tPolicy(BasePolicy):
    ...
    def __init__(
        ...
        *,
        ...
        """
        # Import concrete modules to register GR00T with Hugging Face auto classes.
        ...
        model = AutoModel.from_pretrained(model_dir, low_cpu_mem_usage=False, **model_kwargs)
        ...
        self.processor: BaseProcessor = AutoProcessor.from_pretrained(processor_dir, **local_backbone_kwargs)
        self.processor.eval()
