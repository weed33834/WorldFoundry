...
class SiglipSdpaAttention(SiglipAttention):
    """
    Siglip attention module using the WorldFoundry core SDPA primitive. This module inherits from
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "SiglipModel is using SiglipSdpaAttention, but the core SDPA path does not support `output_attentions=True`. Falling back to the manual attention implementation, "
