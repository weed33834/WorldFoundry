...
class TransformerEncoder(nn.Module):
    def __init__(self, encoder_layer, num_layers: int, norm=None) -> None:
        super().__init__()
...
class TransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers: int, norm=None, return_intermediate: bool = False) -> None:
        super().__init__()
...
def build_transformer(args):
    """Build the transformer stack used by ACT.

    Args:
        args: Namespace-like object with transformer hyperparameters.
    """
    return Transformer(
