...
from ..types import Data, Sequence
...
class OctoModule(nn.Module):
    ...
    def __call__(
        self, observations, tasks, timestep_pad_mask, train=False, verbose=False
    ):
        ...
        Args:
            ...
            timestep_pad_mask: A boolean mask of shape (batch, horizon) where False indicates a padded timestep.
            train: Kept for Flax checkpoint compatibility; inference passes ``False``.
