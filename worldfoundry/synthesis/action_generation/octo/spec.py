...
_PACKAGE = "worldfoundry.synthesis.action_generation.octo"
_LEGACY_MODULES = {
    "octo.model.octo_model": f"{_PACKAGE}.modeling.model",
    "octo.model.octo_module": f"{_PACKAGE}.modeling.module",
    "octo.model.components.action_heads": f"{_PACKAGE}.modeling.action_heads",
    "octo.model.components.base": f"{_PACKAGE}.modeling.base",
    "octo.model.components.block_transformer": f"{_PACKAGE}.modeling.block_transformer",
    "octo.model.components.diffusion": f"{_PACKAGE}.modeling.diffusion",
    "octo.model.components.film_conditioning_layer": f"{_PACKAGE}.modeling.film_conditioning",
    "octo.model.components.tokenizers": f"{_PACKAGE}.modeling.tokenizers",
    "octo.model.components.transformer": f"{_PACKAGE}.modeling.transformer",
    "octo.model.components.unet": f"{_PACKAGE}.modeling.unet",
    "octo.model.components.vit_encoders": f"{_PACKAGE}.modeling.vit_encoders",
    "octo.data.utils.text_processing": f"{_PACKAGE}.preprocessing.text",
    "octo.utils.spec": f"{_PACKAGE}.spec",
    "octo.utils.typing": f"{_PACKAGE}.types",
}
...
class ModuleSpec(TypedDict):
    ...
    Usage:
        ...
        >>> from worldfoundry.synthesis.action_generation.octo.modeling.transformer import Transformer
...
def _import_from_string(module_string: str, name: str):
    module_string = _LEGACY_MODULES.get(module_string, module_string)
    try:
