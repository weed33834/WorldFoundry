...
from worldfoundry.core.attention import QKVSelfAttention as Attention
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.history_embedder = HistoryEmbedder(
