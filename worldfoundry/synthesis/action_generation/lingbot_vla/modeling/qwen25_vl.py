"""Checkpoint-compatible Qwen2.5-VL inference layers for LingBot-VLA v1."""
...
try:
    ...
    class SlidingWindowCache(Cache):
        """Compatibility sentinel for Transformers releases without the legacy cache class."""
...
def rotate_half(x: torch.Tensor) -> torch.Tensor:
    """Rotate the two halves of the last dimension for rotary embeddings."""
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, **kwargs):
        super().__init__(config)
        # Respect the runtime-selected backend. The previous unconditional FA2
        # flag overrode eager/SDPA selection and made CPU, pre-Ampere, and
        # installations without a compatible flash-attn wheel fail at init.
