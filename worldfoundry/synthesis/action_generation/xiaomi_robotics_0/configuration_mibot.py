# coding=utf-8
# WorldFoundry modification: vendored in-tree from the pinned official checkpoint runtime.
# ruff: noqa
...
class Qwen3VLTextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Transformers 5 no longer creates ``pad_token_id`` unless the
        # concrete config forwards it.  Qwen permits ``None`` here, but the
        # text embedding constructor still reads the attribute unconditionally.
        super().__init__(
