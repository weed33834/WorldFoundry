...
from .cp_load_balancer import CPLoadBalancerType
...
def dispatch_ring_flash_attn(
    ...
    *,
    ...
    if strategy == CPLoadBalancerType.zig_zag:
    ...
    elif strategy == CPLoadBalancerType.llama3:
