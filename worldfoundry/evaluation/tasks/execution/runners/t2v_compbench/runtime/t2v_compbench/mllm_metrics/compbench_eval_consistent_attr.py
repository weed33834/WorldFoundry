...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-path", type=str, default="../csv_consistent_attr", help="path to store the video scores")
    parser.add_argument("--read-prompt-file", type=str, default=str(asset_path("meta_data/consistent_attribute_binding.json")), help="path of txt file with input prompts and meta data")
