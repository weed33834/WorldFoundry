...
from worldfoundry.base_models.perception_core.detection.grounding_dino.util import box_ops
...
from worldfoundry.base_models.perception_core.detection.grounding_dino.util.vl_utils import create_positive_map_from_span
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", "-c", type=str, default=str(grounding_dino_config_path()), help="path to config file")
    parser.add_argument(
        "--checkpoint_path", "-p", type=str, default=str(grounding_dino_checkpoint_path()), help="path to checkpoint file"
    )
    parser.add_argument(
    ...
    parser.add_argument("--read-prompt-file", type=str, default=str(asset_path("meta_data/generative_numeracy.json")), help="path to the meta data")
    parser.add_argument("--video-path", type=str, required=True, help="path to the input videos")
    
    parser.add_argument("--frame-folder", type=str, default=None, help="path to the frame folder") 
    ...
    csv_path = f'{output_path}/{args.t2v_model}_numeracy_frame.csv'
