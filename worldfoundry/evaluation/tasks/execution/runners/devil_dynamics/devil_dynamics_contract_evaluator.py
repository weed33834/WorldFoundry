"""Benchmark-zoo contract evaluator for DEVIL Dynamics."""
...
from worldfoundry.evaluation.tasks.execution.runners.devil_dynamics.devil_dynamics_metrics import (
    BENCHMARK_ID,
    OFFICIAL_REQUIREMENTS,
    official_scores_from_records,
)

EVALUATOR_KIND = "in_tree_devil_dynamics_contract_evaluator"


def write_devil_dynamics_evaluation(
    *,
    display_name: str,
