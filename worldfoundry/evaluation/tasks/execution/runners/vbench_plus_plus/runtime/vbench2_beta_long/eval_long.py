...
def parse_args():
    ...
    bundled_full_json = bundled_benchmark_asset("vbench-plus-plus", "long", "VBench_full_info.json")
    default_full_json = str(bundled_full_json) if bundled_full_json.is_file() else f'{CUR_DIR}/VBench_full_info.json'
