...
def init_submodules(dimension_list, local=False, read_frame=False):
    ...
    for dimension in dimension_list:
        ...
        # Assign the DINO model path for subject consistency dimension
            ...
            submodules_dict[dimension] = {
                "name": str(vbench_asset_path("vbench_clip_vit_b32_checkpoint")) if local else 'ViT-B/32',
                "retina": str(vbench_asset_path("vbench_retinaface_checkpoint")),
            }
        elif dimension == 'safety':
            submodules_dict[dimension] = {
                "name": str(vbench_asset_path("vbench_clip_vit_b32_checkpoint")) if local else 'ViT-B/32',
                "sd_checker": str(vbench_asset_path("vbench_sd_safety_checker_model")),
                "q16": str(vbench_asset_path("vbench_q16_prompts")),
            }
