"""Benchmark-zoo contract evaluator for PhyGround."""
...
from worldfoundry.evaluation.tasks.execution.runners.phyground.phyground_official_filter import (
    BENCHMARK_ID,
...
EVALUATOR_KIND = "in_tree_phyground_contract_evaluator"


def write_phyground_evaluation(
    *,
    display_name: str,
    ...
    **kwargs: Any,
    ...
    return write_video_contract_evaluation(
        ...
        prompt_manifest_keys=("phyground_prompt_manifest",),
