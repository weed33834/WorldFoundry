        ...
        rows.append(
            {
                ...
                "group": spec["group"],
                "source": "phyeduvideo_official_runtime" if official_runtime_executed else "phyeduvideo_results_file",
    ...
    *,
    ...
    return {
        ...
        "evaluation": {
            ...
            "kind": "phyeduvideo_official_in_tree" if official_runtime_executed else "phyeduvideo_result_normalizer",
        ...
        "notes": [
            "PhyEduVideo in-tree runtime materializes Prompts/Prompts.json teaching-point T2V prompts and normalizes official scorer outputs.",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        scorecard = {
            ...
            "evaluation": {
                "available": False,
                "kind": "phyeduvideo_result_normalizer",
