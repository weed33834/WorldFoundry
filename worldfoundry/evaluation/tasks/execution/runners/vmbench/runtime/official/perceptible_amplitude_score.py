...
from worldfoundry.base_models.perception_core.detection.grounding_dino.util.misc import (
    clean_state_dict,
...
if __name__ == "__main__":
    ...
    sam_version = "vit_h"
    sam_checkpoint = os.environ.get("WORLDFOUNDRY_SAM_VIT_H_CKPT", str(sam_checkpoint_path("vit_h")))
