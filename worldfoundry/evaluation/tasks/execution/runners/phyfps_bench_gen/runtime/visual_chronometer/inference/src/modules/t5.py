...
class T5Embedder:
    available_models = ["flan-t5-large"]
    ...
    def __init__(
        ...
        *,
        ...
        print(f"T5 embedder is on {self.device}")
        ...
        if local_cache:
            ...
            cache_dir = os.path.join(self.cache_dir, "flan-t5-large")
            for filename in [
                "config.json",
                "special_tokens_map.json",
                "spiece.model",
    ...
    def find_phrase_indices(self, sentence, phrase):
