...
from worldfoundry.base_models.llm_mllm_core.mllm.otter import OtterHD as OtterHDModel


class OtterHD():
    support_multi_image = False
    merged_image_files = []
    def __init__(self, model_path:str="Otter-AI/OtterHD-8B") -> None:
        """Llava model wrapper

        Args:
            model_path (str): Llava model name, e.g. "liuhaotian/llava-v1.5-7b" or "llava-hf/vip-llava-13b-hf"
        """
        self.model = OtterHDModel(model_path=model_path)
