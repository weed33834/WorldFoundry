...
def main(
    ...
    if model_name == "idefics1":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.idefics1_eval import Idefics1
        model = Idefics1()

    elif model_name == "llava":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.llava_eval import Llava
        model = Llava()
    elif model_name == "llava_next":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.llava_next_eval import LlavaNext
        model = LlavaNext()
        
    # MLLM with BAD output
    elif model_name == "idefics2": 
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.idefics2_eval import Idefics2
        model = Idefics2()
    elif model_name == "kosmos2":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.kosmos2_eval import Kosmos2
        model=Kosmos2()
    elif model_name == "fuyu":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.fuyu_eval import Fuyu
        model = Fuyu()
    elif model_name == "cogvlm":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.cogvlm_eval import CogVLM
        model = CogVLM("THUDM/cogvlm-chat-hf")
    elif model_name == "openflamingo":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.openflamingo_eval import OpenFlamingo
        model = OpenFlamingo()
    elif model_name == "otterimage":
        from worldfoundry.evaluation.tasks.execution.runners.videoscore.runtime.videoscore.benchmark.mllm_tools.otterimage_eval import OtterImage
        model = OtterImage()
    else:
