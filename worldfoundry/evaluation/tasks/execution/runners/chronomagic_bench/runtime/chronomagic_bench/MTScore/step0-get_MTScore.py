...
import time
from worldfoundry.evaluation.tasks.execution.runners.chronomagic_bench.runtime.chronomagic_bench.MTScore.configs.config import (
    Config,
    eval_dict_leaf,
)
from worldfoundry.evaluation.tasks.execution.runners.chronomagic_bench.runtime.chronomagic_bench.MTScore.configs.utils import (
    _frame_from_video,
    retrieve_text,
    setup_internvideo2,
)
