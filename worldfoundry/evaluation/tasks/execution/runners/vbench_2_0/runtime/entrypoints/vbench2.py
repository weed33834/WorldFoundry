...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="WorldFoundry in-tree VBench-2.0 runtime")
...
def main() -> None:
    ...
    runtime = VBench2(torch.device("cuda"), args.full_json_dir, args.output_path)
    runtime.evaluate(
