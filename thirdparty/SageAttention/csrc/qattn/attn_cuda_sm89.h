...
torch::Tensor qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_window_size(torch::Tensor query,
                    torch::Tensor key,
                    torch::Tensor value,
                    torch::Tensor output,
...
torch::Tensor qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_inst_buf_window_size(torch::Tensor query,
                    torch::Tensor key,
                    torch::Tensor value,
                    torch::Tensor output,
                    int window_size_left,
...
torch::Tensor qk_int8_sv_f8_accum_f16_fuse_v_scale_attn_inst_buf_window_size(torch::Tensor query,
                    torch::Tensor key,
                    torch::Tensor value,
                    torch::Tensor output,
                    int window_size_left,
...
torch::Tensor qk_int8_sv_f8_accum_f32_fuse_v_scale_fuse_v_mean_attn_window_size(torch::Tensor query,
                    torch::Tensor key,
                    torch::Tensor value,
                    torch::Tensor output,
                    int window_size_left,
