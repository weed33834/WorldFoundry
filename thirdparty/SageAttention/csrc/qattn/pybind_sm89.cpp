...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_window_size", &qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_window_size, "QK int8 sv f8 accum f32 fuse v scale attn");
  ...
  m.def("qk_int8_sv_f8_accum_f32_fuse_v_scale_fuse_v_mean_attn_window_size", &qk_int8_sv_f8_accum_f32_fuse_v_scale_fuse_v_mean_attn_window_size, "QK int8 sv f8 accum f32 fuse v scale fuse v mean attn");
  ...
  m.def("qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_inst_buf_window_size", &qk_int8_sv_f8_accum_f32_fuse_v_scale_attn_inst_buf_window_size, "QK int8 sv f8 accum f32 fuse v scale attn inst buf");
  ...
  m.def("qk_int8_sv_f8_accum_f16_fuse_v_scale_attn_inst_buf_window_size", &qk_int8_sv_f8_accum_f16_fuse_v_scale_attn_inst_buf_window_size, "QK int8 sv f8 accum f16 fuse v scale attn inst buf");
}