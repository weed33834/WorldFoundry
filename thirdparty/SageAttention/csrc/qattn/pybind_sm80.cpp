...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("qk_int8_sv_f16_accum_f16_fuse_v_mean_attn_window_size", &qk_int8_sv_f16_accum_f16_fuse_v_mean_attn_window_size, "QK int8 sv f16 accum f16 attn per warp fuse v mean");
